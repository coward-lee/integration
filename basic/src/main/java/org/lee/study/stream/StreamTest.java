 ...
 * Collection 集合类
 * Stream 流
 * Spliterator  可拆分迭代器Spliterator Stream的源头(并行流的关键)，如Collection的Spliterator； 和这个与 Iterator，功能相似 但是比Iterator功能更强，如Spliterator是平行流的关键
 * StreamSupport 工具类
