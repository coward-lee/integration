...
public class EntityScanPackages {
	...
	/**
	 * Return the {@link EntityScanPackages} for the given bean design.parttern.factory.
	 * @param beanFactory the source bean design.parttern.factory
	 * @return the {@link EntityScanPackages} for the bean design.parttern.factory (never {@code null})
	 */
