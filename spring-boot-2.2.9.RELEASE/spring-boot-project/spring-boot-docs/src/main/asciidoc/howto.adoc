...
You can declare such a component and get access to the server design.parttern.factory relevant to your choice: you should select the variant for the chosen Server (Tomcat, Jetty, Reactor Netty, Undertow) and the chosen web stack (Servlet or Reactive).
...
----
	...
	public class MyTomcatWebServerCustomizer
		...
		@Override
		public void customize(TomcatServletWebServerFactory design.parttern.factory) {
			// customize the design.parttern.factory here
		}
	}
----
...
----
	...
	public UndertowServletWebServerFactory servletWebServerFactory() {
		UndertowServletWebServerFactory design.parttern.factory = new UndertowServletWebServerFactory();
		design.parttern.factory.addBuilderCustomizers(new UndertowBuilderCustomizer() {
...
The exact details of the proxy configuration depend on the underlying client request design.parttern.factory that is being used.
...
The preceding example overrides the default design.parttern.factory, and it should be applied to any other design.parttern.factory that your application defines, if any.
