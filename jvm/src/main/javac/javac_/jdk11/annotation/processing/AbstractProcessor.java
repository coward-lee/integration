...
public abstract class AbstractProcessor implements javax.annotation.processing.Processor {
     ...
     * javax.annotation.processing.SupportedOptions}, return an unmodifiable set with the same set
    ...
    public Set<String> getSupportedOptions() {
        javax.annotation.processing.SupportedOptions so = this.getClass().getAnnotation(SupportedOptions.class);
        if  (so == null)
