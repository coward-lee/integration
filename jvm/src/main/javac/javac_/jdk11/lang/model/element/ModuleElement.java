 ...
 * @spec JPMS
 */
public interface ModuleElement extends javax.lang.model.element.Element, QualifiedNameable {
    ...
    interface ProvidesDirective extends Directive {
         ...
         */
        javax.lang.model.element.TypeElement getService();

        /**
         * Returns the implementations of the service being provided.
         * @return the implementations of the service being provided
         */
        List<? extends javax.lang.model.element.TypeElement> getImplementations();
    }
