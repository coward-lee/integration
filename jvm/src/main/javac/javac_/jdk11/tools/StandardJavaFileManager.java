 ...
 *     <ul>
 *       <li>
 *         the method <code>{@linkplain javax.tools.FileObject#delete()}</code>
 *         is equivalent to <code>{@linkplain File#delete()}</code>,
 *       </li>
 *       <li>
 *         the method <code>{@linkplain javax.tools.FileObject#getLastModified()}</code>
 *         is equivalent to <code>{@linkplain File#lastModified()}</code>,
 *       </li>
 *       <li>
 *         the methods <code>{@linkplain javax.tools.FileObject#getCharContent(boolean)}</code>,
 *         <code>{@linkplain javax.tools.FileObject#openInputStream()}</code>, and
 *         <code>{@linkplain javax.tools.FileObject#openReader(boolean)}</code>
 *         must succeed if the following would succeed (ignoring
 *         encoding issues):
 *         <blockquote>
 *           <pre>new {@linkplain java.io.FileInputStream#FileInputStream(File) FileInputStream}(new {@linkplain File#File(java.net.URI) File}({@linkplain javax.tools.FileObject fileObject}.{@linkplain javax.tools.FileObject#toUri() toUri}()))</pre>
 *         </blockquote>
 *       </li>
 *       <li>
 *         and the methods
 *         <code>{@linkplain javax.tools.FileObject#openOutputStream()}</code>, and
 *         <code>{@linkplain javax.tools.FileObject#openWriter()}</code> must
 *         succeed if the following would succeed (ignoring encoding
 *         issues):
 *         <blockquote>
 *           <pre>new {@linkplain java.io.FileOutputStream#FileOutputStream(File) FileOutputStream}(new {@linkplain File#File(java.net.URI) File}({@linkplain javax.tools.FileObject fileObject}.{@linkplain javax.tools.FileObject#toUri() toUri}()))</pre>
 *         </blockquote>
 *       </li>
 *     </ul>
 *   </li>
 ...
 *     <code>{@linkplain javax.tools.FileObject#toUri()}</code>
 *     <ul>
 *       <li>
...
public interface StandardJavaFileManager extends JavaFileManager {
     ...
     * @since 9
     */
    default Iterable<? extends javax.tools.JavaFileObject> getJavaFileObjectsFromPaths(
     ...
     *
     * <pre>
     *     getJavaFileObjectsFromPaths({@linkplain Arrays#asList Arrays.asList}(paths))
     * </pre>
     *
     ...
     * @since 9
     */
    default Iterable<? extends javax.tools.JavaFileObject> getJavaFileObjects(Path... paths) {
     ...
     * {@link Path Path} object. In such cases, this method may be
