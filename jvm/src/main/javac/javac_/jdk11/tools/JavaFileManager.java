 ...
 * @see javax.tools.JavaFileObject
...
public interface JavaFileManager extends Closeable, Flushable, OptionChecker {
     ...
     * and this file manager cannot be reopened
     */
    Iterable<javax.tools.JavaFileObject> list(Location location,
                                              String packageName,
                                              Set<Kind> kinds,
                                              boolean recurse)
        throws IOException;
     ...
     * and this file manager cannot be reopened
     */
    String inferBinaryName(Location location, javax.tools.JavaFileObject file);
    ...
    /**
     * Returns a {@linkplain javax.tools.JavaFileObject file object} for input
     ...
     * and this file manager cannot be reopened
     */
    javax.tools.JavaFileObject getJavaFileForInput(Location location,
                                                   String className,
                                                   Kind kind)
        throws IOException;

    /**
     * Returns a {@linkplain javax.tools.JavaFileObject file object} for output
     * representing the specified class of the specified kind in the
     * given package-oriented location.
     *
     ...
     * and this file manager cannot be reopened
     */
    javax.tools.JavaFileObject getJavaFileForOutput(Location location,
                                                    String className,
                                                    Kind kind,
    ...
    /**
     * Returns a {@linkplain javax.tools.FileObject file object} for input
     ...
     * of {@link javax.tools.JavaFileObject}.
     *
    ...
    /**
     * Returns a {@linkplain javax.tools.FileObject file object} for output
     * representing the specified <a href="JavaFileManager.html#relative_name">relative
     ...
     * and this file manager cannot be reopened
     */
    javax.tools.FileObject getFileForOutput(Location location,
                                            String packageName,
                                            String relativeName,
                                            javax.tools.FileObject sibling)
        throws IOException;
