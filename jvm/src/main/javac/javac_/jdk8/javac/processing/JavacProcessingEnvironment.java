...
package javac_.jdk8.javac.processing;
...
public class JavacProcessingEnvironment implements ProcessingEnvironment, Closeable {
            ...
            if (nextProc != null)
                ...
                if (!names.hasNext())
                    ...
                    try {
                        ...
                        throw new com.sun.tools.javac.processing.AnnotationProcessingError(t);
                    }
                    nextProc = processor;
                    return true;
                }
    ...
    private void discoverAndRunProcs(Context context,
        ...
        RoundEnvironment renv = new com.sun.tools.javac.processing.JavacRoundEnvironment(false,
                                                          false,
                                                          rootElements,
    ...
    private boolean needClassLoader(String procNames, Iterable<? extends File> workingpath) {
        ...
        for(File pathElement : workingpath) {
            try {
                ...
                if (com.sun.tools.javac.processing.ServiceProxy.hasService(Processor.class, urls))
                    return true;
            } catch (MalformedURLException ex) {
                throw new AssertionError(ex);
            }
            catch (com.sun.tools.javac.processing.ServiceProxy.ServiceConfigurationError e) {
