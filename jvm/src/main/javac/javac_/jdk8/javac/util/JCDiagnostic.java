...
public class JCDiagnostic implements Diagnostic<JavaFileObject> {
    ...
    public static class Factory {
        ...
        public static Factory instance(com.sun.tools.javac.util.Context context) {
        ...
        protected Factory(Context context) {
            ...
            final com.sun.tools.javac.util.Options options = com.sun.tools.javac.util.Options.instance(context);
            initOptions(options);
    ...
    class SourcePosition {
        ...
        SourcePosition() {
            int n = (position == null ? com.sun.tools.javac.util.Position.NOPOS : position.getPreferredPosition());
            if (n == com.sun.tools.javac.util.Position.NOPOS || source == null)
                line = column = -1;
            else {
    ...
    protected JCDiagnostic(DiagnosticFormatter<JCDiagnostic> formatter,
                       ...
                       String key,
                       Object... args) {
        if (source == null && pos != null && pos.getPreferredPosition() != com.sun.tools.javac.util.Position.NOPOS)
     ...
     */
    public com.sun.tools.javac.util.List<JCDiagnostic> getSubdiagnostics() {
    ...
    protected int getIntStartPosition() {
        return (position == null ? com.sun.tools.javac.util.Position.NOPOS : position.getStartPosition());
    }

    protected int getIntPosition() {
        return (position == null ? com.sun.tools.javac.util.Position.NOPOS : position.getPreferredPosition());
    }
    ...
    public static class MultilineDiagnostic extends JCDiagnostic {
        ...
        private final com.sun.tools.javac.util.List<JCDiagnostic> subdiagnostics;

        public MultilineDiagnostic(JCDiagnostic other, com.sun.tools.javac.util.List<JCDiagnostic> subdiagnostics) {
