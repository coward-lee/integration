 ...
 */
public abstract class AbstractDiagnosticFormatter implements DiagnosticFormatter<com.sun.tools.javac.util.JCDiagnostic> {
     ...
     */
    private com.sun.tools.javac.util.List<Type> allCaptured = com.sun.tools.javac.util.List.nil();
    ...
    public String formatKind(com.sun.tools.javac.util.JCDiagnostic d, Locale l) {
        switch (d.getType()) {
    ...
    @Override
    public String format(com.sun.tools.javac.util.JCDiagnostic d, Locale locale) {
        allCaptured = com.sun.tools.javac.util.List.nil();
        return formatDiagnostic(d, locale);
    }

    protected abstract String formatDiagnostic(com.sun.tools.javac.util.JCDiagnostic d, Locale locale);

    public String formatPosition(com.sun.tools.javac.util.JCDiagnostic d, PositionKind pk, Locale l) {
        com.sun.tools.javac.util.Assert.check(d.getPosition() != com.sun.tools.javac.util.Position.NOPOS);
        return String.valueOf(getPosition(d, pk));
    }
    //where
    private long getPosition(com.sun.tools.javac.util.JCDiagnostic d, PositionKind pk) {
        switch (pk) {
    ...
    public String formatSource(com.sun.tools.javac.util.JCDiagnostic d, boolean fullname, Locale l) {
     ...
     */
    protected Collection<String> formatArguments(com.sun.tools.javac.util.JCDiagnostic d, Locale l) {
        com.sun.tools.javac.util.ListBuffer<String> buf = new ListBuffer<String>();
     ...
     */
    protected String formatArgument(com.sun.tools.javac.util.JCDiagnostic d, Object arg, Locale l) {
        if (arg instanceof com.sun.tools.javac.util.JCDiagnostic) {
            String s = null;
            depth++;
            try {
                s = formatMessage((com.sun.tools.javac.util.JCDiagnostic)arg, l);
            }
            finally {
                depth--;
            }
     ...
     */
    protected String formatIterable(com.sun.tools.javac.util.JCDiagnostic d, Iterable<?> it, Locale l) {
     ...
     */
    protected com.sun.tools.javac.util.List<String> formatSubdiagnostics(com.sun.tools.javac.util.JCDiagnostic d, Locale l) {
        com.sun.tools.javac.util.List<String> subdiagnostics = List.nil();
        ...
        if (maxDepth == -1 || depth < maxDepth) {
            ...
            try {
                ...
                int count = 0;
                for (com.sun.tools.javac.util.JCDiagnostic d2 : d.getSubdiagnostics()) {
     ...
     */
    protected String formatSubdiagnostic(com.sun.tools.javac.util.JCDiagnostic parent, com.sun.tools.javac.util.JCDiagnostic sub, Locale l) {
     ...
     */
    protected String formatSourceLine(com.sun.tools.javac.util.JCDiagnostic d, int nSpaces) {
        StringBuilder buf = new StringBuilder();
        DiagnosticSource source = d.getDiagnosticSource();
        int pos = d.getIntPosition();
        if (d.getIntPosition() == com.sun.tools.javac.util.Position.NOPOS)
    ...
    protected String formatLintCategory(com.sun.tools.javac.util.JCDiagnostic d, Locale l) {
