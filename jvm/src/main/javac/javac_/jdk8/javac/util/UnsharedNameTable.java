 ...
 */
public class UnsharedNameTable extends com.sun.tools.javac.util.Name.Table {
    static public com.sun.tools.javac.util.Name.Table create(com.sun.tools.javac.util.Names names) {
     ...
     */
    public UnsharedNameTable(com.sun.tools.javac.util.Names names, int hashSize) {
        super(names);
        hashMask = hashSize - 1;
        ...
        while (element != null) {
            ...
            if (n == null) {
                if (firstTableEntry == element) {
                    ...
                    com.sun.tools.javac.util.Assert.checkNonNull(previousNonNullTableEntry, "previousNonNullTableEntry cannot be null here.");
