...
public class BasicDiagnosticFormatter extends AbstractDiagnosticFormatter {
     ...
     */
    public BasicDiagnosticFormatter(com.sun.tools.javac.util.Options options, com.sun.tools.javac.util.JavacMessages msgs) {
    ...
    public String formatDiagnostic(com.sun.tools.javac.util.JCDiagnostic d, Locale l) {
        if (l == null)
    ...
    public String formatMessage(com.sun.tools.javac.util.JCDiagnostic d, Locale l) {
    ...
    protected String addSourceLineIfNeeded(com.sun.tools.javac.util.JCDiagnostic d, String msg) {
        if (!displaySource(d))
            return msg;
        else {
    ...
    protected String formatMeta(char c, com.sun.tools.javac.util.JCDiagnostic d, Locale l) {
        switch (c) {
            case 'b':
            ...
            case 't': {
                ...
                case FRAGMENT:
                    ...
                    break;
                case ERROR:
                    usePrefix = (d.getIntPosition() == com.sun.tools.javac.util.Position.NOPOS);
                    break;
                default:
                    usePrefix = true;
                }
    ...
    private String selectFormat(JCDiagnostic d) {
        com.sun.tools.javac.util.DiagnosticSource source = d.getDiagnosticSource();
