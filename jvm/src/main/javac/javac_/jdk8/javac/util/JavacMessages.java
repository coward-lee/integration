...
public class JavacMessages implements Messages {
    ...
    public static final com.sun.tools.javac.util.Context.Key<JavacMessages> messagesKey =
        new com.sun.tools.javac.util.Context.Key<JavacMessages>();

    /** Get the JavacMessages instance for this context. */
    public static JavacMessages instance(com.sun.tools.javac.util.Context context) {
    ...
    private Map<Locale, SoftReference<com.sun.tools.javac.util.List<ResourceBundle>>> bundleCache;

    private com.sun.tools.javac.util.List<String> bundleNames;

    private Locale currentLocale;
    private com.sun.tools.javac.util.List<ResourceBundle> currentBundles;
    ...
    public JavacMessages(String bundleName, Locale locale) throws MissingResourceException {
        bundleNames = com.sun.tools.javac.util.List.nil();
        bundleCache = new HashMap<Locale, SoftReference<com.sun.tools.javac.util.List<ResourceBundle>>>();
        add(bundleName);
    ...
    public com.sun.tools.javac.util.List<ResourceBundle> getBundles(Locale locale) {
        if (locale == currentLocale && currentBundles != null)
            return currentBundles;
        SoftReference<com.sun.tools.javac.util.List<ResourceBundle>> bundles = bundleCache.get(locale);
        com.sun.tools.javac.util.List<ResourceBundle> bundleList = bundles == null ? null : bundles.get();
        if (bundleList == null) {
            bundleList = com.sun.tools.javac.util.List.nil();
            ...
            bundleCache.put(locale, new SoftReference<com.sun.tools.javac.util.List<ResourceBundle>>(bundleList));
        }
        return bundleList;
    }
    ...
    static String getDefaultLocalizedString(String key, Object... args) {
        return getLocalizedString(com.sun.tools.javac.util.List.of(getDefaultBundle()), key, args);
    }
    ...
    private static String getLocalizedString(com.sun.tools.javac.util.List<ResourceBundle> bundles,
                                             String key,
                                             Object... args) {
       String msg = null;
