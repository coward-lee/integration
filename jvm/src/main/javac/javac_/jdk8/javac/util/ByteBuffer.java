...
public class ByteBuffer {
    ...
    public void appendByte(int b) {
        elems = com.sun.tools.javac.util.ArrayUtils.ensureCapacity(elems, length);
        elems[length++] = (byte)b;
    }
    ...
    public void appendBytes(byte[] bs, int start, int len) {
        elems = com.sun.tools.javac.util.ArrayUtils.ensureCapacity(elems, length + len);
    ...
    public void appendChar(int x) {
        elems = com.sun.tools.javac.util.ArrayUtils.ensureCapacity(elems, length + 1);
    ...
    /** Append a name.
     */
    public void appendName(com.sun.tools.javac.util.Name name) {
