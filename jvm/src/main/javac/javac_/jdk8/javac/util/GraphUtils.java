...
public class GraphUtils {
     ...
     */
    public static <D, N extends TarjanNode<D>> com.sun.tools.javac.util.List<? extends com.sun.tools.javac.util.List<? extends N>> tarjan(Iterable<? extends N> nodes) {
        ListBuffer<com.sun.tools.javac.util.List<N>> cycles = new ListBuffer<>();
