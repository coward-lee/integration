...
public class Options {
    ...
    public static final com.sun.tools.javac.util.Context.Key<Options> optionsKey =
        new com.sun.tools.javac.util.Context.Key<Options>();

    private LinkedHashMap<String,String> values;

    /** Get the Options instance for this context. */
    public static Options instance(com.sun.tools.javac.util.Context context) {
...
// DEBUGGING -- Use LinkedHashMap for reproducability
    ...
    private java.util.List<Runnable> listeners = List.nil();
