 ...
 */
public class SharedNameTable extends com.sun.tools.javac.util.Name.Table {
    // maintain a freelist of recently used name tables for reuse.
    private static com.sun.tools.javac.util.List<SoftReference<SharedNameTable>> freelist = List.nil();

    static public synchronized SharedNameTable create(com.sun.tools.javac.util.Names names) {
     ...
     */
    public SharedNameTable(com.sun.tools.javac.util.Names names, int hashSize, int nameSize) {
        super(names);
        hashMask = hashSize - 1;
    ...
    public com.sun.tools.javac.util.Name fromChars(char[] cs, int start, int len) {
        int nc = this.nc;
        byte[] bytes = this.bytes = com.sun.tools.javac.util.ArrayUtils.ensureCapacity(this.bytes, nc + len * 3);
    ...
    @Override
    public com.sun.tools.javac.util.Name fromUtf(byte[] cs, int start, int len) {
    ...
    static class NameImpl extends com.sun.tools.javac.util.Name {
        ...
        public boolean equals(Object other) {
            if (other instanceof com.sun.tools.javac.util.Name)
                return
                    table == ((com.sun.tools.javac.util.Name)other).table && index == ((Name) other).getIndex();
            else return false;
        }
