 ...
 */
     ...
     */
    public static com.sun.tools.javac.util.Name shortName(com.sun.tools.javac.util.Name classname) {
     ...
     *  "" if not existent.
     */
    public static com.sun.tools.javac.util.Name packagePart(com.sun.tools.javac.util.Name classname) {
    ...
    public static com.sun.tools.javac.util.List<com.sun.tools.javac.util.Name> enclosingCandidates(com.sun.tools.javac.util.Name name) {
        com.sun.tools.javac.util.List<javac_.jdk8.javac.util.Name> names = List.nil();
        int index;
