 ...
 */
public class CacheFSInfo extends com.sun.tools.javac.file.FSInfo {

    /**
     * Register a Context.Factory to create a CacheFSInfo.
     */
    public static void preRegister(Context context) {
        context.put(com.sun.tools.javac.file.FSInfo.class, new Context.Factory<com.sun.tools.javac.file.FSInfo>() {
            public com.sun.tools.javac.file.FSInfo make(Context c) {
                com.sun.tools.javac.file.FSInfo instance = new CacheFSInfo();
