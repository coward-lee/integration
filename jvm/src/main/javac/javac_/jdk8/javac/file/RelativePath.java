...
package javac_.jdk8.javac.file;
...
public abstract class RelativePath implements Comparable<RelativePath> {
    ...
    public static class RelativeDirectory extends RelativePath {
        ...
        static com.sun.tools.javac.file.RelativePath.RelativeDirectory forPackage(CharSequence packageName) {
            return new com.sun.tools.javac.file.RelativePath.RelativeDirectory(packageName.toString().replace('.', '/'));
        }
         ...
         * @param p must use '/' as an internal separator
         */
        public RelativeDirectory(com.sun.tools.javac.file.RelativePath.RelativeDirectory d, String p) {
            this(d.path + p);
        }
        ...
        public com.sun.tools.javac.file.RelativePath.RelativeDirectory dirname() {
            ...
            return new com.sun.tools.javac.file.RelativePath.RelativeDirectory(path.substring(0, sep + 1));
        }
    ...
    public static class RelativeFile extends RelativePath {
        static com.sun.tools.javac.file.RelativePath.RelativeFile forClass(CharSequence className, JavaFileObject.Kind kind) {
            return new com.sun.tools.javac.file.RelativePath.RelativeFile(className.toString().replace('.', '/') + kind.extension);
        }
         ...
         * @param p must use '/' as an internal separator
         */
        public RelativeFile(com.sun.tools.javac.file.RelativePath.RelativeDirectory d, String p) {
            this(d.path + p);
        }

        RelativeFile(com.sun.tools.javac.file.RelativePath.RelativeDirectory d, RelativePath p) {
            this(d, p.path);
        }
