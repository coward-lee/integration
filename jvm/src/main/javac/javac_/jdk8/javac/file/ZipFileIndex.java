...
public class ZipFileIndex {
     ...
     */
    synchronized Entry getZipIndexEntry(com.sun.tools.javac.file.RelativePath path) {
        try {
            checkIndex();
     ...
     */
    public synchronized boolean contains(com.sun.tools.javac.file.RelativePath path) {
        try {
            checkIndex();
    ...
    public synchronized boolean isDirectory(com.sun.tools.javac.file.RelativePath path) throws IOException {
