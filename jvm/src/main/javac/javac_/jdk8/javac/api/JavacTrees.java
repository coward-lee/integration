...
public class JavacTrees extends DocTrees {
    ...
    public com.sun.tools.javac.api.JavacScope getScope(TreePath path) {
        return new com.sun.tools.javac.api.JavacScope(getAttrContext(path));
    }
    ...
    public boolean isAccessible(Scope scope, TypeElement type) {
        if (scope instanceof com.sun.tools.javac.api.JavacScope && type instanceof ClassSymbol) {
            Env<AttrContext> env = ((com.sun.tools.javac.api.JavacScope) scope).env;
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof com.sun.tools.javac.api.JavacScope
