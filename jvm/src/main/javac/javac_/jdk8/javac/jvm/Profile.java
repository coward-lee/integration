 ...
 */
public enum Profile {
    COMPACT1("compact1", 1, com.sun.tools.javac.jvm.Target.JDK1_8),
    COMPACT2("compact2", 2, com.sun.tools.javac.jvm.Target.JDK1_8),
    COMPACT3("compact3", 3, com.sun.tools.javac.jvm.Target.JDK1_8),

    DEFAULT {
        @Override
        public boolean isValid(com.sun.tools.javac.jvm.Target t) {
            return true;
        }
    };
    ...
    final Set<com.sun.tools.javac.jvm.Target> targets;
    ...
    Profile(String name, int value, com.sun.tools.javac.jvm.Target t, com.sun.tools.javac.jvm.Target... targets) {
        this.name = name;
        this.value = value;
