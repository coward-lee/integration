...
public abstract class Symbol extends AnnoConstruct implements Element {
     ...
     *  @see com.sun.tools.javac.code.Kinds
     */
    public int kind;
     ...
     */
    public Symbol(int kind, long flags, Name name, com.sun.tools.javac.code.Type type, Symbol owner) {
        this.kind = kind;
    ...
    public Symbol location(com.sun.tools.javac.code.Type site, com.sun.tools.javac.code.Types types) {
        if (owner.name == null || owner.name.isEmpty()) {
            return location();
        }
        if (owner.type.hasTag(CLASS)) {
            com.sun.tools.javac.code.Type ownertype = types.asOuterSuper(site, owner);
     ...
     */
    public com.sun.tools.javac.code.Type erasure(com.sun.tools.javac.code.Types types) {
     ...
     */
    public com.sun.tools.javac.code.Type externalType(com.sun.tools.javac.code.Types types) {
        com.sun.tools.javac.code.Type t = erasure(types);
        if (name == name.table.names.init && owner.hasOuterInstance()) {
            com.sun.tools.javac.code.Type outerThisType = types.erasure(owner.type.getEnclosingType());
    ...
    public boolean isPrivate() {
        return (flags_field & com.sun.tools.javac.code.Flags.AccessFlags) == PRIVATE;
    }
     ...
     */
    public boolean isSubClass(Symbol base, com.sun.tools.javac.code.Types types) {
     ...
     */
    public boolean isMemberOf(TypeSymbol clazz, com.sun.tools.javac.code.Types types) {
        return
            owner == clazz ||
    ...
    private boolean hiddenIn(ClassSymbol clazz, com.sun.tools.javac.code.Types types) {
     ...
     */
    private Symbol hiddenInInternal(ClassSymbol currentClass, com.sun.tools.javac.code.Types types) {
        if (currentClass == owner) {
            return this;
        }
        com.sun.tools.javac.code.Scope.Entry e = currentClass.members().lookup(name);
        while (e.scope != null) {
            if (e.sym.kind == kind &&
                    (kind != MTH ||
        ...
        for (com.sun.tools.javac.code.Type st : types.interfaces(currentClass.type)
     ...
     */
    public boolean isInheritedIn(Symbol clazz, com.sun.tools.javac.code.Types types) {
        switch ((int)(flags_field & com.sun.tools.javac.code.Flags.AccessFlags)) {
     ...
     */
    public Symbol asMemberOf(com.sun.tools.javac.code.Type site, com.sun.tools.javac.code.Types types) {
        throw new AssertionError();
    }
     ...
     */
    public boolean overrides(Symbol _other, TypeSymbol origin, com.sun.tools.javac.code.Types types, boolean checkResult) {
        return false;
    }
    ...
    public Set<Modifier> getModifiers() {
        return com.sun.tools.javac.code.Flags.asModifierSet(flags());
    }
    ...
    public List<TypeVariableSymbol> getTypeParameters() {
        ...
        for (com.sun.tools.javac.code.Type t : type.getTypeArguments()) {
    ...
    public static class DelegatedSymbol<T extends Symbol> extends Symbol {
        ...
        public Symbol location(com.sun.tools.javac.code.Type site, com.sun.tools.javac.code.Types types) { return other.location(site, types); }
        public Symbol baseSymbol() { return other; }
        public com.sun.tools.javac.code.Type erasure(com.sun.tools.javac.code.Types types) { return other.erasure(types); }
        public com.sun.tools.javac.code.Type externalType(com.sun.tools.javac.code.Types types) { return other.externalType(types); }
        ...
        public com.sun.tools.javac.code.Scope members() { return other.members(); }
        public boolean isInner() { return other.isInner(); }
        public boolean hasOuterInstance() { return other.hasOuterInstance(); }
        public com.sun.tools.javac.code.Symbol.ClassSymbol enclClass() { return other.enclClass(); }
        public com.sun.tools.javac.code.Symbol.ClassSymbol outermostClass() { return other.outermostClass(); }
        public com.sun.tools.javac.code.Symbol.PackageSymbol packge() { return other.packge(); }
        public boolean isSubClass(Symbol base, com.sun.tools.javac.code.Types types) { return other.isSubClass(base, types); }
        public boolean isMemberOf(com.sun.tools.javac.code.Symbol.TypeSymbol clazz, com.sun.tools.javac.code.Types types) { return other.isMemberOf(clazz, types); }
        public boolean isEnclosedBy(com.sun.tools.javac.code.Symbol.ClassSymbol clazz) { return other.isEnclosedBy(clazz); }
        public boolean isInheritedIn(Symbol clazz, com.sun.tools.javac.code.Types types) { return other.isInheritedIn(clazz, types); }
        public Symbol asMemberOf(com.sun.tools.javac.code.Type site, com.sun.tools.javac.code.Types types) { return other.asMemberOf(site, types); }
        public void complete() throws com.sun.tools.javac.code.Symbol.CompletionFailure { other.complete(); }
    ...
    public static abstract class TypeSymbol extends Symbol {
        public TypeSymbol(int kind, long flags, Name name, com.sun.tools.javac.code.Type type, Symbol owner) {
         ...
         */
        public final boolean precedes(com.sun.tools.javac.code.Symbol.TypeSymbol that, com.sun.tools.javac.code.Types types) {
            if (this == that)
                return false;
        ...
        public java.util.List<Symbol> getEnclosedElements() {
            ...
            for (com.sun.tools.javac.code.Scope.Entry e = members().elems; e != null; e = e.sibling) {
    ...
    public static class TypeVariableSymbol
        ...
        public TypeVariableSymbol(long flags, Name name, com.sun.tools.javac.code.Type type, Symbol owner) {
        ...
        public List<com.sun.tools.javac.code.Type> getBounds() {
            TypeVar t = (TypeVar)type;
            com.sun.tools.javac.code.Type bound = t.getUpperBound();
            if (!bound.isCompound())
    ...
    public static class PackageSymbol extends TypeSymbol
        ...
        public com.sun.tools.javac.code.Symbol.ClassSymbol package_info; // see bug 6443073

        public PackageSymbol(Name name, com.sun.tools.javac.code.Type type, Symbol owner) {
    ...
    public static class ClassSymbol extends TypeSymbol implements TypeElement {
         ...
         */
        public List<com.sun.tools.javac.code.Symbol.ClassSymbol> trans_local;

        /** the constant pool of the class
         */
        public Pool pool;

        public ClassSymbol(long flags, Name name, com.sun.tools.javac.code.Type type, Symbol owner) {
            super(TYP, flags, name, type, owner);
            this.members_field = null;
            this.fullname = formFullName(name, owner);
        ...
        public ClassSymbol(long flags, Name name, Symbol owner) {
            this(
                flags,
                name,
                new ClassType(com.sun.tools.javac.code.Type.noType, null, null),
                owner);
            this.type.tsym = this;
        }
        ...
        public com.sun.tools.javac.code.Type erasure(com.sun.tools.javac.code.Types types) {
            if (erasure_field == null)
                erasure_field = new ClassType(types.erasure(type.getEnclosingType()),
                                              List.<com.sun.tools.javac.code.Type>nil(), this);
            return erasure_field;
        }
        ...
        public boolean isSubClass(Symbol base, com.sun.tools.javac.code.Types types) {
            if (this == base) {
                ...
                for (com.sun.tools.javac.code.Type t = type; t.hasTag(CLASS); t = types.supertype(t))
                    for (List<com.sun.tools.javac.code.Type> is = types.interfaces(t);
                         is.nonEmpty();
                         is = is.tail)
        ...
        public void complete() throws com.sun.tools.javac.code.Symbol.CompletionFailure {
            try {
                ...
                this.type = new ErrorType(this, com.sun.tools.javac.code.Type.noType);
                throw ex;
            }
        }

        public List<com.sun.tools.javac.code.Type> getInterfaces() {
            complete();
            if (type instanceof ClassType) {
                ...
                if (t.all_interfaces_field != null)
                    return com.sun.tools.javac.code.Type.getModelTypes(t.all_interfaces_field);
        ...
        public com.sun.tools.javac.code.Type getSuperclass() {
            ...
            if (type instanceof ClassType) {
                ...
                if (t.supertype_field == null) // FIXME: shouldn't be null
                    t.supertype_field = com.sun.tools.javac.code.Type.noType;
        ...
        private com.sun.tools.javac.code.Symbol.ClassSymbol getSuperClassToSearchForAnnotations() {
            ...
            com.sun.tools.javac.code.Type sup = getSuperclass();

            if (!sup.hasTag(CLASS) || sup.isErroneous())
                return null;

            return (com.sun.tools.javac.code.Symbol.ClassSymbol) sup.tsym;
        }
        ...
        protected <A extends Annotation> A[] getInheritedAnnotations(Class<A> annoType) {
            ...
            com.sun.tools.javac.code.Symbol.ClassSymbol sup = getSuperClassToSearchForAnnotations();
        ...
        public Set<Modifier> getModifiers() {
            long flags = flags();
            return com.sun.tools.javac.code.Flags.asModifierSet(flags & ~DEFAULT);
        }
        ...
        protected <A extends Annotation> Attribute.Compound getAttribute(final Class<A> annoType) {
            ...
            // Search supertypes
            com.sun.tools.javac.code.Symbol.ClassSymbol superType = getSuperClassToSearchForAnnotations();
        ...
        public void markAbstractIfNeeded(com.sun.tools.javac.code.Types types) {
    ...
    public static class VarSymbol extends Symbol implements VariableElement {
         ...
         */
        public VarSymbol(long flags, Name name, com.sun.tools.javac.code.Type type, Symbol owner) {
            super(VAR, flags, name, type, owner);
        }

        /** Clone this symbol with new owner.
         */
        public com.sun.tools.javac.code.Symbol.VarSymbol clone(Symbol newOwner) {
            com.sun.tools.javac.code.Symbol.VarSymbol v = new com.sun.tools.javac.code.Symbol.VarSymbol(flags_field, name, type, newOwner) {
                @Override
                public Symbol baseSymbol() {
                    return com.sun.tools.javac.code.Symbol.VarSymbol.this;
                }
            };
            v.pos = pos;
            v.adr = adr;
...
//          System.out.println("clone " + v + " in " + newOwner);//DEBUG
        ...
        public Symbol asMemberOf(com.sun.tools.javac.code.Type site, com.sun.tools.javac.code.Types types) {
            return new com.sun.tools.javac.code.Symbol.VarSymbol(flags_field, name, types.memberType(site, this), owner);
        }
    ...
    public static class MethodSymbol extends Symbol implements ExecutableElement {
        ...
        public List<com.sun.tools.javac.code.Symbol.VarSymbol> extraParams = List.nil();

        /** The captured local variables in an anonymous class */
        public List<com.sun.tools.javac.code.Symbol.VarSymbol> capturedLocals = List.nil();

        /** The parameters of the method. */
        public List<com.sun.tools.javac.code.Symbol.VarSymbol> params = null;
         ...
         */
        public MethodSymbol(long flags, Name name, com.sun.tools.javac.code.Type type, Symbol owner) {
        ...
        /** Clone this symbol with new owner.
         */
        public com.sun.tools.javac.code.Symbol.MethodSymbol clone(Symbol newOwner) {
            com.sun.tools.javac.code.Symbol.MethodSymbol m = new com.sun.tools.javac.code.Symbol.MethodSymbol(flags_field, name, type, newOwner) {
                @Override
                public Symbol baseSymbol() {
                    return com.sun.tools.javac.code.Symbol.MethodSymbol.this;
                }
            };
            m.code = code;
            return m;
        ...
        public Set<Modifier> getModifiers() {
            long flags = flags();
            return com.sun.tools.javac.code.Flags.asModifierSet((flags & DEFAULT) != 0 ? flags & ~ABSTRACT : flags);
        }
         ...
         *                    implementations
         */
        public Symbol implemented(com.sun.tools.javac.code.Symbol.TypeSymbol c, com.sun.tools.javac.code.Types types) {
            Symbol impl = null;
            for (List<com.sun.tools.javac.code.Type> is = types.interfaces(c.type);
                 impl == null && is.nonEmpty();
                 is = is.tail) {
                com.sun.tools.javac.code.Symbol.TypeSymbol i = is.head.tsym;
        ...
        public Symbol implementedIn(com.sun.tools.javac.code.Symbol.TypeSymbol c, com.sun.tools.javac.code.Types types) {
            Symbol impl = null;
            for (com.sun.tools.javac.code.Scope.Entry e = c.members().lookup(name);
                 impl == null && e.scope != null;
                 e = e.next()) {
                if (this.overrides(e.sym, (com.sun.tools.javac.code.Symbol.TypeSymbol)owner, types, true) &&
         ...
         */
        public boolean binaryOverrides(Symbol _other, com.sun.tools.javac.code.Symbol.TypeSymbol origin, com.sun.tools.javac.code.Types types) {
            if (isConstructor() || _other.kind != MTH) return false;

            if (this == _other) return true;
            com.sun.tools.javac.code.Symbol.MethodSymbol other = (com.sun.tools.javac.code.Symbol.MethodSymbol)_other;

            // check for a direct implementation
            if (other.isOverridableIn((com.sun.tools.javac.code.Symbol.TypeSymbol)owner) &&
         ...
         */
        public com.sun.tools.javac.code.Symbol.MethodSymbol binaryImplementation(com.sun.tools.javac.code.Symbol.ClassSymbol origin, com.sun.tools.javac.code.Types types) {
            for (com.sun.tools.javac.code.Symbol.TypeSymbol c = origin; c != null; c = types.supertype(c.type).tsym) {
                for (Scope.Entry e = c.members().lookup(name);
                     e.scope != null;
                     e = e.next()) {
                    if (e.sym.kind == MTH &&
                        ((com.sun.tools.javac.code.Symbol.MethodSymbol)e.sym).binaryOverrides(this, origin, types))
                        return (com.sun.tools.javac.code.Symbol.MethodSymbol)e.sym;
                }
            }
            return null;
        }
         ...
         *  See JLS 8.4.6.1 (without transitivity) and 8.4.6.4
         */
        public boolean overrides(Symbol _other, com.sun.tools.javac.code.Symbol.TypeSymbol origin, com.sun.tools.javac.code.Types types, boolean checkResult) {
            if (isConstructor() || _other.kind != MTH) return false;
            ...
            if (other.isOverridableIn((com.sun.tools.javac.code.Symbol.TypeSymbol)owner) &&
                types.asSuper(owner.type, other.owner) != null) {
                com.sun.tools.javac.code.Type mt = types.memberType(owner.type, this);
                com.sun.tools.javac.code.Type ot = types.memberType(owner.type, other);
            ...
            com.sun.tools.javac.code.Type mt = types.memberType(origin.type, this);
            com.sun.tools.javac.code.Type ot = types.memberType(origin.type, other);
            return
                types.isSubSignature(mt, ot) &&
                (!checkResult || types.resultSubtype(mt, ot, types.noWarnings));
        }

        private boolean isOverridableIn(com.sun.tools.javac.code.Symbol.TypeSymbol origin) {
            // JLS 8.4.6.1
            switch ((int)(flags_field & com.sun.tools.javac.code.Flags.AccessFlags)) {
            case com.sun.tools.javac.code.Flags.PRIVATE:
                return false;
            case com.sun.tools.javac.code.Flags.PUBLIC:
                return !this.owner.isInterface() ||
                        (flags_field & STATIC) == 0;
            case com.sun.tools.javac.code.Flags.PROTECTED:
         ...
         */
        public com.sun.tools.javac.code.Symbol.MethodSymbol implementation(com.sun.tools.javac.code.Symbol.TypeSymbol origin, com.sun.tools.javac.code.Types types, boolean checkResult) {
        ...
        public com.sun.tools.javac.code.Symbol.MethodSymbol implementation(com.sun.tools.javac.code.Symbol.TypeSymbol origin, com.sun.tools.javac.code.Types types, boolean checkResult, Filter<Symbol> implFilter) {
            com.sun.tools.javac.code.Symbol.MethodSymbol res = types.implementation(this, origin, checkResult, implFilter);
            if (res != null)
                return res;
        ...
        public List<com.sun.tools.javac.code.Symbol.VarSymbol> params() {
            owner.complete();
            if (params == null) {
                ...
                ListBuffer<com.sun.tools.javac.code.Symbol.VarSymbol> buf = new ListBuffer<com.sun.tools.javac.code.Symbol.VarSymbol>();
                List<Name> remaining = paramNames;
                // assert: remaining and paramNames are both empty or both
                // have same cardinality as type.getParameterTypes()
                int i = 0;
                for (com.sun.tools.javac.code.Type t : type.getParameterTypes()) {
                    Name paramName;
                    ...
                    buf.append(new com.sun.tools.javac.code.Symbol.VarSymbol(PARAMETER, paramName, t, this));
                    i++;
                }
                params = buf.toList();
            }
        ...
        public Symbol asMemberOf(com.sun.tools.javac.code.Type site, Types types) {
            return new com.sun.tools.javac.code.Symbol.MethodSymbol(flags_field, name, types.memberType(site, this), owner);
        }
        ...
        public List<com.sun.tools.javac.code.Symbol.VarSymbol> getParameters() {
            return params();
        }
        ...
        public List<com.sun.tools.javac.code.Type> getThrownTypes() {
    ...
    public static class DynamicMethodSymbol extends MethodSymbol {
        ...
        public DynamicMethodSymbol(Name name, Symbol owner, int bsmKind, com.sun.tools.javac.code.Symbol.MethodSymbol bsm, com.sun.tools.javac.code.Type type, Object[] staticArgs) {
