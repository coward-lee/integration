    ...
    */
    ...
    public static class JCPrimitiveType extends Type
        ...
        public Type constType(Object constValue) {
            ...
            return new com.sun.tools.javac.code.Type.JCPrimitiveType(tag, tsym) {
                    @Override
                    public Object constValue() {
                        return value;
                    }
    ...
    public static class WildcardType extends Type
        ...
        public WildcardType(javax.lang.model.type.WildcardType t, com.sun.tools.javac.code.Type.TypeVar bound) {
            this(t.type, t.kind, t.tsym, bound);
        }

        public WildcardType(Type type, BoundKind kind, TypeSymbol tsym, com.sun.tools.javac.code.Type.TypeVar bound) {
            this(type, kind, tsym);
            this.bound = bound;
        }
        ...
        public Type withTypeVar(Type t) {
            ...
            if (bound == t)
                return this;
            bound = (com.sun.tools.javac.code.Type.TypeVar)t;
            return this;
        }
        ...
        public Type map(Mapping f) {
            ...
            if (t == type)
                ...
                return new javax.lang.model.type.WildcardType(t, kind, tsym, bound);
        }
    ...
    public static class ClassType extends Type implements DeclaredType {
        ...
        public Type constType(Object constValue) {
            final Object value = constValue;
            return new com.sun.tools.javac.code.Type.ClassType(getEnclosingType(), typarams_field, tsym) {
                    @Override
                    public Object constValue() {
                        return value;
                    }
...
//where
            private String className(Symbol sym, boolean longform) {
                if (sym.name.isEmpty() && (sym.flags() & COMPOUND) != 0) {
                    ...
                    String s;
                    com.sun.tools.javac.code.Type.ClassType norm = (com.sun.tools.javac.code.Type.ClassType) tsym.type.unannotatedType();
                    if (norm == null) {
        ...
        public Type map(Mapping f) {
            ...
            else return new com.sun.tools.javac.code.Type.ClassType(outer1, typarams1, tsym);
        }
    ...
    public static class UnionClassType extends ClassType implements UnionType {
        ...
        public UnionClassType(com.sun.tools.javac.code.Type.ClassType ct, List<? extends Type> alternatives) {
    ...
    public static class ArrayType extends Type
        ...
        public boolean equals(Object obj) {
            return
                this == obj ||
                (obj instanceof javax.lang.model.type.ArrayType &&
                 this.elemtype.equals(((javax.lang.model.type.ArrayType)obj).elemtype));
        }
        ...
        public javax.lang.model.type.ArrayType makeVarargs() {
            return new javax.lang.model.type.ArrayType(elemtype, tsym) {
                @Override
                public boolean isVarargs() {
                    return true;
                }
        ...
        public Type map(Mapping f) {
            ...
            else return new javax.lang.model.type.ArrayType(elemtype1, tsym);
        }
    ...
    public static class MethodType extends Type implements ExecutableType {
        ...
        public Type map(Mapping f) {
            ...
            else return new com.sun.tools.javac.code.Type.MethodType(argtypes1, restype1, thrown1, tsym);
        }
        ...
        public com.sun.tools.javac.code.Type.MethodType asMethodType() { return this; }
        ...
        public List<com.sun.tools.javac.code.Type.TypeVar> getTypeVariables() {
            return List.nil();
        }
    ...
    public static class CapturedType extends TypeVar {
        ...
        public javax.lang.model.type.WildcardType wildcard;
    ...
    public static class ForAll extends DelegatedType implements ExecutableType {
        ...
        public ForAll(List<Type> tvars, Type qtype) {
            super(FORALL, (com.sun.tools.javac.code.Type.MethodType)qtype);
            this.tvars = tvars;
        }
        ...
        public com.sun.tools.javac.code.Type.MethodType asMethodType() {
            return (com.sun.tools.javac.code.Type.MethodType)qtype;
        }

        public void complete() {
            for (List<Type> l = tvars; l.nonEmpty(); l = l.tail) {
                ((com.sun.tools.javac.code.Type.TypeVar)l.head).bound.complete();
            }
            qtype.complete();
        }

        public List<com.sun.tools.javac.code.Type.TypeVar> getTypeVariables() {
            return List.convert(com.sun.tools.javac.code.Type.TypeVar.class, getTypeArguments());
        }
    ...
    public static class UndetVar extends DelegatedType {
        ...
        public interface UndetVarListener {
            ...
            void varChanged(com.sun.tools.javac.code.Type.UndetVar uv, Set<InferenceBound> ibs);
        }
        ...
        public UndetVar(com.sun.tools.javac.code.Type.TypeVar origin, Types types) {
            ...
            Mapping toTypeVarMap = new Mapping("toTypeVarMap") {
                ...
                public Type apply(Type t) {
                    if (t.hasTag(UNDETVAR)) {
                        com.sun.tools.javac.code.Type.UndetVar uv = (com.sun.tools.javac.code.Type.UndetVar)t;
        ...
        public void substBounds(List<Type> from, List<Type> to, Types types) {
            ...
            try {
                ...
                listener = new UndetVarListener() {
                    public void varChanged(com.sun.tools.javac.code.Type.UndetVar uv, Set<InferenceBound> ibs) {
    ...
    public static class CapturedUndetVar extends UndetVar {
        ...
        public CapturedUndetVar(com.sun.tools.javac.code.Type.CapturedType origin, Types types) {
            super(origin, types);
            if (!origin.lower.hasTag(BOT)) {
                bounds.put(com.sun.tools.javac.code.Type.UndetVar.InferenceBound.LOWER, List.of(origin.lower));
            }
        }

        @Override
        public void addBound(com.sun.tools.javac.code.Type.UndetVar.InferenceBound ib, Type bound, Types types, boolean update) {
            if (update) {
    ...
    public static class AnnotatedType extends Type
        ...
        // TODO: attach annotations?
        @Override
        public com.sun.tools.javac.code.Type.MethodType asMethodType()         { return underlyingType.asMethodType(); }

        @Override
        public void complete()                   { underlyingType.complete(); }

        @Override
        public TypeMirror getComponentType()     { return ((javax.lang.model.type.ArrayType)underlyingType).getComponentType(); }

        // The result is an ArrayType, but only in the model sense, not the Type sense.
        public Type makeVarargs() {
            return ((javax.lang.model.type.ArrayType) underlyingType).makeVarargs().annotatedType(typeAnnotations);
        }

        @Override
        public TypeMirror getExtendsBound()      { return ((javax.lang.model.type.WildcardType)underlyingType).getExtendsBound(); }
        @Override
        public TypeMirror getSuperBound()        { return ((javax.lang.model.type.WildcardType)underlyingType).getSuperBound(); }
    }
