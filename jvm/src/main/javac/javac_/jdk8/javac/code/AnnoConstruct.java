...
public abstract class AnnoConstruct implements AnnotatedConstruct {
    ...
    @Override
    public abstract List<? extends com.sun.tools.javac.code.Attribute.Compound> getAnnotationMirrors();


    // This method is part of the javax.lang.model API, do not use this in javac code.
    protected <A extends Annotation> com.sun.tools.javac.code.Attribute.Compound getAttribute(Class<A> annoType) {
        String name = annoType.getName();

        for (com.sun.tools.javac.code.Attribute.Compound anno : getAnnotationMirrors()) {
    ...
    public <A extends Annotation> A[] getAnnotationsByType(Class<A> annoType) {
        ...
        com.sun.tools.javac.code.Attribute.Compound direct = null, container = null;
        // Find directly (explicit or implicit) present annotations
        int index = -1;
        for (com.sun.tools.javac.code.Attribute.Compound attribute : getAnnotationMirrors()) {
            index++;
        ...
        com.sun.tools.javac.code.Attribute.Compound[] contained = unpackContained(container);
    ...
    private com.sun.tools.javac.code.Attribute.Compound[] unpackContained(com.sun.tools.javac.code.Attribute.Compound container) {
        // Pack them in an array
        com.sun.tools.javac.code.Attribute[] contained0 = null;
        if (container != null)
            contained0 = unpackAttributes(container);
        ListBuffer<com.sun.tools.javac.code.Attribute.Compound> compounds = new ListBuffer<>();
        if (contained0 != null) {
            for (com.sun.tools.javac.code.Attribute a : contained0)
                if (a instanceof com.sun.tools.javac.code.Attribute.Compound)
                    compounds = compounds.append((com.sun.tools.javac.code.Attribute.Compound)a);
        }
        return compounds.toArray(new com.sun.tools.javac.code.Attribute.Compound[compounds.size()]);
    }
    ...
    public <A extends Annotation> A getAnnotation(Class<A> annoType) {
        ...
        com.sun.tools.javac.code.Attribute.Compound c = getAttribute(annoType);
    ...
    // Helper to getAnnotationsByType
    private static com.sun.tools.javac.code.Attribute[] unpackAttributes(com.sun.tools.javac.code.Attribute.Compound container) {
