...
public class Symtab {
    ...
    public final com.sun.tools.javac.code.Type botType = new BottomType();
     ...
     */
    public final com.sun.tools.javac.code.Type[] typeOfTag = new com.sun.tools.javac.code.Type[TypeTag.getTypeTagCount()];
    ...
    public void initType(com.sun.tools.javac.code.Type type, ClassSymbol c) {
        type.tsym = c;
        typeOfTag[type.getTag().ordinal()] = type;
    }

    public void initType(com.sun.tools.javac.code.Type type, String name) {
        initType(
            type,
            new ClassSymbol(
    ...
    public void initType(com.sun.tools.javac.code.Type type, String name, String bname) {
        initType(type, name);
     ...
     */
    private VarSymbol enterConstant(String name, com.sun.tools.javac.code.Type type) {
    ...
    private void enterBinop(String name,
                            com.sun.tools.javac.code.Type left, com.sun.tools.javac.code.Type right, com.sun.tools.javac.code.Type res,
                            int opcode) {
        predefClass.members().enter(
            new OperatorSymbol(
                makeOperatorName(name),
                new MethodType(List.of(left, right), res,
                               List.<com.sun.tools.javac.code.Type>nil(), methodClass),
                opcode,
                predefClass));
    }
     ...
     */
    private com.sun.tools.javac.code.Type enterClass(String s) {
        return reader.enterClass(names.fromString(s)).type;
    }

    public void synthesizeEmptyInterfaceIfMissing(final com.sun.tools.javac.code.Type type) {
        final Completer completer = type.tsym.completer;
        if (completer != null) {
            type.tsym.completer = new Completer() {
                public void complete(com.sun.tools.javac.code.Symbol sym) throws CompletionFailure {
                    try {
    ...
    public void synthesizeBoxTypeIfMissing(final com.sun.tools.javac.code.Type type) {
                    ...
                    try {
                        ...
                        MethodSymbol unboxMethod =
                            new MethodSymbol(PUBLIC,
                                ...
                                new MethodType(List.<com.sun.tools.javac.code.Type>nil(), type,
                                    List.<com.sun.tools.javac.code.Type>nil(), methodClass),
                                sym);
    ...
    private com.sun.tools.javac.code.Type enterSyntheticAnnotation(String name) {
        ClassType type = (ClassType)enterClass(name);
        ClassSymbol sym = (ClassSymbol)type.tsym;
        sym.completer = null;
        sym.flags_field = PUBLIC|ACYCLIC|ANNOTATION|INTERFACE;
        sym.erasure_field = type;
        sym.members_field = new com.sun.tools.javac.code.Scope(sym);
    ...
    protected Symtab(Context context) throws CompletionFailure {
        ...
        noSymbol = new TypeSymbol(Kinds.NIL, 0, names.empty, com.sun.tools.javac.code.Type.noType, rootPackage) {
        ...
        errType = new ErrorType(errSymbol, com.sun.tools.javac.code.Type.noType);

        unknownSymbol = new ClassSymbol(PUBLIC|STATIC|ACYCLIC, names.fromString("<any?>"), null, rootPackage);
        unknownSymbol.members_field = new com.sun.tools.javac.code.Scope.ErrorScope(unknownSymbol);
        ...
        boundClass.members_field = new com.sun.tools.javac.code.Scope.ErrorScope(boundClass);

        // the builtin class of all methods
        methodClass = new ClassSymbol(PUBLIC|ACYCLIC, names.Method, noSymbol);
        methodClass.members_field = new com.sun.tools.javac.code.Scope.ErrorScope(boundClass);

        // Create class to hold all predefined constants and operations.
        predefClass = new ClassSymbol(PUBLIC|ACYCLIC, names.empty, rootPackage);
        com.sun.tools.javac.code.Scope scope = new com.sun.tools.javac.code.Scope(predefClass);
        ...
        enumFinalFinalize =
            new MethodSymbol(PROTECTED|FINAL|HYPOTHETICAL,
                             names.finalize,
                             new MethodType(List.<com.sun.tools.javac.code.Type>nil(), voidType,
                                            List.<com.sun.tools.javac.code.Type>nil(), methodClass),
                             enumSym);
        ...
        arrayCloneMethod = new MethodSymbol(
            PUBLIC,
            names.clone,
            new MethodType(List.<com.sun.tools.javac.code.Type>nil(), objectType,
