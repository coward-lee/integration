...
package javac_.jdk8.javac.code;
...
public class Types {
    ...
    // </editor-fold>
      ...
      */
     public com.sun.tools.javac.code.Type wildUpperBound(com.sun.tools.javac.code.Type t) {
      ...
      * @param t a type
      */
     public com.sun.tools.javac.code.Type cvarUpperBound(com.sun.tools.javac.code.Type t) {
         if (t.hasTag(TYPEVAR)) {
     ...
     * @param t a type argument, either a wildcard or a type
     */
    public com.sun.tools.javac.code.Type wildLowerBound(com.sun.tools.javac.code.Type t) {
        if (t.hasTag(WILDCARD)) {
            WildcardType w = (WildcardType) t.unannotatedType();
     ...
     * @param t a type
     */
    public com.sun.tools.javac.code.Type cvarLowerBound(com.sun.tools.javac.code.Type t) {
        if (t.hasTag(TYPEVAR)) {
            TypeVar v = (TypeVar) t.unannotatedType();
     ...
     */
    public boolean isUnbounded(com.sun.tools.javac.code.Type t) {
        return isUnbounded.visit(t);
    }
    // where
        private final UnaryVisitor<Boolean> isUnbounded = new UnaryVisitor<Boolean>() {

            public Boolean visitType(com.sun.tools.javac.code.Type t, Void ignored) {
                return true;
            }

            @Override
            public Boolean visitClassType(ClassType t, Void ignored) {
                List<com.sun.tools.javac.code.Type> parms = t.tsym.type.allparams();
                List<com.sun.tools.javac.code.Type> args = t.allparams();
     ...
     * returned.
     */
    public com.sun.tools.javac.code.Type asSub(com.sun.tools.javac.code.Type t, Symbol sym) {
        return asSub.visit(t, sym);
    }
    // where
        private final SimpleVisitor<com.sun.tools.javac.code.Type,Symbol> asSub = new SimpleVisitor<com.sun.tools.javac.code.Type,Symbol>() {

            public com.sun.tools.javac.code.Type visitType(com.sun.tools.javac.code.Type t, Symbol sym) {
                return null;
            }

            @Override
            public com.sun.tools.javac.code.Type visitClassType(ClassType t, Symbol sym) {
                if (t.tsym == sym)
                    return t;
                com.sun.tools.javac.code.Type base = asSuper(sym.type, t.tsym);
                if (base == null)
                    return null;
                ListBuffer<com.sun.tools.javac.code.Type> from = new ListBuffer<com.sun.tools.javac.code.Type>();
                ListBuffer<com.sun.tools.javac.code.Type> to = new ListBuffer<com.sun.tools.javac.code.Type>();
                try {
                    adapt(base, t, from, to);
                } catch (AdaptFailure ex) {
                    return null;
                }
                com.sun.tools.javac.code.Type res = subst(sym.type, from.toList(), to.toList());
                if (!isSubtype(res, t))
                    return null;
                ListBuffer<com.sun.tools.javac.code.Type> openVars = new ListBuffer<com.sun.tools.javac.code.Type>();
                for (List<com.sun.tools.javac.code.Type> l = sym.type.allparams();
                     l.nonEmpty(); l = l.tail)
                ...
                if (openVars.nonEmpty()) {
                    if (t.isRaw()) {
                        ...
                        List<com.sun.tools.javac.code.Type> opens = openVars.toList();
                        ListBuffer<com.sun.tools.javac.code.Type> qs = new ListBuffer<com.sun.tools.javac.code.Type>();
                        for (List<com.sun.tools.javac.code.Type> iter = opens; iter.nonEmpty(); iter = iter.tail) {
            ...
            @Override
            public com.sun.tools.javac.code.Type visitErrorType(ErrorType t, Symbol sym) {
                return t;
            }
        };
    // </editor-fold>
     ...
     * conversion to s?
     */
    public boolean isConvertible(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, Warner warn) {
        if (t.hasTag(ERROR)) {
            return true;
        }
     ...
     * conversions to s?
     */
    public boolean isConvertible(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
    ...
    class DescriptorCache {
        ...
        class FunctionDescriptor {
            ...
            public com.sun.tools.javac.code.Type getType(com.sun.tools.javac.code.Type site) {
        ...
        public FunctionDescriptor findDescriptorInternal(TypeSymbol origin,
            ...
            for (Symbol sym : membersCache.getElements(new DescriptorFilter(origin))) {
                com.sun.tools.javac.code.Type mtype = memberType(origin.type, sym);
                if (abstracts.isEmpty() ||
                    ...
                    throw failure("not.a.functional.intf.1",  origin,
                            diags.fragment("incompatible.abstracts", com.sun.tools.javac.code.Kinds.kindName(origin), origin));
                }
            }
            if (abstracts.isEmpty()) {
                //t must define a suitable non-generic method
                throw failure("not.a.functional.intf.1", origin,
                            diags.fragment("no.abstracts", com.sun.tools.javac.code.Kinds.kindName(origin), origin));
                ...
                if (descRes == null) {
                    ...
                    JCDiagnostic.MultilineDiagnostic incompatibleDescriptors =
                            ...
                            com.sun.tools.javac.code.Kinds.kindName(origin), origin), descriptors.toList());
        ...
        private FunctionDescriptor mergeDescriptors(TypeSymbol origin, List<Symbol> methodSyms) {
            ...
            outer: for (Symbol msym1 : methodSyms) {
                com.sun.tools.javac.code.Type mt1 = memberType(origin.type, msym1);
                for (Symbol msym2 : methodSyms) {
                    com.sun.tools.javac.code.Type mt2 = memberType(origin.type, msym2);
            ...
            List<com.sun.tools.javac.code.Type> thrown = null;
            com.sun.tools.javac.code.Type mt1 = memberType(origin.type, bestSoFar);
            for (Symbol msym2 : methodSyms) {
                com.sun.tools.javac.code.Type mt2 = memberType(origin.type, msym2);
                List<com.sun.tools.javac.code.Type> thrown_mt2 = mt2.getThrownTypes();
                if (toErase) {
            ...
            final List<com.sun.tools.javac.code.Type> thrown1 = thrown;
            return new FunctionDescriptor(bestSoFar) {
                @Override
                public com.sun.tools.javac.code.Type getType(com.sun.tools.javac.code.Type origin) {
                    com.sun.tools.javac.code.Type mt = memberType(origin, getSymbol());
                    return createMethodTypeWithThrown(mt, thrown1);
                }
            };
        }

        boolean isSubtypeInternal(com.sun.tools.javac.code.Type s, com.sun.tools.javac.code.Type t) {
     ...
     */
    public com.sun.tools.javac.code.Type findDescriptorType(com.sun.tools.javac.code.Type origin) throws FunctionDescriptorLookupError {
    ...
    public boolean isFunctionalInterface(com.sun.tools.javac.code.Type site) {
        try {
    ...
    public com.sun.tools.javac.code.Type removeWildcards(com.sun.tools.javac.code.Type site) {
        com.sun.tools.javac.code.Type capturedSite = capture(site);
        if (capturedSite != site) {
            com.sun.tools.javac.code.Type formalInterface = site.tsym.type;
            ListBuffer<com.sun.tools.javac.code.Type> typeargs = new ListBuffer<>();
            List<com.sun.tools.javac.code.Type> actualTypeargs = site.getTypeArguments();
            List<com.sun.tools.javac.code.Type> capturedTypeargs = capturedSite.getTypeArguments();
            //simply replace the wildcards with its bound
            for (com.sun.tools.javac.code.Type t : formalInterface.getTypeArguments()) {
     ...
     */
    public ClassSymbol makeFunctionalInterfaceClass(Env<AttrContext> env, Name name, List<com.sun.tools.javac.code.Type> targets, long cflags) {
        if (targets.isEmpty()) {
            return null;
        }
        Symbol descSym = findDescriptorSymbol(targets.head.tsym);
        com.sun.tools.javac.code.Type descType = findDescriptorType(targets.head);
        ClassSymbol csym = new ClassSymbol(cflags, name, env.enclClass.sym.outermostClass());
        csym.completer = null;
        csym.members_field = new com.sun.tools.javac.code.Scope(csym);
        MethodSymbol instDescSym = new MethodSymbol(descSym.flags(), descSym.name, descType, csym);
        csym.members_field.enter(instDescSym);
        com.sun.tools.javac.code.Type.ClassType ctype = new com.sun.tools.javac.code.Type.ClassType(com.sun.tools.javac.code.Type.noType, List.<com.sun.tools.javac.code.Type>nil(), csym);
    ...
    //where
        private Filter<Symbol> bridgeFilter = new Filter<Symbol>() {
            public boolean accepts(Symbol t) {
                return t.kind == com.sun.tools.javac.code.Kinds.MTH &&
                        t.name != names.init &&
                        t.name != names.clinit &&
                        (t.flags() & SYNTHETIC) == 0;
            }
        ...
        private boolean pendingBridges(ClassSymbol origin, TypeSymbol s) {
            ...
            for (com.sun.tools.javac.code.Type t : interfaces(origin.type)) {
    ...
    */
    class DescriptorFilter implements Filter<Symbol> {
       ...
       public boolean accepts(Symbol sym) {
           return sym.kind == com.sun.tools.javac.code.Kinds.MTH &&
     ...
     */
    public boolean isSubtypeUnchecked(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
        return isSubtypeUnchecked(t, s, noWarnings);
    }
    /**
     * Is t an unchecked subtype of s?
     */
    public boolean isSubtypeUnchecked(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, Warner warn) {
    ...
    //where
        private boolean isSubtypeUncheckedInternal(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, Warner warn) {
            if (t.hasTag(ARRAY) && s.hasTag(ARRAY)) {
                ...
                com.sun.tools.javac.code.Type t2 = asSuper(t, s.tsym);
                if (t2 != null && t2.isRaw()) {
                    if (isReifiable(s)) {
        ...
        private void checkUnsafeVarargsConversion(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, Warner warn) {
     ...
     */
    final public boolean isSubtype(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
        return isSubtype(t, s, true);
    }
    final public boolean isSubtypeNoCapture(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
    ...
    public boolean isSubtype(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, boolean capture) {
        ...
        if (s.isCompound()) {
            for (com.sun.tools.javac.code.Type s2 : interfaces(s).prepend(supertype(s))) {
        ...
        if (!t.hasTag(UNDETVAR) && !t.isCompound()) {
            ...
            com.sun.tools.javac.code.Type lower = cvarLowerBound(wildLowerBound(s));
            if (s != lower)
    ...
    // where
        ...
        {
            @Override
            public Boolean visitType(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
                switch (t.getTag()) {
                 case BYTE:
            ...
            private boolean containsTypeRecursive(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
            ...
            private com.sun.tools.javac.code.Type rewriteSupers(com.sun.tools.javac.code.Type t) {
                ...
                if (from.isEmpty())
                    return t;
                ListBuffer<com.sun.tools.javac.code.Type> rewrite = new ListBuffer<>();
                boolean changed = false;
                for (com.sun.tools.javac.code.Type orig : to.toList()) {
                    com.sun.tools.javac.code.Type s = rewriteSupers(orig);
            ...
            @Override
            public Boolean visitClassType(ClassType t, com.sun.tools.javac.code.Type s) {
                com.sun.tools.javac.code.Type sup = asSuper(t, s.tsym);
            ...
            @Override
            public Boolean visitArrayType(ArrayType t, com.sun.tools.javac.code.Type s) {
                if (s.hasTag(ARRAY)) {
            ...
            @Override
            public Boolean visitUndetVar(UndetVar t, com.sun.tools.javac.code.Type s) {
            ...
            @Override
            public Boolean visitErrorType(ErrorType t, com.sun.tools.javac.code.Type s) {
                return true;
            }
        };
     ...
     */
    public boolean isSubtypeUnchecked(com.sun.tools.javac.code.Type t, List<com.sun.tools.javac.code.Type> ts, Warner warn) {
        for (List<com.sun.tools.javac.code.Type> l = ts; l.nonEmpty(); l = l.tail)
     ...
     */
    public boolean isSubtypes(List<com.sun.tools.javac.code.Type> ts, List<com.sun.tools.javac.code.Type> ss) {
     ...
     * return false.
     **/
    public boolean isSubtypesUnchecked(List<com.sun.tools.javac.code.Type> ts, List<com.sun.tools.javac.code.Type> ss, Warner warn) {
        while (ts.tail != null && ss.tail != null
               /*inlined: ts.nonEmpty() && ss.nonEmpty()*/ &&
     ...
     */
    public boolean isSameTypes(List<com.sun.tools.javac.code.Type> ts, List<com.sun.tools.javac.code.Type> ss) {
        return isSameTypes(ts, ss, false);
    }
    public boolean isSameTypes(List<com.sun.tools.javac.code.Type> ts, List<com.sun.tools.javac.code.Type> ss, boolean strict) {
        while (ts.tail != null && ss.tail != null
               /*inlined: ts.nonEmpty() && ss.nonEmpty()*/ &&
   ...
   public boolean isSignaturePolymorphic(MethodSymbol msym) {
       List<com.sun.tools.javac.code.Type> argtypes = msym.type.getParameterTypes();
     ...
     */
    public boolean isSameType(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
        return isSameType(t, s, false);
    }
    public boolean isSameType(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, boolean strict) {
        return strict ?
                isSameTypeStrict.visit(t, s) :
                isSameTypeLoose.visit(t, s);
    }
    public boolean isSameAnnotatedType(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
    ...
    // where
        abstract class SameTypeVisitor extends TypeRelation {
            ...
            @Override
            public Boolean visitWildcardType(WildcardType t, com.sun.tools.javac.code.Type s) {
                if (s.isPartial())
                    return visit(s, t);
                else
                    return false;
            ...
            public Boolean visitClassType(ClassType t, com.sun.tools.javac.code.Type s) {
                ...
                if (t.isCompound() && s.isCompound()) {
                    ...
                    for (com.sun.tools.javac.code.Type x : interfaces(t))
                        set.add(new UniqueType(x.unannotatedType(), Types.this));
                    for (com.sun.tools.javac.code.Type x : interfaces(s)) {
            ...
            abstract protected boolean containsTypes(List<com.sun.tools.javac.code.Type> ts1, List<com.sun.tools.javac.code.Type> ts2);
            ...
            @Override
            public Boolean visitMethodType(MethodType t, com.sun.tools.javac.code.Type s) {
            ...
            @Override
            public Boolean visitPackageType(PackageType t, com.sun.tools.javac.code.Type s) {
                return t == s;
            }

            @Override
            public Boolean visitForAll(ForAll t, com.sun.tools.javac.code.Type s) {
                if (!s.hasTag(FORALL)) {
                    return false;
                }
        ...
        private class LooseSameTypeVisitor extends SameTypeVisitor {
            ...
            @Override
            protected boolean containsTypes(List<com.sun.tools.javac.code.Type> ts1, List<com.sun.tools.javac.code.Type> ts2) {
        ...
        TypeRelation isSameAnnotatedType = new LooseSameTypeVisitor() {
            @Override
            public Boolean visitAnnotatedType(AnnotatedType t, com.sun.tools.javac.code.Type s) {
                if (!s.isAnnotated())
                    return false;
    ...
    public boolean containedBy(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
        switch (t.getTag()) {
        case UNDETVAR:
            if (s.hasTag(WILDCARD)) {
                ...
                switch(wt.kind) {
                    case UNBOUND:
                        break;
                    case EXTENDS: {
                        com.sun.tools.javac.code.Type bound = wildUpperBound(s);
                        undetvar.addBound(InferenceBound.UPPER, bound, this);
                        break;
                    }
                    case SUPER: {
                        com.sun.tools.javac.code.Type bound = wildLowerBound(s);
    ...
    boolean containsType(List<com.sun.tools.javac.code.Type> ts, List<com.sun.tools.javac.code.Type> ss) {
     ...
     * @param s a type
     */
    public boolean containsType(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
...
//                    debugContainsType(t, s);
    ...
    public boolean isCaptureOf(com.sun.tools.javac.code.Type s, WildcardType t) {
        if (!s.hasTag(TYPEVAR) || !((TypeVar)s.unannotatedType()).isCaptured())
            return false;
        return isSameWildcard(t, ((CapturedType)s.unannotatedType()).wildcard);
    }

    public boolean isSameWildcard(WildcardType t, com.sun.tools.javac.code.Type s) {
        if (!s.hasTag(WILDCARD))
            return false;
    ...
    public boolean containsTypeEquivalent(List<com.sun.tools.javac.code.Type> ts, List<com.sun.tools.javac.code.Type> ss) {
        while (ts.nonEmpty() && ss.nonEmpty()
     ...
     *
     */
    public boolean isEqualityComparable(com.sun.tools.javac.code.Type s, com.sun.tools.javac.code.Type t, Warner warn) {
    ...
    public boolean isCastable(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
     ...
     * (not defined for Method and ForAll types).
     */
    public boolean isCastable(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, Warner warn) {
        if (t == s)
            return true;
    ...
    // where
        private TypeRelation isCastable = new TypeRelation() {
            ...
            public Boolean visitClassType(ClassType t, com.sun.tools.javac.code.Type s) {
                ...
                if (s.hasTag(CLASS) || s.hasTag(ARRAY)) {
                    ...
                    if ((upcast = isSubtype(erasure(t), erasure(s)))
                        ...
                        // Assume |a| <: |b|
                        final com.sun.tools.javac.code.Type a = upcast ? t : s;
                        final com.sun.tools.javac.code.Type b = upcast ? s : t;
                        final boolean HIGH = true;
                        final boolean LOW = false;
                        final boolean DONT_REWRITE_TYPEVARS = false;
                        com.sun.tools.javac.code.Type aHigh = rewriteQuantifiers(a, HIGH, DONT_REWRITE_TYPEVARS);
                        com.sun.tools.javac.code.Type aLow  = rewriteQuantifiers(a, LOW,  DONT_REWRITE_TYPEVARS);
                        com.sun.tools.javac.code.Type bHigh = rewriteQuantifiers(b, HIGH, DONT_REWRITE_TYPEVARS);
                        com.sun.tools.javac.code.Type bLow  = rewriteQuantifiers(b, LOW,  DONT_REWRITE_TYPEVARS);
                        com.sun.tools.javac.code.Type lowSub = asSub(bLow, aLow.tsym);
                        com.sun.tools.javac.code.Type highSub = (lowSub == null) ? null : asSub(bHigh, aHigh.tsym);
                        if (highSub == null) {
            ...
            boolean visitIntersectionType(IntersectionClassType ict, com.sun.tools.javac.code.Type s, boolean reverse) {
                Warner warn = noWarnings;
                for (com.sun.tools.javac.code.Type c : ict.getComponents()) {
                    warn.clear();
            ...
            @Override
            public Boolean visitTypeVar(TypeVar t, com.sun.tools.javac.code.Type s) {
                switch (s.getTag()) {
                case ERROR:
                case BOT:
                    return true;
    ...
    public boolean disjointTypes(List<com.sun.tools.javac.code.Type> ts, List<com.sun.tools.javac.code.Type> ss) {
        while (ts.tail != null && ss.tail != null) {
     ...
     */
    public boolean disjointType(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
    ...
    // where
        private TypeRelation disjointType = new TypeRelation() {
            ...
            private boolean isCastableRecursive(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
                TypePair pair = new TypePair(t, s);
                if (cache.add(pair)) {
                    try {
            ...
            private boolean notSoftSubtypeRecursive(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
                TypePair pair = new TypePair(t, s);
                if (cache.add(pair)) {
                    try {
    ...
    public List<com.sun.tools.javac.code.Type> cvarLowerBounds(List<com.sun.tools.javac.code.Type> ts) {
        return map(ts, cvarLowerBoundMapping);
    }
    private final Mapping cvarLowerBoundMapping = new Mapping("cvarLowerBound") {
            public com.sun.tools.javac.code.Type apply(com.sun.tools.javac.code.Type t) {
     ...
     */
    public boolean notSoftSubtype(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
        if (t == s) return false;
        if (t.hasTag(TYPEVAR)) {
    ...
    private com.sun.tools.javac.code.Type relaxBound(com.sun.tools.javac.code.Type t) {
        if (t.hasTag(TYPEVAR)) {
    ...
    public boolean isReifiable(com.sun.tools.javac.code.Type t) {
        ...
        private UnaryVisitor<Boolean> isReifiable = new UnaryVisitor<Boolean>() {
            ...
            public Boolean visitClassType(ClassType t, Void ignored) {
                if (t.isCompound())
                    ...
                    for (com.sun.tools.javac.code.Type param : t.allparams()) {
                        if (!param.isUnbound())
                            return false;
                    }
                    return true;
    ...
    public boolean isArray(com.sun.tools.javac.code.Type t) {
     ...
     */
    public com.sun.tools.javac.code.Type elemtype(com.sun.tools.javac.code.Type t) {
        switch (t.getTag()) {
        case WILDCARD:
    ...
    public com.sun.tools.javac.code.Type elemtypeOrType(com.sun.tools.javac.code.Type t) {
        com.sun.tools.javac.code.Type elemtype = elemtype(t);
     ...
     */
    public int dimensions(com.sun.tools.javac.code.Type t) {
        int result = 0;
     ...
     */
    public ArrayType makeArrayType(com.sun.tools.javac.code.Type t) {
     ...
     * @param sym a symbol
     */
    public com.sun.tools.javac.code.Type asSuper(com.sun.tools.javac.code.Type t, Symbol sym) {
        /* Some examples:
         *
    ...
    // where
        private SimpleVisitor<com.sun.tools.javac.code.Type,Symbol> asSuper = new SimpleVisitor<com.sun.tools.javac.code.Type,Symbol>() {
            ...
            public com.sun.tools.javac.code.Type visitClassType(ClassType t, Symbol sym) {
                ...
                com.sun.tools.javac.code.Type st = supertype(t);
                if (st.hasTag(CLASS) || st.hasTag(TYPEVAR)) {
                    com.sun.tools.javac.code.Type x = asSuper(st, sym);
                    if (x != null)
                        return x;
                }
                if ((sym.flags() & INTERFACE) != 0) {
                    for (List<com.sun.tools.javac.code.Type> l = interfaces(t); l.nonEmpty(); l = l.tail) {
                        if (!l.head.hasTag(ERROR)) {
                            com.sun.tools.javac.code.Type x = asSuper(l.head, sym);
                            if (x != null)
                                return x;
                        }
                    }
            ...
            @Override
            public com.sun.tools.javac.code.Type visitArrayType(ArrayType t, Symbol sym) {
                return isSubtype(t, sym.type) ? sym.type : null;
            }

            @Override
            public com.sun.tools.javac.code.Type visitTypeVar(TypeVar t, Symbol sym) {
                if (t.tsym == sym)
                    return t;
                else
     ...
     * @param sym a symbol
     */
    public com.sun.tools.javac.code.Type asOuterSuper(com.sun.tools.javac.code.Type t, Symbol sym) {
        switch (t.getTag()) {
        case CLASS:
            do {
                com.sun.tools.javac.code.Type s = asSuper(t, sym);
                if (s != null) return s;
     ...
     * @param sym a symbol
     */
    public com.sun.tools.javac.code.Type asEnclosingSuper(com.sun.tools.javac.code.Type t, Symbol sym) {
        switch (t.getTag()) {
        case CLASS:
            do {
                com.sun.tools.javac.code.Type s = asSuper(t, sym);
                if (s != null) return s;
                com.sun.tools.javac.code.Type outer = t.getEnclosingType();
     ...
     * @param sym a symbol
     */
    public com.sun.tools.javac.code.Type memberType(com.sun.tools.javac.code.Type t, Symbol sym) {
        return (sym.flags() & STATIC) != 0
            ? sym.type
            : memberType.visit(t, sym);
        }
    // where
        private SimpleVisitor<com.sun.tools.javac.code.Type,Symbol> memberType = new SimpleVisitor<com.sun.tools.javac.code.Type,Symbol>() {
            ...
            @Override
            public com.sun.tools.javac.code.Type visitWildcardType(WildcardType t, Symbol sym) {
            ...
            public com.sun.tools.javac.code.Type visitClassType(ClassType t, Symbol sym) {
                ...
                if (((flags & STATIC) == 0) && owner.type.isParameterized()) {
                    com.sun.tools.javac.code.Type base = asOuterSuper(t, owner);
                    ...
                    if (base != null) {
                        List<com.sun.tools.javac.code.Type> ownerParams = owner.type.allparams();
                        List<com.sun.tools.javac.code.Type> baseParams = base.allparams();
    ...
    public boolean isAssignable(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
     ...
     * (not defined for Method and ForAll types)
     */
    public boolean isAssignable(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, Warner warn) {
        if (t.hasTag(ERROR))
            return true;
     ...
     */
    public com.sun.tools.javac.code.Type erasure(com.sun.tools.javac.code.Type t) {
        return eraseNotNeeded(t)? t : erasure(t, false);
    }
    //where
    private boolean eraseNotNeeded(com.sun.tools.javac.code.Type t) {
    ...
    private com.sun.tools.javac.code.Type erasure(com.sun.tools.javac.code.Type t, boolean recurse) {
        if (t.isPrimitive())
    ...
    // where
        private SimpleVisitor<com.sun.tools.javac.code.Type, Boolean> erasure = new SimpleVisitor<com.sun.tools.javac.code.Type, Boolean>() {
            public com.sun.tools.javac.code.Type visitType(com.sun.tools.javac.code.Type t, Boolean recurse) {
                if (t.isPrimitive())
                    return t; /*fast special case*/
                else
            ...
            @Override
            public com.sun.tools.javac.code.Type visitWildcardType(WildcardType t, Boolean recurse) {
                return erasure(wildUpperBound(t), recurse);
            }

            @Override
            public com.sun.tools.javac.code.Type visitClassType(ClassType t, Boolean recurse) {
                com.sun.tools.javac.code.Type erased = t.tsym.erasure(Types.this);
                if (recurse) {
            ...
            @Override
            public com.sun.tools.javac.code.Type visitTypeVar(TypeVar t, Boolean recurse) {
                return erasure(t.bound, recurse);
            }

            @Override
            public com.sun.tools.javac.code.Type visitErrorType(ErrorType t, Boolean recurse) {
                return t;
            }

            @Override
            public com.sun.tools.javac.code.Type visitAnnotatedType(AnnotatedType t, Boolean recurse) {
                com.sun.tools.javac.code.Type erased = erasure(t.unannotatedType(), recurse);
    ...
    private Mapping erasureFun = new Mapping ("erasure") {
            public com.sun.tools.javac.code.Type apply(com.sun.tools.javac.code.Type t) { return erasure(t); }
        };

    private Mapping erasureRecFun = new Mapping ("erasureRecursive") {
        public com.sun.tools.javac.code.Type apply(com.sun.tools.javac.code.Type t) { return erasureRecursive(t); }
    };

    public List<com.sun.tools.javac.code.Type> erasure(List<com.sun.tools.javac.code.Type> ts) {
        return com.sun.tools.javac.code.Type.map(ts, erasureFun);
    }

    public com.sun.tools.javac.code.Type erasureRecursive(com.sun.tools.javac.code.Type t) {
        return erasure(t, true);
    }

    public List<com.sun.tools.javac.code.Type> erasureRecursive(List<com.sun.tools.javac.code.Type> ts) {
        return com.sun.tools.javac.code.Type.map(ts, erasureRecFun);
    }
    // </editor-fold>
     ...
     *                          null otherwise.
     */
    public com.sun.tools.javac.code.Type makeCompoundType(List<com.sun.tools.javac.code.Type> bounds) {
        return makeCompoundType(bounds, bounds.head.tsym.isInterface());
    }
    public com.sun.tools.javac.code.Type makeCompoundType(List<com.sun.tools.javac.code.Type> bounds, boolean allInterfaces) {
        Assert.check(bounds.nonEmpty());
        com.sun.tools.javac.code.Type firstExplicitBound = bounds.head;
        if (allInterfaces) {
            bounds = bounds.prepend(syms.objectType);
        }
        ClassSymbol bc =
            new ClassSymbol(ABSTRACT|PUBLIC|SYNTHETIC|COMPOUND|ACYCLIC,
                            com.sun.tools.javac.code.Type.moreInfo
        ...
        bc.members_field = new com.sun.tools.javac.code.Scope(bc);
        return bc.type;
    }
     ...
     */
    public com.sun.tools.javac.code.Type makeCompoundType(com.sun.tools.javac.code.Type bound1, com.sun.tools.javac.code.Type bound2) {
        return makeCompoundType(List.of(bound1, bound2));
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="supertype">
    public com.sun.tools.javac.code.Type supertype(com.sun.tools.javac.code.Type t) {
        return supertype.visit(t);
    }
    // where
        private UnaryVisitor<com.sun.tools.javac.code.Type> supertype = new UnaryVisitor<com.sun.tools.javac.code.Type>() {

            public com.sun.tools.javac.code.Type visitType(com.sun.tools.javac.code.Type t, Void ignored) {
            ...
            @Override
            public com.sun.tools.javac.code.Type visitClassType(ClassType t, Void ignored) {
                if (t.supertype_field == null) {
                    com.sun.tools.javac.code.Type supertype = ((ClassSymbol)t.tsym).getSuperclass();
                    // An interface has no superclass; its supertype is Object.
                    if (t.isInterface())
                        supertype = ((ClassType)t.tsym.type).supertype_field;
                    if (t.supertype_field == null) {
                        List<com.sun.tools.javac.code.Type> actuals = classBound(t).allparams();
                        List<com.sun.tools.javac.code.Type> formals = t.tsym.type.allparams();
             ...
             */
            @Override
            public com.sun.tools.javac.code.Type visitTypeVar(TypeVar t, Void ignored) {
            ...
            @Override
            public com.sun.tools.javac.code.Type visitArrayType(ArrayType t, Void ignored) {
            ...
            @Override
            public com.sun.tools.javac.code.Type visitErrorType(ErrorType t, Void ignored) {
                return com.sun.tools.javac.code.Type.noType;
            }
        };
    // </editor-fold>
     ...
     */
    public List<com.sun.tools.javac.code.Type> interfaces(com.sun.tools.javac.code.Type t) {
        return interfaces.visit(t);
    }
    // where
        private UnaryVisitor<List<com.sun.tools.javac.code.Type>> interfaces = new UnaryVisitor<List<com.sun.tools.javac.code.Type>>() {

            public List<com.sun.tools.javac.code.Type> visitType(com.sun.tools.javac.code.Type t, Void ignored) {
                return List.nil();
            }

            @Override
            public List<com.sun.tools.javac.code.Type> visitClassType(ClassType t, Void ignored) {
                if (t.interfaces_field == null) {
                    List<com.sun.tools.javac.code.Type> interfaces = ((ClassSymbol)t.tsym).getInterfaces();
                    if (t.interfaces_field == null) {
                        ...
                        List<com.sun.tools.javac.code.Type> actuals = t.allparams();
                        List<com.sun.tools.javac.code.Type> formals = t.tsym.type.allparams();
                        if (t.hasErasedSupertypes()) {
            ...
            @Override
            public List<com.sun.tools.javac.code.Type> visitTypeVar(TypeVar t, Void ignored) {
    ...
    public List<com.sun.tools.javac.code.Type> directSupertypes(com.sun.tools.javac.code.Type t) {
        return directSupertypes.visit(t);
    }
    // where
        private final UnaryVisitor<List<com.sun.tools.javac.code.Type>> directSupertypes = new UnaryVisitor<List<com.sun.tools.javac.code.Type>>() {

            public List<com.sun.tools.javac.code.Type> visitType(final com.sun.tools.javac.code.Type type, final Void ignored) {
                if (!type.isCompound()) {
                    final com.sun.tools.javac.code.Type sup = supertype(type);
                    return (sup == com.sun.tools.javac.code.Type.noType || sup == type || sup == null)
                        ? interfaces(type)
            ...
            private List<com.sun.tools.javac.code.Type> visitIntersectionType(final IntersectionClassType it) {
    ...
    public boolean isDirectSuperInterface(TypeSymbol isym, TypeSymbol origin) {
        for (com.sun.tools.javac.code.Type i2 : interfaces(origin.type)) {
    ...
    Map<com.sun.tools.javac.code.Type,Boolean> isDerivedRawCache = new HashMap<com.sun.tools.javac.code.Type,Boolean>();

    public boolean isDerivedRaw(com.sun.tools.javac.code.Type t) {
    ...
    public boolean isDerivedRawInternal(com.sun.tools.javac.code.Type t) {
        if (t.isErroneous())
            return false;
        return
            t.isRaw() ||
            supertype(t) != com.sun.tools.javac.code.Type.noType && isDerivedRaw(supertype(t)) ||
            isDerivedRaw(interfaces(t));
    }

    public boolean isDerivedRaw(List<com.sun.tools.javac.code.Type> ts) {
        List<com.sun.tools.javac.code.Type> l = ts;
     ...
     *                          null otherwise.
     */
    public void setBounds(TypeVar t, List<com.sun.tools.javac.code.Type> bounds) {
        setBounds(t, bounds, bounds.head.tsym.isInterface());
    }

    /**
     * Same as {@link #setBounds(com.sun.tools.javac.code.Type.TypeVar,List, com.sun.tools.javac.code.Type)}, except that
     ...
     */
    public void setBounds(TypeVar t, List<com.sun.tools.javac.code.Type> bounds, boolean allInterfaces) {
     ...
     */
    public List<com.sun.tools.javac.code.Type> getBounds(TypeVar t) {
     ...
     * type itself.
     */
    public com.sun.tools.javac.code.Type classBound(com.sun.tools.javac.code.Type t) {
        return classBound.visit(t);
    }
    // where
        private UnaryVisitor<com.sun.tools.javac.code.Type> classBound = new UnaryVisitor<com.sun.tools.javac.code.Type>() {
            ...
            @Override
            public com.sun.tools.javac.code.Type visitClassType(ClassType t, Void ignored) {
                com.sun.tools.javac.code.Type outer1 = classBound(t.getEnclosingType());
     ...
     *
     * @jls section 8.4.2.
     * @see #overrideEquivalent(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s)
     ...
     */
    public boolean isSubSignature(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
        return isSubSignature(t, s, true);
    }

    public boolean isSubSignature(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, boolean strict) {
     ...
     *
     * @jls section 8.4.2.
     * @see #isSubSignature(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s)
     ...
     */
    public boolean overrideEquivalent(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
        return hasSameArgs(t, s) ||
            hasSameArgs(t, erasure(s)) || hasSameArgs(erasure(t), s);
    }

    public boolean overridesObjectMethod(TypeSymbol origin, Symbol msym) {
        for (com.sun.tools.javac.code.Scope.Entry e = syms.objectType.tsym.members().lookup(msym.name); e.scope != null ; e = e.next()) {
    ...
    class ImplementationCache {
        ...
        private MethodSymbol implementationInternal(MethodSymbol ms, TypeSymbol origin, boolean checkResult, Filter<Symbol> implFilter) {
            for (com.sun.tools.javac.code.Type t = origin.type; t.hasTag(CLASS) || t.hasTag(TYPEVAR); t = supertype(t)) {
                while (t.hasTag(TYPEVAR))
                    t = t.getUpperBound();
                TypeSymbol c = t.tsym;
                for (com.sun.tools.javac.code.Scope.Entry e = c.members().lookup(ms.name, implFilter);
                     e.scope != null;
                     e = e.next(implFilter)) {
                    if (e.sym != null &&
    ...
    class MembersClosureCache extends SimpleVisitor<com.sun.tools.javac.code.Scope.CompoundScope, Void> {
        ...
        public CompoundScope visitType(com.sun.tools.javac.code.Type t, Void _unused) {
            if (nilScope == null) {
        ...
        public CompoundScope visitClassType(ClassType t, Void _unused) {
            ...
            try {
                ...
                if (membersClosure == null) {
                    ...
                    for (com.sun.tools.javac.code.Type i : interfaces(t)) {
    ...
    public CompoundScope membersClosure(com.sun.tools.javac.code.Type site, boolean skipInterface) {
    ...
    public MethodSymbol firstUnimplementedAbstract(ClassSymbol sym) {
        ...
        private MethodSymbol firstUnimplementedAbstractImpl(ClassSymbol impl, ClassSymbol c) {
            ...
            if (c == impl || (c.flags() & (ABSTRACT | INTERFACE)) != 0) {
                com.sun.tools.javac.code.Scope s = c.members();
                ...
                if (undef == null) {
                    com.sun.tools.javac.code.Type st = supertype(c.type);
                    if (st.hasTag(CLASS))
                        undef = firstUnimplementedAbstractImpl(impl, (ClassSymbol)st.tsym);
                }
                for (List<com.sun.tools.javac.code.Type> l = interfaces(c.type);
    ...
    //where
    public List<MethodSymbol> interfaceCandidates(com.sun.tools.javac.code.Type site, MethodSymbol ms) {
    ...
    // where
            private class MethodFilter implements Filter<Symbol> {
                ...
                MethodFilter(Symbol msym, com.sun.tools.javac.code.Type site) {
                    this.msym = msym;
                    this.site = site;
                }

                public boolean accepts(Symbol s) {
                    return s.kind == com.sun.tools.javac.code.Kinds.MTH &&
                            s.name == msym.name &&
                            (s.flags() & SYNTHETIC) == 0 &&
     ...
     */
    public boolean hasSameArgs(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
        return hasSameArgs(t, s, true);
    }

    public boolean hasSameArgs(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, boolean strict) {
        return hasSameArgs(t, s, strict ? hasSameArgs_strict : hasSameArgs_nonstrict);
    }

    private boolean hasSameArgs(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, TypeRelation hasSameArgs) {
    ...
    public List<com.sun.tools.javac.code.Type> subst(List<com.sun.tools.javac.code.Type> ts,
                                                     List<com.sun.tools.javac.code.Type> from,
                                                     List<com.sun.tools.javac.code.Type> to) {
     ...
     */
    public com.sun.tools.javac.code.Type subst(com.sun.tools.javac.code.Type t, List<com.sun.tools.javac.code.Type> from, List<com.sun.tools.javac.code.Type> to) {
        return new Subst(from, to).subst(t);
    }

    private class Subst extends UnaryVisitor<com.sun.tools.javac.code.Type> {
        List<com.sun.tools.javac.code.Type> from;
        List<com.sun.tools.javac.code.Type> to;

        public Subst(List<com.sun.tools.javac.code.Type> from, List<com.sun.tools.javac.code.Type> to) {
        ...
        com.sun.tools.javac.code.Type subst(com.sun.tools.javac.code.Type t) {
            if (from.tail == null)
                return t;
            else
                return visit(t);
        ...
        List<com.sun.tools.javac.code.Type> subst(List<com.sun.tools.javac.code.Type> ts) {
            if (from.tail == null)
                return ts;
            boolean wild = false;
            if (ts.nonEmpty() && from.nonEmpty()) {
                com.sun.tools.javac.code.Type head1 = subst(ts.head);
                List<com.sun.tools.javac.code.Type> tail1 = subst(ts.tail);
        ...
        @Override
        public com.sun.tools.javac.code.Type visitMethodType(MethodType t, Void ignored) {
            List<com.sun.tools.javac.code.Type> argtypes = subst(t.argtypes);
            com.sun.tools.javac.code.Type restype = subst(t.restype);
            List<com.sun.tools.javac.code.Type> thrown = subst(t.thrown);
        ...
        @Override
        public com.sun.tools.javac.code.Type visitTypeVar(TypeVar t, Void ignored) {
            for (List<com.sun.tools.javac.code.Type> from = this.from, to = this.to;
                 from.nonEmpty();
        ...
        @Override
        public com.sun.tools.javac.code.Type visitUndetVar(UndetVar t, Void ignored) {
        ...
        public com.sun.tools.javac.code.Type visitClassType(ClassType t, Void ignored) {
            if (!t.isCompound()) {
                List<com.sun.tools.javac.code.Type> typarams = t.getTypeArguments();
                List<com.sun.tools.javac.code.Type> typarams1 = subst(typarams);
                com.sun.tools.javac.code.Type outer = t.getEnclosingType();
                com.sun.tools.javac.code.Type outer1 = subst(outer);
                if (typarams1 == typarams && outer1 == outer)
                    return t;
                else
                    return new ClassType(outer1, typarams1, t.tsym);
            } else {
                com.sun.tools.javac.code.Type st = subst(supertype(t));
                List<com.sun.tools.javac.code.Type> is = subst(interfaces(t));
        ...
        @Override
        public com.sun.tools.javac.code.Type visitWildcardType(WildcardType t, Void ignored) {
            com.sun.tools.javac.code.Type bound = t.type;
        ...
        @Override
        public com.sun.tools.javac.code.Type visitArrayType(ArrayType t, Void ignored) {
            com.sun.tools.javac.code.Type elemtype = subst(t.elemtype);
        ...
        @Override
        public com.sun.tools.javac.code.Type visitForAll(ForAll t, Void ignored) {
            if (com.sun.tools.javac.code.Type.containsAny(to, t.tvars)) {
                //perform alpha-renaming of free-variables in 't'
                //if 'to' types contain variables that are free in 't'
                List<com.sun.tools.javac.code.Type> freevars = newInstances(t.tvars);
                t = new ForAll(freevars,
                        Types.this.subst(t.qtype, t.tvars, freevars));
            }
            List<com.sun.tools.javac.code.Type> tvars1 = substBounds(t.tvars, from, to);
            com.sun.tools.javac.code.Type qtype1 = subst(t.qtype);
    ...
    public List<com.sun.tools.javac.code.Type> substBounds(List<com.sun.tools.javac.code.Type> tvars,
                                                           List<com.sun.tools.javac.code.Type> from,
                                                           List<com.sun.tools.javac.code.Type> to) {
        if (tvars.isEmpty())
            return tvars;
        ListBuffer<com.sun.tools.javac.code.Type> newBoundsBuf = new ListBuffer<>();
        boolean changed = false;
        // calculate new bounds
        for (com.sun.tools.javac.code.Type t : tvars) {
            TypeVar tv = (TypeVar) t;
            com.sun.tools.javac.code.Type bound = subst(tv.bound, from, to);
            if (bound != tv.bound)
                changed = true;
        ...
        if (!changed)
            return tvars;
        ListBuffer<com.sun.tools.javac.code.Type> newTvars = new ListBuffer<>();
        ...
        // of the old
        List<com.sun.tools.javac.code.Type> newBounds = newBoundsBuf.toList();
        from = tvars;
        to = newTvars.toList();
        ...
        for (com.sun.tools.javac.code.Type t : newTvars.toList()) {
            TypeVar tv = (TypeVar) t;
    ...
    public TypeVar substBound(TypeVar t, List<com.sun.tools.javac.code.Type> from, List<com.sun.tools.javac.code.Type> to) {
        com.sun.tools.javac.code.Type bound1 = subst(t.bound, from, to);
        if (bound1 == t.bound)
            return t;
        else {
            ...
            // of the old
            tv.bound = subst(bound1, List.<com.sun.tools.javac.code.Type>of(t), List.<com.sun.tools.javac.code.Type>of(tv));
            return tv;
        }
    }
    // </editor-fold>
    ...
    public boolean hasSameBounds(ForAll t, ForAll s) {
        List<com.sun.tools.javac.code.Type> l1 = t.tvars;
        List<com.sun.tools.javac.code.Type> l2 = s.tvars;
     ...
     */
    public List<com.sun.tools.javac.code.Type> newInstances(List<com.sun.tools.javac.code.Type> tvars) {
        List<com.sun.tools.javac.code.Type> tvars1 = com.sun.tools.javac.code.Type.map(tvars, newInstanceFun);
        for (List<com.sun.tools.javac.code.Type> l = tvars1; l.nonEmpty(); l = l.tail) {
    ...
    private static final Mapping newInstanceFun = new Mapping("newInstanceFun") {
            public com.sun.tools.javac.code.Type apply(com.sun.tools.javac.code.Type t) { return new TypeVar(t.tsym, t.getUpperBound(), t.getLowerBound()); }
        };
    // </editor-fold>

    public com.sun.tools.javac.code.Type createMethodTypeWithParameters(com.sun.tools.javac.code.Type original, List<com.sun.tools.javac.code.Type> newParams) {
        return original.accept(methodWithParameters, newParams);
    }
    // where
        private final MapVisitor<List<com.sun.tools.javac.code.Type>> methodWithParameters = new MapVisitor<List<com.sun.tools.javac.code.Type>>() {
            public com.sun.tools.javac.code.Type visitType(com.sun.tools.javac.code.Type t, List<com.sun.tools.javac.code.Type> newParams) {
                throw new IllegalArgumentException("Not a method type: " + t);
            }
            public com.sun.tools.javac.code.Type visitMethodType(MethodType t, List<com.sun.tools.javac.code.Type> newParams) {
                return new MethodType(newParams, t.restype, t.thrown, t.tsym);
            }
            public com.sun.tools.javac.code.Type visitForAll(ForAll t, List<com.sun.tools.javac.code.Type> newParams) {
                return new ForAll(t.tvars, t.qtype.accept(this, newParams));
            }
        };

    public com.sun.tools.javac.code.Type createMethodTypeWithThrown(com.sun.tools.javac.code.Type original, List<com.sun.tools.javac.code.Type> newThrown) {
        return original.accept(methodWithThrown, newThrown);
    }
    // where
        private final MapVisitor<List<com.sun.tools.javac.code.Type>> methodWithThrown = new MapVisitor<List<com.sun.tools.javac.code.Type>>() {
            public com.sun.tools.javac.code.Type visitType(com.sun.tools.javac.code.Type t, List<com.sun.tools.javac.code.Type> newThrown) {
                throw new IllegalArgumentException("Not a method type: " + t);
            }
            public com.sun.tools.javac.code.Type visitMethodType(MethodType t, List<com.sun.tools.javac.code.Type> newThrown) {
                return new MethodType(t.argtypes, t.restype, newThrown, t.tsym);
            }
            public com.sun.tools.javac.code.Type visitForAll(ForAll t, List<com.sun.tools.javac.code.Type> newThrown) {
                return new ForAll(t.tvars, t.qtype.accept(this, newThrown));
            }
        };

    public com.sun.tools.javac.code.Type createMethodTypeWithReturn(com.sun.tools.javac.code.Type original, com.sun.tools.javac.code.Type newReturn) {
        return original.accept(methodWithReturn, newReturn);
    }
    // where
        private final MapVisitor<com.sun.tools.javac.code.Type> methodWithReturn = new MapVisitor<com.sun.tools.javac.code.Type>() {
            public com.sun.tools.javac.code.Type visitType(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type newReturn) {
                throw new IllegalArgumentException("Not a method type: " + t);
            }
            public com.sun.tools.javac.code.Type visitMethodType(MethodType t, com.sun.tools.javac.code.Type newReturn) {
                return new MethodType(t.argtypes, newReturn, t.thrown, t.tsym);
            }
            public com.sun.tools.javac.code.Type visitForAll(ForAll t, com.sun.tools.javac.code.Type newReturn) {
                return new ForAll(t.tvars, t.qtype.accept(this, newReturn));
            }
        };

    // <editor-fold defaultstate="collapsed" desc="createErrorType">
    public com.sun.tools.javac.code.Type createErrorType(com.sun.tools.javac.code.Type originalType) {
        return new ErrorType(originalType, syms.errSymbol);
    }

    public com.sun.tools.javac.code.Type createErrorType(ClassSymbol c, com.sun.tools.javac.code.Type originalType) {
        return new ErrorType(c, originalType);
    }

    public com.sun.tools.javac.code.Type createErrorType(Name name, TypeSymbol container, com.sun.tools.javac.code.Type originalType) {
     ...
     */
    public int rank(com.sun.tools.javac.code.Type t) {
        t = t.unannotatedType();
        switch(t.getTag()) {
        case CLASS: {
            ...
            if (cls.rank_field < 0) {
                ...
                if (fullname == names.java_lang_Object)
                    ...
                    for (List<com.sun.tools.javac.code.Type> l = interfaces(cls);
                         l.nonEmpty();
                         l = l.tail) {
                        if (rank(l.head) > r)
                            r = rank(l.head);
        ...
        case TYPEVAR: {
            ...
            if (tvar.rank_field < 0) {
                ...
                for (List<com.sun.tools.javac.code.Type> l = interfaces(tvar);
                     l.nonEmpty();
                     l = l.tail) {
     ...
     */
    public String toString(com.sun.tools.javac.code.Type t, Locale locale) {
     ...
     */
    @Deprecated
    public String toString(com.sun.tools.javac.code.Type t) {
        if (t.hasTag(FORALL)) {
    ...
    // where
        private String typaramsString(List<com.sun.tools.javac.code.Type> tvars) {
        ...
        private void appendTyparamString(TypeVar t, StringBuilder buf) {
            ...
            com.sun.tools.javac.code.Type bound = t.bound;
            if (!bound.isCompound()) {
                buf.append(bound);
            } else if ((erasure(t).tsym.flags() & INTERFACE) == 0) {
                buf.append(supertype(t));
                for (com.sun.tools.javac.code.Type intf : interfaces(t)) {
                    buf.append('&');
                    buf.append(intf);
                }
            } else {
     ...
     * otherwise).
     */
    private Map<com.sun.tools.javac.code.Type,List<com.sun.tools.javac.code.Type>> closureCache = new HashMap<com.sun.tools.javac.code.Type,List<com.sun.tools.javac.code.Type>>();

    /**
     * Returns the closure of a class or interface type.
     */
    public List<com.sun.tools.javac.code.Type> closure(com.sun.tools.javac.code.Type t) {
        List<com.sun.tools.javac.code.Type> cl = closureCache.get(t);
        if (cl == null) {
            com.sun.tools.javac.code.Type st = supertype(t);
            if (!t.isCompound()) {
                if (st.hasTag(CLASS)) {
     ...
     */
    public List<com.sun.tools.javac.code.Type> insert(List<com.sun.tools.javac.code.Type> cl, com.sun.tools.javac.code.Type t) {
        if (cl.isEmpty()) {
            return cl.prepend(t);
     ...
     */
    public List<com.sun.tools.javac.code.Type> union(List<com.sun.tools.javac.code.Type> cl1, List<com.sun.tools.javac.code.Type> cl2) {
        if (cl1.isEmpty()) {
            return cl2;
        } else if (cl2.isEmpty()) {
            return cl1;
     ...
     */
    public List<com.sun.tools.javac.code.Type> intersect(List<com.sun.tools.javac.code.Type> cl1, List<com.sun.tools.javac.code.Type> cl2) {
        if (cl1 == cl2)
            return cl1;
        ...
        if (cl1.head.tsym == cl2.head.tsym &&
            ...
            if (cl1.head.isParameterized() && cl2.head.isParameterized()) {
                com.sun.tools.javac.code.Type merge = merge(cl1.head,cl2.head);
    ...
    // where
        class TypePair {
            ...
            TypePair(com.sun.tools.javac.code.Type t1, com.sun.tools.javac.code.Type t2) {
                this(t1, t2, false);
            }

            TypePair(com.sun.tools.javac.code.Type t1, com.sun.tools.javac.code.Type t2, boolean strict) {
                this.t1 = t1;
                this.t2 = t2;
                this.strict = strict;
            }
        ...
        private com.sun.tools.javac.code.Type merge(com.sun.tools.javac.code.Type c1, com.sun.tools.javac.code.Type c2) {
            ClassType class1 = (ClassType) c1;
            List<com.sun.tools.javac.code.Type> act1 = class1.getTypeArguments();
            ClassType class2 = (ClassType) c2;
            List<com.sun.tools.javac.code.Type> act2 = class2.getTypeArguments();
            ListBuffer<com.sun.tools.javac.code.Type> merged = new ListBuffer<com.sun.tools.javac.code.Type>();
            List<com.sun.tools.javac.code.Type> typarams = class1.tsym.type.getTypeArguments();
     ...
     */
    private com.sun.tools.javac.code.Type compoundMin(List<com.sun.tools.javac.code.Type> cl) {
        if (cl.isEmpty()) return syms.objectType;
        List<com.sun.tools.javac.code.Type> compound = closureMin(cl);
        if (compound.isEmpty())
            return null;
     ...
     * compoundMin or glb.
     */
    private List<com.sun.tools.javac.code.Type> closureMin(List<com.sun.tools.javac.code.Type> cl) {
        ListBuffer<com.sun.tools.javac.code.Type> classes = new ListBuffer<>();
        ListBuffer<com.sun.tools.javac.code.Type> interfaces = new ListBuffer<>();
        Set<com.sun.tools.javac.code.Type> toSkip = new HashSet<>();
        while (!cl.isEmpty()) {
            com.sun.tools.javac.code.Type current = cl.head;
            boolean keep = !toSkip.contains(current);
            if (keep && current.hasTag(TYPEVAR)) {
                // skip lower-bounded variables with a subtype in cl.tail
                for (com.sun.tools.javac.code.Type t : cl.tail) {
     ...
     */
    public com.sun.tools.javac.code.Type lub(List<com.sun.tools.javac.code.Type> ts) {
        return lub(ts.toArray(new com.sun.tools.javac.code.Type[ts.length()]));
    }
     ...
     */
    public com.sun.tools.javac.code.Type lub(com.sun.tools.javac.code.Type... ts) {
        ...
        for (int i = 0 ; i < ts.length ; i++) {
            com.sun.tools.javac.code.Type t = ts[i];
            switch (t.getTag()) {
            case CLASS:
        ...
        case ARRAY_BOUND:
            // calculate lub(A[], B[])
            com.sun.tools.javac.code.Type[] elements = new com.sun.tools.javac.code.Type[ts.length];
            for (int i = 0 ; i < ts.length ; i++) {
                com.sun.tools.javac.code.Type elem = elements[i] = elemTypeFun.apply(ts[i]);
                if (elem.isPrimitive()) {
                    // if a primitive type is found, then return
                    // arraySuperType unless all the types are the
                    // same
                    com.sun.tools.javac.code.Type first = ts[0];
        ...
        case CLASS_BOUND:
            ...
            List<com.sun.tools.javac.code.Type> cl = erasedSupertypes(ts[startIdx]);
            ...
            List<com.sun.tools.javac.code.Type> mec = closureMin(cl);
            //step 3 - for each element G in MEC, compute lci(Inv(G))
            List<com.sun.tools.javac.code.Type> candidates = List.nil();
            for (com.sun.tools.javac.code.Type erasedSupertype : mec) {
                List<com.sun.tools.javac.code.Type> lci = List.of(asSuper(ts[startIdx], erasedSupertype.tsym));
                for (int i = startIdx + 1 ; i < ts.length ; i++) {
                    com.sun.tools.javac.code.Type superType = asSuper(ts[i], erasedSupertype.tsym);
                    lci = intersect(lci, superType != null ? List.of(superType) : List.<com.sun.tools.javac.code.Type>nil());
                }
        ...
        default:
            // calculate lub(A, B[])
            List<com.sun.tools.javac.code.Type> classes = List.of(arraySuperType());
            for (int i = 0 ; i < ts.length ; i++) {
    ...
    // where
        List<com.sun.tools.javac.code.Type> erasedSupertypes(com.sun.tools.javac.code.Type t) {
            ListBuffer<com.sun.tools.javac.code.Type> buf = new ListBuffer<>();
            for (com.sun.tools.javac.code.Type sup : closure(t)) {
        ...
        private com.sun.tools.javac.code.Type arraySuperType = null;
    ...
    public com.sun.tools.javac.code.Type glb(List<com.sun.tools.javac.code.Type> ts) {
        com.sun.tools.javac.code.Type t1 = ts.head;
        for (com.sun.tools.javac.code.Type t2 : ts.tail) {
            if (t1.isErroneous())
                return t1;
            t1 = glb(t1, t2);
        }
    ...
    //where
    public com.sun.tools.javac.code.Type glb(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
        if (s == null)
            return t;
        ...
        List<com.sun.tools.javac.code.Type> closure = union(closure(t), closure(s));
     ...
     */
    private com.sun.tools.javac.code.Type glbFlattened(List<com.sun.tools.javac.code.Type> flatBounds, com.sun.tools.javac.code.Type errT) {
        List<com.sun.tools.javac.code.Type> bounds = closureMin(flatBounds);
        ...
        if (bounds.isEmpty()) {             // length == 0
            ...
            int classCount = 0;
            List<com.sun.tools.javac.code.Type> lowers = List.nil();
            for (com.sun.tools.javac.code.Type bound : bounds) {
                if (!bound.isInterface()) {
                    classCount++;
                    com.sun.tools.javac.code.Type lower = cvarLowerBound(bound);
     ...
     */
    public int hashCode(com.sun.tools.javac.code.Type t) {
        return hashCode.visit(t);
    }
    // where
        private static final UnaryVisitor<Integer> hashCode = new UnaryVisitor<Integer>() {

            public Integer visitType(com.sun.tools.javac.code.Type t, Void ignored) {
            ...
            public Integer visitClassType(ClassType t, Void ignored) {
                ...
                for (com.sun.tools.javac.code.Type s : t.getTypeArguments()) {
                    result *= 127;
                    result += visit(s);
                }
                return result;
            ...
            public Integer visitMethodType(MethodType t, Void ignored) {
                ...
                for (List<com.sun.tools.javac.code.Type> thisargs = t.argtypes;
                     thisargs.tail != null;
    ...
    public boolean resultSubtype(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, Warner warner) {
        List<com.sun.tools.javac.code.Type> tvars = t.getTypeArguments();
        List<com.sun.tools.javac.code.Type> svars = s.getTypeArguments();
        com.sun.tools.javac.code.Type tres = t.getReturnType();
        com.sun.tools.javac.code.Type sres = subst(s.getReturnType(), svars, tvars);
     ...
     * @jls section 8.4.5
     */
    public boolean returnTypeSubstitutable(com.sun.tools.javac.code.Type r1, com.sun.tools.javac.code.Type r2) {
    ...
    public boolean returnTypeSubstitutable(com.sun.tools.javac.code.Type r1,
                                           com.sun.tools.javac.code.Type r2, com.sun.tools.javac.code.Type r2res,
                                           Warner warner) {
     ...
     */
    public boolean covariantReturnType(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s, Warner warner) {
        return
            isSameType(t, s) ||
     ...
     */
    public ClassSymbol boxedClass(com.sun.tools.javac.code.Type t) {
     ...
     */
    public com.sun.tools.javac.code.Type boxedTypeOrType(com.sun.tools.javac.code.Type t) {
     ...
     */
    public com.sun.tools.javac.code.Type unboxedType(com.sun.tools.javac.code.Type t) {
        if (allowBoxing) {
     ...
     */
    public com.sun.tools.javac.code.Type unboxedTypeOrType(com.sun.tools.javac.code.Type t) {
        com.sun.tools.javac.code.Type unboxedType = unboxedType(t);
    ...
    public List<com.sun.tools.javac.code.Type> capture(List<com.sun.tools.javac.code.Type> ts) {
        List<com.sun.tools.javac.code.Type> buf = List.nil();
        for (com.sun.tools.javac.code.Type t : ts) {
            buf = buf.prepend(capture(t));
        }
        return buf.reverse();
    }

    public com.sun.tools.javac.code.Type capture(com.sun.tools.javac.code.Type t) {
        if (!t.hasTag(CLASS)) {
            return t;
        }
        if (t.getEnclosingType() != com.sun.tools.javac.code.Type.noType) {
            com.sun.tools.javac.code.Type capturedEncl = capture(t.getEnclosingType());
            if (capturedEncl != t.getEnclosingType()) {
                com.sun.tools.javac.code.Type type1 = memberType(capturedEncl, t.tsym);
        ...
        List<com.sun.tools.javac.code.Type> A = G.getTypeArguments();
        List<com.sun.tools.javac.code.Type> T = cls.getTypeArguments();
        List<com.sun.tools.javac.code.Type> S = freshTypeVariables(T);

        List<com.sun.tools.javac.code.Type> currentA = A;
        List<com.sun.tools.javac.code.Type> currentT = T;
        List<com.sun.tools.javac.code.Type> currentS = S;
        ...
        while (!currentA.isEmpty() &&
            ...
            if (currentS.head != currentT.head) {
                ...
                com.sun.tools.javac.code.Type Ui = currentA.head.getUpperBound();
                ...
                com.sun.tools.javac.code.Type tmpBound = Si.bound.hasTag(UNDETVAR) ? ((UndetVar)Si.bound).qtype : Si.bound;
                com.sun.tools.javac.code.Type tmpLower = Si.lower.hasTag(UNDETVAR) ? ((UndetVar)Si.lower).qtype : Si.lower;
    ...
    // where
        public List<com.sun.tools.javac.code.Type> freshTypeVariables(List<com.sun.tools.javac.code.Type> types) {
            ListBuffer<com.sun.tools.javac.code.Type> result = new ListBuffer<>();
            for (com.sun.tools.javac.code.Type t : types) {
                if (t.hasTag(WILDCARD)) {
                    t = t.unannotatedType();
                    com.sun.tools.javac.code.Type bound = ((WildcardType)t).getExtendsBound();
                    if (bound == null)
    ...
    private boolean sideCast(com.sun.tools.javac.code.Type from, com.sun.tools.javac.code.Type to, Warner warn) {
        ...
        com.sun.tools.javac.code.Type target = to;
        ...
        List<com.sun.tools.javac.code.Type> commonSupers = superClosure(to, erasure(from));
        boolean giveWarning = commonSupers.isEmpty();
        // The arguments to the supers could be unified here to
        // get a more accurate analysis
        while (commonSupers.nonEmpty()) {
            com.sun.tools.javac.code.Type t1 = asSuper(from, commonSupers.head.tsym);
            com.sun.tools.javac.code.Type t2 = commonSupers.head; // same as asSuper(to, commonSupers.head.tsym);
    ...
    private boolean sideCastFinal(com.sun.tools.javac.code.Type from, com.sun.tools.javac.code.Type to, Warner warn) {
        // We are casting from type $from$ to type $to$, which are
        ...
        com.sun.tools.javac.code.Type t1 = asSuper(from, to.tsym);
        if (t1 == null) return false;
        com.sun.tools.javac.code.Type t2 = to;
        if (disjointTypes(t1.getTypeArguments(), t2.getTypeArguments()))
            return false;
        if (!allowCovariantReturns)
            // reject if there is a common method signature with
    ...
    private boolean giveWarning(com.sun.tools.javac.code.Type from, com.sun.tools.javac.code.Type to) {
        List<com.sun.tools.javac.code.Type> bounds = to.isCompound() ?
                ((IntersectionClassType)to.unannotatedType()).getComponents() : List.of(to);
        for (com.sun.tools.javac.code.Type b : bounds) {
            com.sun.tools.javac.code.Type subFrom = asSub(from, b.tsym);
    ...
    private List<com.sun.tools.javac.code.Type> superClosure(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
        List<com.sun.tools.javac.code.Type> cl = List.nil();
        for (List<com.sun.tools.javac.code.Type> l = interfaces(t); l.nonEmpty(); l = l.tail) {
    ...
    private boolean containsTypeEquivalent(com.sun.tools.javac.code.Type t, com.sun.tools.javac.code.Type s) {
        return
     ...
     */
    public void adapt(com.sun.tools.javac.code.Type source,
                      com.sun.tools.javac.code.Type target,
                      ListBuffer<com.sun.tools.javac.code.Type> from,
                      ListBuffer<com.sun.tools.javac.code.Type> to) throws AdaptFailure {
        new Adapter(from, to).adapt(source, target);
    }

    class Adapter extends SimpleVisitor<Void, com.sun.tools.javac.code.Type> {

        ListBuffer<com.sun.tools.javac.code.Type> from;
        ListBuffer<com.sun.tools.javac.code.Type> to;
        Map<Symbol, com.sun.tools.javac.code.Type> mapping;

        Adapter(ListBuffer<com.sun.tools.javac.code.Type> from, ListBuffer<com.sun.tools.javac.code.Type> to) {
            this.from = from;
            this.to = to;
            mapping = new HashMap<Symbol, com.sun.tools.javac.code.Type>();
        }

        public void adapt(com.sun.tools.javac.code.Type source, com.sun.tools.javac.code.Type target) throws AdaptFailure {
            visit(source, target);
            List<com.sun.tools.javac.code.Type> fromList = from.toList();
            List<com.sun.tools.javac.code.Type> toList = to.toList();
            while (!fromList.isEmpty()) {
                com.sun.tools.javac.code.Type val = mapping.get(fromList.head.tsym);
                if (toList.head != val)
                    toList.head = val;
        ...
        @Override
        public Void visitClassType(ClassType source, com.sun.tools.javac.code.Type target) throws AdaptFailure {
        ...
        @Override
        public Void visitArrayType(ArrayType source, com.sun.tools.javac.code.Type target) throws AdaptFailure {
        ...
        @Override
        public Void visitWildcardType(WildcardType source, com.sun.tools.javac.code.Type target) throws AdaptFailure {
        ...
        @Override
        public Void visitTypeVar(TypeVar source, com.sun.tools.javac.code.Type target) throws AdaptFailure {
            // Check to see if there is
            // already a mapping for $source$, in which case
            // the old mapping will be merged with the new
            com.sun.tools.javac.code.Type val = mapping.get(source.tsym);
            if (val != null) {
        ...
        @Override
        public Void visitType(com.sun.tools.javac.code.Type source, com.sun.tools.javac.code.Type target) {
            return null;
        }

        private Set<TypePair> cache = new HashSet<TypePair>();

        private void adaptRecursive(com.sun.tools.javac.code.Type source, com.sun.tools.javac.code.Type target) {
        ...
        private void adaptRecursive(List<com.sun.tools.javac.code.Type> source, List<com.sun.tools.javac.code.Type> target) {
    ...
    private void adaptSelf(com.sun.tools.javac.code.Type t,
                           ListBuffer<com.sun.tools.javac.code.Type> from,
                           ListBuffer<com.sun.tools.javac.code.Type> to) {
        try {
            //if (t.tsym.type != t)
     ...
     * quantifiers) only
     */
    private com.sun.tools.javac.code.Type rewriteQuantifiers(com.sun.tools.javac.code.Type t, boolean high, boolean rewriteTypeVars) {
        return new Rewriter(high, rewriteTypeVars).visit(t);
    }

    class Rewriter extends UnaryVisitor<com.sun.tools.javac.code.Type> {
        ...
        @Override
        public com.sun.tools.javac.code.Type visitClassType(ClassType t, Void s) {
            ListBuffer<com.sun.tools.javac.code.Type> rewritten = new ListBuffer<com.sun.tools.javac.code.Type>();
            boolean changed = false;
            for (com.sun.tools.javac.code.Type arg : t.allparams()) {
                com.sun.tools.javac.code.Type bound = visit(arg);
                if (arg != bound) {
                    changed = true;
                }
        ...
        public com.sun.tools.javac.code.Type visitType(com.sun.tools.javac.code.Type t, Void s) {
            return t;
        }

        @Override
        public com.sun.tools.javac.code.Type visitCapturedType(CapturedType t, Void s) {
            com.sun.tools.javac.code.Type w_bound = t.wildcard.type;
            com.sun.tools.javac.code.Type bound = w_bound.contains(t) ?
                        erasure(w_bound) :
                        visit(w_bound);
        ...
        @Override
        public com.sun.tools.javac.code.Type visitTypeVar(TypeVar t, Void s) {
            if (rewriteTypeVars) {
                com.sun.tools.javac.code.Type bound = t.bound.contains(t) ?
                        erasure(t.bound) :
                        visit(t.bound);
        ...
        @Override
        public com.sun.tools.javac.code.Type visitWildcardType(WildcardType t, Void s) {
            com.sun.tools.javac.code.Type bound2 = visit(t.type);
            return t.type == bound2 ? t : rewriteAsWildcardType(bound2, t.bound, t.kind);
        }

        private com.sun.tools.javac.code.Type rewriteAsWildcardType(com.sun.tools.javac.code.Type bound, TypeVar formal, BoundKind bk) {
            switch (bk) {
        ...
        com.sun.tools.javac.code.Type B(com.sun.tools.javac.code.Type t) {
            while (t.hasTag(WILDCARD)) {
                WildcardType w = (WildcardType)t.unannotatedType();
                t = high ?
                    w.getExtendsBound() :
     ...
     */
    private WildcardType makeExtendsWildcard(com.sun.tools.javac.code.Type bound, TypeVar formal) {
     ...
     * substituted by the wildcard
     */
    private WildcardType makeSuperWildcard(com.sun.tools.javac.code.Type bound, TypeVar formal) {
        if (bound.hasTag(BOT)) {
            return new WildcardType(syms.objectType,
                                    BoundKind.UNBOUND,
                                    syms.boundClass,
    ...
    public static class UniqueType {
        ...
        public UniqueType(com.sun.tools.javac.code.Type type, Types types) {
            this.type = type;
            this.types = types;
        }
     ...
     */
    public static abstract class DefaultTypeVisitor<R,S> implements com.sun.tools.javac.code.Type.Visitor<R,S> {
        final public R visit(com.sun.tools.javac.code.Type t, S s)               { return t.accept(this, s); }
     ...
     */
    public static abstract class TypeRelation extends SimpleVisitor<Boolean, com.sun.tools.javac.code.Type> {}
    ...
    public static abstract class UnaryVisitor<R> extends SimpleVisitor<R,Void> {
        final public R visit(com.sun.tools.javac.code.Type t) { return t.accept(this, null); }
    }
     ...
     * not needed.
     */
    public static class MapVisitor<S> extends DefaultTypeVisitor<com.sun.tools.javac.code.Type,S> {
        final public com.sun.tools.javac.code.Type visit(com.sun.tools.javac.code.Type t) { return t.accept(this, null); }
        public com.sun.tools.javac.code.Type visitType(com.sun.tools.javac.code.Type t, S s) { return t; }
    }
    // </editor-fold>
    ...
    public static abstract class SignatureGenerator {
         ...
         */
        public void assembleSig(com.sun.tools.javac.code.Type type) {
            ...
            switch (type.getTag()) {
                ...
                case METHOD:
                    ...
                    if (hasTypeVar(mt.thrown)) {
                        for (List<com.sun.tools.javac.code.Type> l = mt.thrown; l.nonEmpty(); l = l.tail) {
                            append('^');
                            assembleSig(l.head);
                        }
                    }
                    break;
                case WILDCARD: {
                    com.sun.tools.javac.code.Type.WildcardType ta = (com.sun.tools.javac.code.Type.WildcardType) type;
                    switch (ta.kind) {
                        case SUPER:
                            append('-');
                            assembleSig(ta.type);
                ...
                case TYPEVAR:
                    ...
                    break;
                case FORALL:
                    com.sun.tools.javac.code.Type.ForAll ft = (com.sun.tools.javac.code.Type.ForAll) type;
        ...
        public boolean hasTypeVar(List<com.sun.tools.javac.code.Type> l) {
            while (l.nonEmpty()) {
        ...
        public void assembleClassSig(com.sun.tools.javac.code.Type type) {
            type = type.unannotatedType();
            ClassType ct = (ClassType) type;
            ClassSymbol c = (ClassSymbol) ct.tsym;
            classReference(c);
            com.sun.tools.javac.code.Type outer = ct.getEnclosingType();
        ...
        public void assembleParamsSig(List<com.sun.tools.javac.code.Type> typarams) {
            append('<');
            for (List<com.sun.tools.javac.code.Type> ts = typarams; ts.nonEmpty(); ts = ts.tail) {
                com.sun.tools.javac.code.Type.TypeVar tvar = (com.sun.tools.javac.code.Type.TypeVar) ts.head;
                append(tvar.tsym.name);
                List<com.sun.tools.javac.code.Type> bounds = types.getBounds(tvar);
                if ((bounds.head.tsym.flags() & INTERFACE) != 0) {
                    append(':');
                }
                for (List<com.sun.tools.javac.code.Type> l = bounds; l.nonEmpty(); l = l.tail) {
                    append(':');
                    assembleSig(l.head);
                }
            }
        ...
        private void assembleSig(List<com.sun.tools.javac.code.Type> types) {
