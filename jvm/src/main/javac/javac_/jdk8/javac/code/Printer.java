 ...
 */
public abstract class Printer implements com.sun.tools.javac.code.Type.Visitor<String, Locale>, com.sun.tools.javac.code.Symbol.Visitor<String, Locale> {

    List<com.sun.tools.javac.code.Type> seenCaptured = List.nil();
     ...
     * @return localized string representation
     */
    public String visitTypes(List<com.sun.tools.javac.code.Type> ts, Locale locale) {
     ...
     * @return localized string representation
     */
    public String visitSymbols(List<com.sun.tools.javac.code.Symbol> ts, Locale locale) {
        ListBuffer<String> sbuf = new ListBuffer<>();
        for (com.sun.tools.javac.code.Symbol t : ts) {
            sbuf.append(visit(t, locale));
        }
        return sbuf.toList().toString();
    }
     ...
     * @return localized string representation
     */
    public String visit(com.sun.tools.javac.code.Type t, Locale locale) {
     ...
     * @return localized string representation
     */
    public String visit(com.sun.tools.javac.code.Symbol s, Locale locale) {
    ...
    void printBaseElementType(com.sun.tools.javac.code.Type t, StringBuilder sb, Locale locale) {
        com.sun.tools.javac.code.Type arrel = t;
    ...
    void printBrackets(com.sun.tools.javac.code.Type t, StringBuilder sb, Locale locale) {
        com.sun.tools.javac.code.Type arrel = t;
        while (arrel.hasTag(TypeTag.ARRAY)) {
        ...
        if (t.getAnnotationMirrors().nonEmpty()) {
            if (t.unannotatedType().hasTag(TypeTag.ARRAY)) {
                ...
                return res.toString();
                    ...
                    t.unannotatedType().getEnclosingType() != com.sun.tools.javac.code.Type.noType) {
    ...
    public String visitType(com.sun.tools.javac.code.Type t, Locale locale) {
    ...
    protected String className(ClassType t, boolean longform, Locale locale) {
        com.sun.tools.javac.code.Symbol sym = t.tsym;
        if (sym.name.length() == 0 && (sym.flags() & COMPOUND) != 0) {
            StringBuilder s = new StringBuilder(visit(t.supertype_field, locale));
            for (List<com.sun.tools.javac.code.Type> is = t.interfaces_field; is.nonEmpty(); is = is.tail) {
                s.append('&');
