...
public abstract class Attribute implements AnnotationValue {
    ...
    public Attribute(com.sun.tools.javac.code.Type type) {
        this.type = type;
    }
    ...
    public static class Constant extends Attribute {
        ...
        public void accept(com.sun.tools.javac.code.Attribute.Visitor v) { v.visitConstant(this); }
        public Constant(com.sun.tools.javac.code.Type type, Object value) {
            super(type);
            this.value = value;
        }
    ...
    public static class Class extends Attribute {
        ...
        public void accept(com.sun.tools.javac.code.Attribute.Visitor v) { v.visitClass(this); }
        public Class(com.sun.tools.javac.code.Types types, com.sun.tools.javac.code.Type type) {
            super(makeClassType(types, type));
            this.classType = type;
        }
        static com.sun.tools.javac.code.Type makeClassType(Types types, com.sun.tools.javac.code.Type type) {
            com.sun.tools.javac.code.Type arg = type.isPrimitive()
                ? types.boxedClass(type).type
                : types.erasure(type);
            return new com.sun.tools.javac.code.Type.ClassType(types.syms.classType.getEnclosingType(),
                                      List.of(arg),
    ...
    public static class Compound extends Attribute implements AnnotationMirror {
        ...
        public Compound(com.sun.tools.javac.code.Type type,
                        List<Pair<MethodSymbol,Attribute>> values) {
            super(type);
            this.values = values;
        }
        public void accept(com.sun.tools.javac.code.Attribute.Visitor v) { v.visitCompound(this); }
    ...
    public static class TypeCompound extends Compound {
        ...
        public TypeCompound(com.sun.tools.javac.code.Attribute.Compound compound,
                            TypeAnnotationPosition position) {
            this(compound.type, compound.values, position);
        }
        public TypeCompound(com.sun.tools.javac.code.Type type,
                            List<Pair<MethodSymbol, Attribute>> values,
                            TypeAnnotationPosition position) {
            super(type, values);
        ...
        private com.sun.tools.javac.code.Attribute.TypeCompound getFirstEmbeddedTC() {
            if (values.size() == 1) {
                ...
                if (val.fst.getSimpleName().contentEquals("value")
                        && val.snd instanceof com.sun.tools.javac.code.Attribute.Array) {
                    com.sun.tools.javac.code.Attribute.Array arr = (com.sun.tools.javac.code.Attribute.Array) val.snd;
        ...
        public boolean tryFixPosition() {
            ...
            com.sun.tools.javac.code.Attribute.TypeCompound from = getFirstEmbeddedTC();
    ...
    public static class Array extends Attribute {
        ...
        public Array(com.sun.tools.javac.code.Type type, Attribute[] values) {
            super(type);
            this.values = values;
        }

        public Array(com.sun.tools.javac.code.Type type, List<Attribute> values) {
            super(type);
            this.values = values.toArray(new Attribute[values.size()]);
        }

        public void accept(com.sun.tools.javac.code.Attribute.Visitor v) { v.visitArray(this); }
        public String toString() {
            StringBuilder buf = new StringBuilder();
            buf.append('{');
            boolean first = true;
    ...
    public static class Enum extends Attribute {
        ...
        public Enum(com.sun.tools.javac.code.Type type, VarSymbol value) {
            super(type);
            this.value = Assert.checkNonNull(value);
        }
        public void accept(com.sun.tools.javac.code.Attribute.Visitor v) { v.visitEnum(this); }
        public String toString() {
    ...
    public static class Error extends Attribute {
        public Error(com.sun.tools.javac.code.Type type) {
            super(type);
        }
        public void accept(com.sun.tools.javac.code.Attribute.Visitor v) { v.visitError(this); }
        public String toString() {
            return "<error>";
        }
    ...
    public static class UnresolvedClass extends Error {
        ...
        public UnresolvedClass(com.sun.tools.javac.code.Type type, Type classType) {
            super(type);
