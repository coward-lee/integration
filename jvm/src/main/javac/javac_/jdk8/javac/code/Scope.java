...
public class Scope {
    ...
    public static class ImportScope extends Scope {
        ...
        @Override
        com.sun.tools.javac.code.Scope.Entry makeEntry(Symbol sym, com.sun.tools.javac.code.Scope.Entry shadowed, com.sun.tools.javac.code.Scope.Entry sibling, Scope scope,
                                                       final Scope origin, final boolean staticallyImported) {
            return new com.sun.tools.javac.code.Scope.Entry(sym, shadowed, sibling, scope) {
                @Override
                public Scope getOrigin() {
                    return origin;
                }
    ...
    public static class DelegatedScope extends Scope {
        Scope delegatee;
        public static final com.sun.tools.javac.code.Scope.Entry[] emptyTable = new com.sun.tools.javac.code.Scope.Entry[0];
        ...
        public com.sun.tools.javac.code.Scope.Entry lookup(Name name) {
    ...
    public static class CompoundScope extends Scope implements ScopeListener {
        ...
        public void addSubScope(Scope that) {
           if (that != null) {
                ...
                mark++;
                for (com.sun.tools.javac.code.Scope.ScopeListener sl : listeners) {
        ...
        @Override
        public com.sun.tools.javac.code.Scope.Entry lookup(Name name, Filter<Symbol> sf) {
            throw new UnsupportedOperationException();
        }
    ...
    public static class ErrorScope extends Scope {
        ErrorScope(Scope next, Symbol errSymbol, com.sun.tools.javac.code.Scope.Entry[] table) {
        ...
        public Scope dup() {
            return new com.sun.tools.javac.code.Scope.ErrorScope(this, owner, table);
        }
        public Scope dupUnshared() {
            return new com.sun.tools.javac.code.Scope.ErrorScope(this, owner, table.clone());
        }
        public com.sun.tools.javac.code.Scope.Entry lookup(Name name) {
            com.sun.tools.javac.code.Scope.Entry e = super.lookup(name);
            if (e.scope == null)
                return new com.sun.tools.javac.code.Scope.Entry(owner, null, null, null);
            else
                return e;
        }
    }
