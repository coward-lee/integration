...
public class Tokens {
    ...
    final static class NamedToken extends Token {
        ...
        protected void checkKind() {
            if (kind.tag != com.sun.tools.javac.parser.Tokens.Token.Tag.NAMED) {
                throw new AssertionError("Bad token kind - expected " + com.sun.tools.javac.parser.Tokens.Token.Tag.NAMED);
            }
        }
    ...
    static class StringToken extends Token {
        ...
        protected void checkKind() {
            if (kind.tag != com.sun.tools.javac.parser.Tokens.Token.Tag.STRING) {
                throw new AssertionError("Bad token kind - expected " + com.sun.tools.javac.parser.Tokens.Token.Tag.STRING);
            }
        }
    ...
    final static class NumericToken extends StringToken {
        ...
        protected void checkKind() {
            if (kind.tag != com.sun.tools.javac.parser.Tokens.Token.Tag.NUMERIC) {
                throw new AssertionError("Bad token kind - expected " + com.sun.tools.javac.parser.Tokens.Token.Tag.NUMERIC);
            }
        }
