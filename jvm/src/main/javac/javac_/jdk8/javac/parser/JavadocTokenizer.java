 ...
 */
public class JavadocTokenizer extends com.sun.tools.javac.parser.JavaTokenizer {

    /** Create a scanner from the input buffer.  buffer must implement
     *  array() and compact(), and remaining() must be less than limit().
     */
    protected JavadocTokenizer(com.sun.tools.javac.parser.ScannerFactory fac, CharBuffer buffer) {
        super(fac, buffer);
    }
     ...
     */
    protected JavadocTokenizer(com.sun.tools.javac.parser.ScannerFactory fac, char[] input, int inputLength) {
