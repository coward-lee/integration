...
package javac_.jdk8.javac.comp;
...
public class Resolve {
    ...
    protected Resolve(Context context) {
        ...
        infer = com.sun.tools.javac.comp.Infer.instance(context);
 ...
 *************************************************************************/
     ...
     */
    protected static boolean isStatic(com.sun.tools.javac.comp.Env<AttrContext> env) {
     ...
     */
    static boolean isInitializer(com.sun.tools.javac.comp.Env<AttrContext> env) {
     ...
     */
    public boolean isAccessible(com.sun.tools.javac.comp.Env<AttrContext> env, TypeSymbol c) {
        return isAccessible(env, c, false);
    }

    public boolean isAccessible(com.sun.tools.javac.comp.Env<AttrContext> env, TypeSymbol c, boolean checkInner) {
    ...
    boolean isAccessible(com.sun.tools.javac.comp.Env<AttrContext> env, Type t) {
        return isAccessible(env, t, false);
    }

    boolean isAccessible(com.sun.tools.javac.comp.Env<AttrContext> env, Type t, boolean checkInner) {
     ...
     */
    public boolean isAccessible(com.sun.tools.javac.comp.Env<AttrContext> env, Type site, Symbol sym) {
        return isAccessible(env, site, sym, false);
    }
    public boolean isAccessible(com.sun.tools.javac.comp.Env<AttrContext> env, Type site, Symbol sym, boolean checkInner) {
     ...
     */
    void checkAccessibleType(com.sun.tools.javac.comp.Env<AttrContext> env, Type t) {
     ...
     */
    Types.SimpleVisitor<Void, com.sun.tools.javac.comp.Env<AttrContext>> accessibilityChecker =
            new Types.SimpleVisitor<Void, com.sun.tools.javac.comp.Env<AttrContext>>() {

        void visit(List<Type> ts, com.sun.tools.javac.comp.Env<AttrContext> env) {
            for (Type t : ts) {
                visit(t, env);
            }
        }

        public Void visitType(Type t, com.sun.tools.javac.comp.Env<AttrContext> env) {
            return null;
        }

        @Override
        public Void visitArrayType(ArrayType t, com.sun.tools.javac.comp.Env<AttrContext> env) {
            visit(t.elemtype, env);
            return null;
        }

        @Override
        public Void visitClassType(ClassType t, com.sun.tools.javac.comp.Env<AttrContext> env) {
        ...
        @Override
        public Void visitWildcardType(WildcardType t, com.sun.tools.javac.comp.Env<AttrContext> env) {
            visit(t.type, env);
            return null;
        }

        @Override
        public Void visitMethodType(MethodType t, com.sun.tools.javac.comp.Env<AttrContext> env) {
     ...
     */
    Type rawInstantiate(com.sun.tools.javac.comp.Env<AttrContext> env,
                        Type site,
                        Symbol m,
    ...
    Type checkMethod(com.sun.tools.javac.comp.Env<AttrContext> env,
                     Type site,
                     Symbol m,
                     ResultInfo resultInfo,
                     List<Type> argtypes,
     ...
     */
    Type instantiate(com.sun.tools.javac.comp.Env<AttrContext> env,
                     Type site,
                     Symbol m,
                     ResultInfo resultInfo,
                     List<Type> argtypes,
    ...
    interface MethodCheck {
         ...
         */
        void argumentsAcceptable(com.sun.tools.javac.comp.Env<AttrContext> env,
    ...
    MethodCheck nilMethodCheck = new MethodCheck() {
        public void argumentsAcceptable(com.sun.tools.javac.comp.Env<AttrContext> env, DeferredAttrContext deferredAttrContext, List<Type> argtypes, List<Type> formals, Warner warn) {
    ...
    abstract class AbstractMethodCheck implements MethodCheck {
        @Override
        public void argumentsAcceptable(final com.sun.tools.javac.comp.Env<AttrContext> env,
                                    DeferredAttrContext deferredAttrContext,
                                    List<Type> argtypes,
                                    List<Type> formals,
                                    Warner warn) {
    ...
    MethodCheck resolveMethodCheck = new AbstractMethodCheck() {
         ...
         */
        private void varargsAccessible(final com.sun.tools.javac.comp.Env<AttrContext> env, final Type t, final InferenceContext inferenceContext) {
 ...
 ****************************************************************************/
     ...
     */
    Symbol findField(com.sun.tools.javac.comp.Env<AttrContext> env,
                     Type site,
                     Name name,
                     TypeSymbol c) {
     ...
     */
    public VarSymbol resolveInternalField(DiagnosticPosition pos, com.sun.tools.javac.comp.Env<AttrContext> env,
                                          Type site, Name name) {
     ...
     */
    Symbol findVar(com.sun.tools.javac.comp.Env<AttrContext> env, Name name) {
        Symbol bestSoFar = varNotFound;
        Symbol sym;
        com.sun.tools.javac.comp.Env<AttrContext> env1 = env;
    ...
    Symbol selectBest(com.sun.tools.javac.comp.Env<AttrContext> env,
                      Type site,
                      List<Type> argtypes,
                      List<Type> typeargtypes,
                      Symbol sym,
    ...
    Symbol mostSpecific(List<Type> argtypes, Symbol m1,
                        Symbol m2,
                        com.sun.tools.javac.comp.Env<AttrContext> env,
                        final Type site,
                        boolean allowBoxing,
                        boolean useVarargs) {
        switch (m2.kind) {
    ...
    //where
    private boolean signatureMoreSpecific(List<Type> actuals, com.sun.tools.javac.comp.Env<AttrContext> env, Type site, Symbol m1, Symbol m2, boolean allowBoxing, boolean useVarargs) {
        noteWarner.clear();
    ...
    Symbol findMethodInScope(com.sun.tools.javac.comp.Env<AttrContext> env,
                             Type site,
                             Name name,
                             List<Type> argtypes,
                             List<Type> typeargtypes,
     ...
     *  @param useVarargs Box trailing arguments into an array for varargs.
     */
    Symbol findMethod(com.sun.tools.javac.comp.Env<AttrContext> env,
                      Type site,
                      Name name,
                      List<Type> argtypes,
                      List<Type> typeargtypes,
    ...
    // where
    private Symbol findMethod(com.sun.tools.javac.comp.Env<AttrContext> env,
                              Type site,
                              Name name,
                              List<Type> argtypes,
                              List<Type> typeargtypes,
     ...
     *  @param useVarargs Box trailing arguments into an array for varargs.
     */
    Symbol findFun(com.sun.tools.javac.comp.Env<AttrContext> env, Name name,
     ...
     */
    Symbol loadClass(com.sun.tools.javac.comp.Env<AttrContext> env, Name name) {
        try {
     ...
     *                   site's class.
     */
    Symbol findImmediateMemberType(com.sun.tools.javac.comp.Env<AttrContext> env,
                                   Type site,
                                   Name name,
                                   TypeSymbol c) {
        Scope.Entry e = c.members().lookup(name);
     ...
     *                   site's class.
     */
    Symbol findInheritedMemberType(com.sun.tools.javac.comp.Env<AttrContext> env,
                                   Type site,
                                   Name name,
                                   TypeSymbol c) {
     ...
     *                   site's class.
     */
    Symbol findMemberType(com.sun.tools.javac.comp.Env<AttrContext> env,
                          Type site,
                          Name name,
                          TypeSymbol c) {
     ...
     *  @param name      The type's name.
     */
    Symbol findGlobalType(com.sun.tools.javac.comp.Env<AttrContext> env, Scope scope, Name name) {
        Symbol bestSoFar = typeNotFound;
    ...
    Symbol findTypeVar(com.sun.tools.javac.comp.Env<AttrContext> env, Name name, boolean staticOnly) {
     ...
     *  @param name      The type's name.
     */
    Symbol findType(com.sun.tools.javac.comp.Env<AttrContext> env, Name name) {
        Symbol bestSoFar = typeNotFound;
        Symbol sym;
        boolean staticOnly = false;
        for (com.sun.tools.javac.comp.Env<AttrContext> env1 = env; env1.outer != null; env1 = env1.outer) {
            if (isStatic(env1)) staticOnly = true;
     ...
     */
    Symbol findIdent(com.sun.tools.javac.comp.Env<AttrContext> env, Name name, int kind) {
        Symbol bestSoFar = typeNotFound;
        Symbol sym;
     ...
     */
    Symbol findIdentInPackage(com.sun.tools.javac.comp.Env<AttrContext> env, TypeSymbol pck,
                              Name name, int kind) {
     ...
     *                   (a subset of VAL, TYP).
     */
    Symbol findIdentInType(com.sun.tools.javac.comp.Env<AttrContext> env, Type site,
                           Name name, int kind) {
        Symbol bestSoFar = typeNotFound;
        Symbol sym;
        if ((kind & VAR) != 0) {
 ...
 ****************************************************************************/
    ...
    void printscopes(com.sun.tools.javac.comp.Env<AttrContext> env) {
 ...
 ****************************************************************************/
     ...
     */
    Symbol resolveIdent(DiagnosticPosition pos, com.sun.tools.javac.comp.Env<AttrContext> env,
                        Name name, int kind) {
        return accessBase(
    ...
    Symbol resolveMethod(DiagnosticPosition pos,
        ...
        return lookupMethod(env, pos, env.enclClass.sym, resolveMethodCheck,
                new BasicLookupHelper(name, env.enclClass.sym.type, argtypes, typeargtypes) {
                    @Override
                    Symbol doLookup(com.sun.tools.javac.comp.Env<AttrContext> env, MethodResolutionPhase phase) {
     ...
     *  @param typeargtypes  The types of the invocation's type arguments.
     */
    Symbol resolveQualifiedMethod(DiagnosticPosition pos, com.sun.tools.javac.comp.Env<AttrContext> env,
    ...
    private Symbol resolveQualifiedMethod(MethodResolutionContext resolveContext,
                                  DiagnosticPosition pos, com.sun.tools.javac.comp.Env<AttrContext> env,
                                  Symbol location, Type site, Name name, List<Type> argtypes,
                                  List<Type> typeargtypes) {
        return lookupMethod(env, pos, location, resolveContext, new BasicLookupHelper(name, site, argtypes, typeargtypes) {
            ...
            @Override
            Symbol access(com.sun.tools.javac.comp.Env<AttrContext> env, DiagnosticPosition pos, Symbol location, Symbol sym) {
                if (sym.kind >= AMBIGUOUS) {
     ...
     */
    Symbol findPolymorphicSignatureInstance(com.sun.tools.javac.comp.Env<AttrContext> env,
     ...
     *  @param typeargtypes  The types of the invocation's type arguments.
     */
    public MethodSymbol resolveInternalMethod(DiagnosticPosition pos, com.sun.tools.javac.comp.Env<AttrContext> env,
                                        Type site, Name name,
                                        List<Type> argtypes,
                                        List<Type> typeargtypes) {
     ...
     *  @param typeargtypes  The types of the invocation's type arguments.
     */
    public MethodSymbol resolveInternalConstructor(DiagnosticPosition pos, com.sun.tools.javac.comp.Env<AttrContext> env,
                                        Type site,
                                        List<Type> argtypes,
                                        List<Type> typeargtypes) {
        MethodResolutionContext resolveContext = new MethodResolutionContext();
    ...
    Symbol findConstructor(DiagnosticPosition pos, com.sun.tools.javac.comp.Env<AttrContext> env,
     ...
     */
    private Symbol findDiamond(com.sun.tools.javac.comp.Env<AttrContext> env,
                               Type site,
                               List<Type> argtypes,
                               List<Type> typeargtypes,
                               boolean allowBoxing,
    ...
    Symbol resolveOperator(DiagnosticPosition pos, JCTree.Tag optag,
                           com.sun.tools.javac.comp.Env<AttrContext> env, List<Type> argtypes) {
        MethodResolutionContext prevResolutionContext = currentResolutionContext;
        try {
            currentResolutionContext = new MethodResolutionContext();
     ...
     */
    Symbol resolveUnaryOperator(DiagnosticPosition pos, JCTree.Tag optag, com.sun.tools.javac.comp.Env<AttrContext> env, Type arg) {
    ...
    Symbol getMemberReference(DiagnosticPosition pos,
        ...
        com.sun.tools.javac.comp.Env<AttrContext> newEnv = env.dup(env.tree, env.info.dup());
    ...
    Symbol resolveMemberReferenceByArity(com.sun.tools.javac.comp.Env<AttrContext> env,
                                         JCMemberReference referenceTree,
                                         Type site,
                                         Name name,
                                         List<Type> argtypes,
        ...
        //step 1 - bound lookup
        com.sun.tools.javac.comp.Env<AttrContext> boundEnv = env.dup(env.tree, env.info.dup());
        ...
        com.sun.tools.javac.comp.Env<AttrContext> unboundEnv = env.dup(env.tree, env.info.dup());
        if (isStaticSelector) {
     ...
     * has a raw qualifier).
     */
    Pair<Symbol, ReferenceLookupHelper> resolveMemberReference(com.sun.tools.javac.comp.Env<AttrContext> env,
                                                               JCMemberReference referenceTree,
                                                               Type site,
                                                               Name name,
                                                               List<Type> argtypes,
    ...
    abstract class LookupHelper {
         ...
         */
        abstract Symbol lookup(com.sun.tools.javac.comp.Env<AttrContext> env, MethodResolutionPhase phase);
         ...
         */
        abstract Symbol access(com.sun.tools.javac.comp.Env<AttrContext> env, DiagnosticPosition pos, Symbol location, Symbol sym);
    }
    ...
    abstract class BasicLookupHelper extends LookupHelper {
        ...
        @Override
        final Symbol lookup(com.sun.tools.javac.comp.Env<AttrContext> env, MethodResolutionPhase phase) {
        ...
        abstract Symbol doLookup(com.sun.tools.javac.comp.Env<AttrContext> env, MethodResolutionPhase phase);
    ...
    abstract class ReferenceLookupHelper extends LookupHelper {
        ...
        ReferenceLookupHelper unboundLookup(InferenceContext inferenceContext) {
            ...
            return new ReferenceLookupHelper(referenceTree, name, site, argtypes, typeargtypes, maxPhase) {
                ...
                @Override
                Symbol lookup(com.sun.tools.javac.comp.Env<AttrContext> env, MethodResolutionPhase phase) {
    ...
    class ArrayConstructorReferenceLookupHelper extends ReferenceLookupHelper {
        ...
        @Override
        protected Symbol lookup(com.sun.tools.javac.comp.Env<AttrContext> env, MethodResolutionPhase phase) {
     ...
     */
    Symbol lookupMethod(com.sun.tools.javac.comp.Env<AttrContext> env, DiagnosticPosition pos, Symbol location, MethodCheck methodCheck, LookupHelper lookupHelper) {
        MethodResolutionContext resolveContext = new MethodResolutionContext();
        resolveContext.methodCheck = methodCheck;
        return lookupMethod(env, pos, location, resolveContext, lookupHelper);
    }

    Symbol lookupMethod(com.sun.tools.javac.comp.Env<AttrContext> env, DiagnosticPosition pos, Symbol location,
    ...
    boolean hasEnclosingInstance(com.sun.tools.javac.comp.Env<AttrContext> env, Type type) {
        Symbol encl = resolveSelfContainingInternal(env, type.tsym, false);
        return encl != null && encl.kind < ERRONEOUS;
    }

    private Symbol resolveSelfContainingInternal(com.sun.tools.javac.comp.Env<AttrContext> env,
                                                 Symbol member,
                                                 boolean isSuperCall) {
        Name name = names._this;
        com.sun.tools.javac.comp.Env<AttrContext> env1 = isSuperCall ? env.outer : env;
        boolean staticOnly = false;
        if (env1 != null) {
     ...
     */
    Type resolveImplicitThis(DiagnosticPosition pos, com.sun.tools.javac.comp.Env<AttrContext> env, Type t) {
        return resolveImplicitThis(pos, env, t, false);
    }

    Type resolveImplicitThis(DiagnosticPosition pos, com.sun.tools.javac.comp.Env<AttrContext> env, Type t, boolean isSuperCall) {
 ...
 ****************************************************************************/
    ...
    public void logAccessErrorInternal(com.sun.tools.javac.comp.Env<AttrContext> env, JCTree tree, Type type) {
    ...
    class AccessError extends InvalidSymbolError {
        ...
        private com.sun.tools.javac.comp.Env<AttrContext> env;
        private Type site;
