...
class TypeEnvs {
    ...
    private HashMap<TypeSymbol, com.sun.tools.javac.comp.Env<AttrContext>> map;
    protected TypeEnvs(Context context) {
        map = new HashMap<>();
        context.put(typeEnvsKey, this);
    }

    com.sun.tools.javac.comp.Env<AttrContext> get(TypeSymbol sym) { return map.get(sym); }
    com.sun.tools.javac.comp.Env<AttrContext> put(TypeSymbol sym, com.sun.tools.javac.comp.Env<AttrContext> env) { return map.put(sym, env); }
    com.sun.tools.javac.comp.Env<AttrContext> remove(TypeSymbol sym) { return map.remove(sym); }
