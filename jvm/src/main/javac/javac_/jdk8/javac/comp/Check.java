 ...
 **************************************************************************/
     ...
     */
    public void checkRedundantCast(com.sun.tools.javac.comp.Env<AttrContext> env, final JCTypeCast tree) {
    ...
    void checkVarargsMethodDecl(com.sun.tools.javac.comp.Env<AttrContext> env, JCMethodDecl tree) {
    ...
    Type checkMethod(final Type mtype,
            final Symbol sym,
            final com.sun.tools.javac.comp.Env<AttrContext> env,
 ...
 **************************************************************************/
     ...
     */
    void validate(JCTree tree, com.sun.tools.javac.comp.Env<AttrContext> env) {
        validate(tree, env, true);
    }
    void validate(JCTree tree, com.sun.tools.javac.comp.Env<AttrContext> env, boolean checkRaw) {
        new Validator(env).validateTree(tree, checkRaw, true);
    }

    /** Visitor method: Validate a list of type expressions.
     */
    void validate(List<? extends JCTree> trees, com.sun.tools.javac.comp.Env<AttrContext> env) {
    ...
    class Validator extends JCTree.Visitor {
        ...
        Validator(com.sun.tools.javac.comp.Env<AttrContext> env) {
            this.env = env;
        }
    ...
    void checkRaw(JCTree tree, com.sun.tools.javac.comp.Env<AttrContext> env) {
    ...
    //where
        private boolean withinAnonConstr(com.sun.tools.javac.comp.Env<AttrContext> env) {
    ...
    class CycleChecker extends TreeScanner {
        ...
        private void checkSymbol(DiagnosticPosition pos, Symbol sym) {
            if (sym != null && sym.kind == TYP) {
                com.sun.tools.javac.comp.Env<AttrContext> classEnv = enter.getEnv((TypeSymbol)sym);
                if (classEnv != null) {
