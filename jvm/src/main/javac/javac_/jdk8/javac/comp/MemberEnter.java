...
public class MemberEnter extends JCTree.Visitor implements Completer {
    ...
    protected MemberEnter(Context context) {
        ...
        annotate = com.sun.tools.javac.comp.Annotate.instance(context);
        ...
        typeEnvs = com.sun.tools.javac.comp.TypeEnvs.instance(context);
     ...
     *  symbol table.
     */
    ListBuffer<com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext>> halfcompleted = new ListBuffer<com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext>>();
    ...
    private void importStaticAll(int pos,
        ...
        annotate.earlier(new com.sun.tools.javac.comp.Annotate.Worker() {
            Set<Symbol> processed = new HashSet<Symbol>();
    ...
    private void importNamedStatic(final DiagnosticPosition pos,
                                   final TypeSymbol tsym,
                                   final Name name,
                                   final com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
        if (tsym.kind != TYP) {
     ...
     *                  scope to add to.
     */
    private void importNamed(DiagnosticPosition pos, Symbol tsym, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
        if (tsym.kind == TYP &&
 ...
 *********************************************************************/
     ...
     */
    protected void memberEnter(JCTree tree, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> prevEnv = this.env;
        try {
            this.env = env;
            tree.accept(this);
     ...
     */
    void memberEnter(List<? extends JCTree> trees, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
     ...
     */
    void finishClass(JCClassDecl tree, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
     ...
     *  to the symbol table.
     */
    private void addEnumMembers(JCClassDecl tree, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
    ...
    public void visitImport(JCImport tree) {
        ...
        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> localEnv = env.dup(tree);
    ...
    public void visitMethodDef(JCMethodDecl tree) {
        ...
        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> localEnv = methodEnv(tree, env);
     ...
     */
    com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> methodEnv(JCMethodDecl tree, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> localEnv =
    ...
    public void visitVarDef(JCVariableDecl tree) {
        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> localEnv = env;
        ...
        if (tree.init != null) {
            ...
            if ((v.flags_field & FINAL) != 0 &&
                ...
                com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> initEnv = getInitEnv(tree, env);
    ...
    void checkReceiver(JCVariableDecl tree, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> localEnv) {
     ...
     */
    com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> initEnv(JCVariableDecl tree, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> localEnv = env.dupto(new AttrContextEnv(tree, env.info.dup()));
    ...
    public com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> getMethodEnv(JCMethodDecl tree, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> mEnv = methodEnv(tree, env);
    ...
    public com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> getInitEnv(JCVariableDecl tree, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> iEnv = initEnv(tree, env);
        return iEnv;
    }
 ...
 *********************************************************************/
    ...
    Type attribImportType(JCTree tree, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
 ...
 *********************************************************************/
    ...
    void annotateLater(final List<JCAnnotation> annotations,
                       final com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> localEnv,
                       final Symbol s,
        ...
        annotate.normal(new com.sun.tools.javac.comp.Annotate.Worker() {
                @Override
                public String toString() {
        ...
        annotate.validate(new com.sun.tools.javac.comp.Annotate.Worker() { //validate annotations
            @Override
            public void run() {
                JavaFileObject prev = log.useSource(localEnv.toplevel.sourcefile);
                try {
 ...
 *********************************************************************/
    ...
    public void complete(Symbol sym) throws CompletionFailure {
        ...
        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env = typeEnvs.get(c);
        ...
        try {
            ...
            try {
                ...
                com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> baseEnv = baseEnv(tree, env);
            ...
            if (wasFirst) {
                try {
                    while (halfcompleted.nonEmpty()) {
                        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> toFinish = halfcompleted.next();
                        finish(toFinish);
                        if (allowTypeAnnos) {
    ...
    public void typeAnnotate(final JCTree tree, final com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env, final Symbol sym, DiagnosticPosition deferPos) {
        if (allowTypeAnnos) {
    ...
    private class TypeAnnotate extends TreeScanner {
        ...
        public TypeAnnotate(final com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env, final Symbol sym, DiagnosticPosition deferPos) {
            this.env = env;
            this.sym = sym;
    ...
    private com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> baseEnv(JCClassDecl tree, com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> env) {
        ...
        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> outer = env.outer; // the base clause can't see members of this class
        com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext> localEnv = outer.dup(tree, outer.info.dup(baseScope));
     ...
     */
    private void finish(Env<javac_.jdk8.javac.comp.AttrContext> env) {
        JavaFileObject prev = log.useSource(env.toplevel.sourcefile);
        try {
            JCClassDecl tree = (JCClassDecl)env.tree;
