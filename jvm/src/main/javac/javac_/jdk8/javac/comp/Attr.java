...
public class Attr extends JCTree.Visitor {
     ...
     */
    boolean isAssignableAsBlankFinal(VarSymbol v, com.sun.tools.javac.comp.Env<AttrContext> env) {
     ...
     *  @param env    The current environment.
     */
    void checkAssignable(DiagnosticPosition pos, VarSymbol v, JCTree base, com.sun.tools.javac.comp.Env<AttrContext> env) {
        if ((v.flags() & FINAL) != 0 &&
            ((v.flags() & HASINIT) != 0
             ||
             !((base == null ||
     ...
     *  @param env    The current environment.
     */
    Symbol thisSym(DiagnosticPosition pos, com.sun.tools.javac.comp.Env<AttrContext> env) {
    ...
    public Symbol attribIdent(JCTree tree, JCCompilationUnit topLevel) {
        com.sun.tools.javac.comp.Env<AttrContext> localEnv = enter.topLevelEnv(topLevel);
    ...
    // where
        private TreeVisitor<Symbol, com.sun.tools.javac.comp.Env<AttrContext>> identAttributer = new IdentAttributer();
        private class IdentAttributer extends SimpleTreeVisitor<Symbol, com.sun.tools.javac.comp.Env<AttrContext>> {
            @Override
            public Symbol visitMemberSelect(MemberSelectTree node, com.sun.tools.javac.comp.Env<AttrContext> env) {
            ...
            @Override
            public Symbol visitIdentifier(IdentifierTree node, com.sun.tools.javac.comp.Env<AttrContext> env) {
    ...
    public Type attribType(JCTree node, TypeSymbol sym) {
        com.sun.tools.javac.comp.Env<AttrContext> env = typeEnvs.get(sym);
        com.sun.tools.javac.comp.Env<AttrContext> localEnv = env.dup(node, env.info.dup());
        return attribTree(node, localEnv, unknownTypeInfo);
    }

    public Type attribImportQualifier(JCImport tree, com.sun.tools.javac.comp.Env<AttrContext> env) {
    ...
    public com.sun.tools.javac.comp.Env<AttrContext> attribExprToTree(JCTree expr, com.sun.tools.javac.comp.Env<AttrContext> env, JCTree tree) {
        breakTree = tree;
    ...
    public com.sun.tools.javac.comp.Env<AttrContext> attribStatToTree(JCTree stmt, com.sun.tools.javac.comp.Env<AttrContext> env, JCTree tree) {
        breakTree = tree;
        JavaFileObject prev = log.useSource(env.toplevel.sourcefile);
        try {
            attribStat(stmt, env);
    ...
    private static class BreakAttr extends RuntimeException {
        ...
        private BreakAttr(com.sun.tools.javac.comp.Env<AttrContext> env) {
            this.env = env;
        }
    }
 ...
 *************************************************************************/
     ...
     */
    Type attribTree(JCTree tree, com.sun.tools.javac.comp.Env<AttrContext> env, ResultInfo resultInfo) {
        com.sun.tools.javac.comp.Env<AttrContext> prevEnv = this.env;
    ...
    com.sun.tools.javac.comp.Env<AttrContext> copyEnv(com.sun.tools.javac.comp.Env<AttrContext> env) {
        com.sun.tools.javac.comp.Env<AttrContext> newEnv =
     ...
     */
    public Type attribExpr(JCTree tree, com.sun.tools.javac.comp.Env<AttrContext> env, Type pt) {
     ...
     */
    public Type attribExpr(JCTree tree, com.sun.tools.javac.comp.Env<AttrContext> env) {
        return attribTree(tree, env, unknownExprInfo);
    }

    /** Derived visitor method: attribute a type tree.
     */
    public Type attribType(JCTree tree, com.sun.tools.javac.comp.Env<AttrContext> env) {
    ...
    /** Derived visitor method: attribute a type tree.
     */
    Type attribType(JCTree tree, com.sun.tools.javac.comp.Env<AttrContext> env, Type pt) {
     ...
     */
    public Type attribStat(JCTree tree, com.sun.tools.javac.comp.Env<AttrContext> env) {
        return attribTree(tree, env, statInfo);
    }

    /** Attribute a list of expressions, returning a list of types.
     */
    List<Type> attribExprs(List<JCExpression> trees, com.sun.tools.javac.comp.Env<AttrContext> env, Type pt) {
     ...
     */
    <T extends JCTree> void attribStats(List<T> trees, com.sun.tools.javac.comp.Env<AttrContext> env) {
     ...
     */
    int attribArgs(List<JCExpression> trees, com.sun.tools.javac.comp.Env<AttrContext> env, ListBuffer<Type> argtypes) {
        int kind = VAL;
     ...
     */
    List<Type> attribAnyTypes(List<JCExpression> trees, com.sun.tools.javac.comp.Env<AttrContext> env) {
     ...
     */
    List<Type> attribTypes(List<JCExpression> trees, com.sun.tools.javac.comp.Env<AttrContext> env) {
     ...
     * @param env      the current environment
     */
    void attribTypeVariables(List<JCTypeParameter> typarams, com.sun.tools.javac.comp.Env<AttrContext> env) {
     ...
     */
    public Object attribLazyConstantValue(com.sun.tools.javac.comp.Env<AttrContext> env,
    ...
    Type attribIdentAsEnumType(com.sun.tools.javac.comp.Env<AttrContext> env, JCIdent id) {
    ...
    public void visitMethodDef(JCMethodDecl tree) {
        ...
        try {
            ...
            com.sun.tools.javac.comp.Env<AttrContext> localEnv = memberEnter.methodEnv(tree, env);
            ...
            if (tree.recvparam != null) {
                ...
                com.sun.tools.javac.comp.Env<AttrContext> newEnv = memberEnter.methodEnv(tree, env);
        ...
        try {
            ...
            if (tree.init != null) {
                if ((v.flags_field & FINAL) == 0 ||
                    ...
                    com.sun.tools.javac.comp.Env<AttrContext> initEnv = memberEnter.initEnv(tree, env);
    ...
    public void visitBlock(JCBlock tree) {
        if (env.info.scope.owner.kind == TYP) {
            ...
            com.sun.tools.javac.comp.Env<AttrContext> localEnv =
    ...
    public void visitForLoop(JCForLoop tree) {
        com.sun.tools.javac.comp.Env<AttrContext> loopEnv =
    ...
    public void visitSwitch(JCSwitch tree) {
        ...
        com.sun.tools.javac.comp.Env<AttrContext> switchEnv =
            env.dup(tree, env.info.dup(env.info.scope.dup()));
        ...
        try {
            ...
            for (List<JCCase> l = tree.cases; l.nonEmpty(); l = l.tail) {
                JCCase c = l.head;
                com.sun.tools.javac.comp.Env<AttrContext> caseEnv =
    ...
    public void visitTry(JCTry tree) {
        ...
        com.sun.tools.javac.comp.Env<AttrContext> localEnv = env.dup(tree, env.info.dup(env.info.scope.dup()));
        try {
            boolean isTryWithResource = tree.resources.nonEmpty();
            // Create a nested environment for attributing the try block if needed
            com.sun.tools.javac.comp.Env<AttrContext> tryEnv = isTryWithResource ?
            ...
            for (List<JCCatch> l = tree.catchers; l.nonEmpty(); l = l.tail) {
                JCCatch c = l.head;
                com.sun.tools.javac.comp.Env<AttrContext> catchEnv =
    ...
    void checkAutoCloseable(DiagnosticPosition pos, com.sun.tools.javac.comp.Env<AttrContext> env, Type resource) {
    ...
    //where
        private boolean isBooleanOrNumeric(com.sun.tools.javac.comp.Env<AttrContext> env, JCExpression tree) {
            switch (tree.getTag()) {
    ...
    public void visitExec(JCExpressionStatement tree) {
        ...
        com.sun.tools.javac.comp.Env<AttrContext> localEnv = env.dup(tree);
    ...
    public void visitApply(JCMethodInvocation tree) {
        ...
        com.sun.tools.javac.comp.Env<AttrContext> localEnv = env.dup(tree, env.info.dup());
    ...
    //where
         ...
         */
        boolean checkFirstConstructorStat(JCMethodInvocation tree, com.sun.tools.javac.comp.Env<AttrContext> env) {
    ...
    public void visitNewClass(final JCNewClass tree) {
        ...
        if (clazztype.hasTag(CLASS)) {
            ...
            if (cdef == null &&
                ...
                com.sun.tools.javac.comp.Env<AttrContext> diamondEnv = localEnv.dup(tree);
            ...
            // current instance (JLS ???).
                ...
                com.sun.tools.javac.comp.Env<AttrContext> rsEnv = localEnv.dup(tree);
    ...
    //where
        void findDiamond(com.sun.tools.javac.comp.Env<AttrContext> env, JCNewClass tree, Type clazztype) {
    ...
    public void visitLambda(final JCLambda that) {
        ...
        final com.sun.tools.javac.comp.Env<AttrContext> localEnv = lambdaEnv(that, env);
    ...
    //where
        ...
        private void checkAccessibleTypes(final DiagnosticPosition pos, final com.sun.tools.javac.comp.Env<AttrContext> env,
        ...
        */
         ...
         */
        public com.sun.tools.javac.comp.Env<AttrContext> lambdaEnv(JCLambda that, com.sun.tools.javac.comp.Env<AttrContext> env) {
            com.sun.tools.javac.comp.Env<AttrContext> lambdaEnv;
            Symbol owner = env.info.scope.owner;
    ...
    public void visitReference(final JCMemberReference that) {
        ...
        final com.sun.tools.javac.comp.Env<AttrContext> localEnv = env.dup(that);
        try {
     ...
     */
    private void setFunctionalInfo(final com.sun.tools.javac.comp.Env<AttrContext> env, final JCFunctionalExpression fExpr,
    ...
    public void visitIdent(JCIdent tree) {
        ...
        //     (`noOuterThisPath').
        com.sun.tools.javac.comp.Env<AttrContext> symEnv = env;
...
//                             Resolve.isStatic(env));//DEBUG
         ...
         */
        com.sun.tools.javac.comp.Env<AttrContext> enclosingInitEnv(com.sun.tools.javac.comp.Env<AttrContext> env) {
            while (true) {
         ...
         */
        private void checkEnumInitializer(JCTree tree, com.sun.tools.javac.comp.Env<AttrContext> env, VarSymbol v) {
            // JLS:
            //
    ...
    Type checkIntersection(JCTree tree, List<JCExpression> bounds) {
        ...
        if (bounds.length() == 0) {
            ...
            com.sun.tools.javac.comp.Env<AttrContext> cenv = enter.classEnv(cd, env);
            typeEnvs.put(c, cenv);
            attribClass(c);
            return owntype;
        }
     ...
     */
    public void attrib(com.sun.tools.javac.comp.Env<AttrContext> env) {
     ...
     */
    public void attribTopLevel(com.sun.tools.javac.comp.Env<AttrContext> env) {
    ...
    void attribClass(ClassSymbol c) throws CompletionFailure {
        ...
        if ((c.flags_field & UNATTRIBUTED) != 0) {
            ...
            com.sun.tools.javac.comp.Env<AttrContext> env = typeEnvs.get(c);
            ...
            com.sun.tools.javac.comp.Env<AttrContext> lintEnv = env;
