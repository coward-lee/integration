...
public class Flow {
    ...
    private com.sun.tools.javac.comp.Env<AttrContext> attrEnv;
    private       Lint lint;
    ...
    public void analyzeTree(com.sun.tools.javac.comp.Env<AttrContext> env, TreeMaker make) {
    ...
    public void analyzeLambda(com.sun.tools.javac.comp.Env<AttrContext> env, JCLambda that, TreeMaker make, boolean speculative) {
    ...
    public List<Type> analyzeLambdaThrownTypes(final com.sun.tools.javac.comp.Env<AttrContext> env,
     ...
     *************************************************************************/
        ...
        public void visitClassDef(JCClassDecl tree) {
            ...
            ListBuffer<com.sun.tools.javac.comp.Flow.BaseAnalyzer.PendingExit> pendingExitsPrev = pendingExits;
            Lint lintPrev = lint;
        ...
        public void visitMethodDef(JCMethodDecl tree) {
            ...
            try {
                ...
                List<com.sun.tools.javac.comp.Flow.BaseAnalyzer.PendingExit> exits = pendingExits.toList();
                pendingExits = new ListBuffer<>();
                while (exits.nonEmpty()) {
                    com.sun.tools.javac.comp.Flow.BaseAnalyzer.PendingExit exit = exits.head;
                    exits = exits.tail;
        ...
        public void visitDoLoop(JCDoWhileLoop tree) {
            ListBuffer<com.sun.tools.javac.comp.Flow.BaseAnalyzer.PendingExit> prevPendingExits = pendingExits;
            pendingExits = new ListBuffer<>();
            scanStat(tree.body);
        ...
        public void visitTry(JCTry tree) {
            ...
            if (tree.finalizer != null) {
                ListBuffer<com.sun.tools.javac.comp.Flow.BaseAnalyzer.PendingExit> exits = pendingExits;
        ...
        public void visitBreak(JCBreak tree) {
            recordExit(new com.sun.tools.javac.comp.Flow.BaseAnalyzer.PendingExit(tree));
        }
        ...
        public void visitLambda(JCLambda tree) {
            ...
            ListBuffer<com.sun.tools.javac.comp.Flow.BaseAnalyzer.PendingExit> prevPending = pendingExits;
     ...
     *************************************************************************/
        ...
        public void analyzeTree(com.sun.tools.javac.comp.Env<AttrContext> env, JCTree tree, TreeMaker make) {
            try {
                attrEnv = env;
                Flow.this.make = make;
                pendingExits = new ListBuffer<>();
    ...
    class LambdaFlowAnalyzer extends FlowAnalyzer {
        ...
        public void visitLambda(JCLambda tree) {
            ...
            List<Type> prevCaught = caught;
            List<Type> prevThrown = thrown;
            ListBuffer<com.sun.tools.javac.comp.Flow.FlowAnalyzer.FlowPendingExit> prevPending = pendingExits;
            inLambda = true;
            try {
                pendingExits = new ListBuffer<>();
     ...
     *************************************************************************/
        ...
        /** Perform definite assignment/unassignment analysis on a tree.
         */
        public void analyzeTree(com.sun.tools.javac.comp.Env<?> env) {
            analyzeTree(env, env.tree);
         }

        public void analyzeTree(com.sun.tools.javac.comp.Env<?> env, JCTree tree) {
            try {
