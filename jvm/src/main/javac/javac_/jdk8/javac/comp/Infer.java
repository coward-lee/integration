...
public class Infer {
    ...
    */
     ...
     */
    Type instantiateMethod( com.sun.tools.javac.comp.Env<AttrContext> env,
                            List<Type> tvars,
                            MethodType mt,
     ...
     */
    Type generateReturnConstraints(JCTree tree, com.sun.tools.javac.comp.Attr.ResultInfo resultInfo,
    ...
    private Type generateReturnConstraintsPrimitive(JCTree tree, UndetVar from,
                                                    Type to, com.sun.tools.javac.comp.Attr.ResultInfo resultInfo, InferenceContext inferenceContext) {
        if (!allowGraphInference) {
    ...
    private Type generateReturnConstraintsUndetVarToReference(JCTree tree,
            UndetVar from, Type to, com.sun.tools.javac.comp.Attr.ResultInfo resultInfo,
    ...
    abstract class LeafSolver implements GraphStrategy {
        public Node pickNode(InferenceGraph g) {
            if (g.nodes.isEmpty()) {
                //should not happen
                throw new com.sun.tools.javac.comp.Infer.GraphStrategy.NodeNotFoundException(g);
            };
