 ...
 */
public class CompileStates extends HashMap<com.sun.tools.javac.comp.Env<com.sun.tools.javac.comp.AttrContext>, CompileStates.CompileState> {
    ...
    public boolean isDone(Env<javac_.jdk8.javac.comp.AttrContext> env, CompileState cs) {
