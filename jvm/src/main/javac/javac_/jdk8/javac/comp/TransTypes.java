...
public class TransTypes extends TreeTranslator {
     ...
     *  @param target  The target type.
     */
    public JCExpression coerce(com.sun.tools.javac.comp.Env<AttrContext> env, JCExpression tree, Type target) {
...
//      System.err.println("retype " + tree + " to " + erasedType);//DEBUG
    ...
    public <T extends JCTree> List<T> translateArgs(List<T> _args,
        ...
        com.sun.tools.javac.comp.Env<AttrContext> prevEnv = env;
        try {
            env = localEnv;
 ...
 *************************************************************************/
    ...
    void translateClass(ClassSymbol c) {
        ...
        com.sun.tools.javac.comp.Env<AttrContext> myEnv = enter.getEnv(c);
