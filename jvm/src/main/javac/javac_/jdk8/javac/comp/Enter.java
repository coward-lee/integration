...
public class Enter extends JCTree.Visitor {
     ...
     */
    public com.sun.tools.javac.comp.Env<AttrContext> getEnv(TypeSymbol sym) {
        return typeEnvs.get(sym);
    }

    public com.sun.tools.javac.comp.Env<AttrContext> getClassEnv(TypeSymbol sym) {
        com.sun.tools.javac.comp.Env<AttrContext> localEnv = getEnv(sym);
        com.sun.tools.javac.comp.Env<AttrContext> lintEnv = localEnv;
 ...
 *************************************************************************/
     ...
     */
    public com.sun.tools.javac.comp.Env<AttrContext> classEnv(JCClassDecl tree, com.sun.tools.javac.comp.Env<AttrContext> env) {
     ...
     */
    com.sun.tools.javac.comp.Env<AttrContext> topLevelEnv(JCCompilationUnit tree) {
        com.sun.tools.javac.comp.Env<AttrContext> localEnv = new com.sun.tools.javac.comp.Env<AttrContext>(tree, new AttrContext());
    ...
    public com.sun.tools.javac.comp.Env<AttrContext> getTopLevelEnv(JCCompilationUnit tree) {
        com.sun.tools.javac.comp.Env<AttrContext> localEnv = new com.sun.tools.javac.comp.Env<AttrContext>(tree, new AttrContext());
        localEnv.toplevel = tree;
        localEnv.enclClass = predefClassDef;
        localEnv.info.scope = tree.namedImportScope;
     ...
     */
    Scope enterScope(com.sun.tools.javac.comp.Env<AttrContext> env) {
 ...
 *************************************************************************/
     ...
     */
    protected com.sun.tools.javac.comp.Env<AttrContext> env;
     ...
     */
    Type classEnter(JCTree tree, com.sun.tools.javac.comp.Env<AttrContext> env) {
     ...
     */
    <T extends JCTree> List<Type> classEnter(List<T> trees, com.sun.tools.javac.comp.Env<AttrContext> env) {
    ...
    public void visitTopLevel(JCCompilationUnit tree) {
        ...
        com.sun.tools.javac.comp.Env<AttrContext> topEnv = topLevelEnv(tree);

        // Save environment of package-info.java file.
        if (isPkgInfo) {
            com.sun.tools.javac.comp.Env<AttrContext> env0 = typeEnvs.get(tree.packge);
            if (env0 == null) {
    ...
    public void visitClassDef(JCClassDecl tree) {
        ...
        com.sun.tools.javac.comp.Env<AttrContext> localEnv = classEnv(tree, env);
