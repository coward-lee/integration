 ...
 */
public class TreeMaker implements com.sun.tools.javac.tree.JCTree.Factory {
    ...
    public JCCompilationUnit TopLevel(List<JCAnnotation> packageAnnotations,
                                      JCExpression pid,
                                      List<com.sun.tools.javac.tree.JCTree> defs) {
        Assert.checkNonNull(packageAnnotations);
        for (com.sun.tools.javac.tree.JCTree node : defs)
    ...
    public JCImport Import(com.sun.tools.javac.tree.JCTree qualid, boolean importStatic) {
    ...
    public JCTry Try(JCBlock body, List<JCCatch> catchers, JCBlock finalizer) {
        return Try(List.<com.sun.tools.javac.tree.JCTree>nil(), body, catchers, finalizer);
    }

    public JCTry Try(List<com.sun.tools.javac.tree.JCTree> resources,
                     JCBlock body,
    ...
    public JCAssignOp Assignop(com.sun.tools.javac.tree.JCTree.Tag opcode, com.sun.tools.javac.tree.JCTree lhs, com.sun.tools.javac.tree.JCTree rhs) {
        JCAssignOp tree = new JCAssignOp(opcode, lhs, rhs, null);
        tree.pos = pos;
        return tree;
    }

    public JCUnary Unary(com.sun.tools.javac.tree.JCTree.Tag opcode, JCExpression arg) {
        JCUnary tree = new JCUnary(opcode, arg);
        tree.pos = pos;
        return tree;
    }

    public JCBinary Binary(com.sun.tools.javac.tree.JCTree.Tag opcode, JCExpression lhs, JCExpression rhs) {
        JCBinary tree = new JCBinary(opcode, lhs, rhs, null);
        tree.pos = pos;
        return tree;
    }

    public JCTypeCast TypeCast(com.sun.tools.javac.tree.JCTree clazz, JCExpression expr) {
        JCTypeCast tree = new JCTypeCast(clazz, expr);
        tree.pos = pos;
        return tree;
    }

    public JCInstanceOf TypeTest(JCExpression expr, com.sun.tools.javac.tree.JCTree clazz) {
    ...
    public JCWildcard Wildcard(TypeBoundKind kind, com.sun.tools.javac.tree.JCTree type) {
    ...
    public JCAnnotation Annotation(com.sun.tools.javac.tree.JCTree annotationType, List<JCExpression> args) {
        JCAnnotation tree = new JCAnnotation(Tag.ANNOTATION, annotationType, args);
        tree.pos = pos;
        return tree;
    }

    public JCAnnotation TypeAnnotation(com.sun.tools.javac.tree.JCTree annotationType, List<JCExpression> args) {
    ...
    public JCErroneous Erroneous() {
        return Erroneous(List.<com.sun.tools.javac.tree.JCTree>nil());
    }

    public JCErroneous Erroneous(List<? extends com.sun.tools.javac.tree.JCTree> errs) {
        JCErroneous tree = new JCErroneous(errs);
        tree.pos = pos;
        return tree;
    }

    public LetExpr LetExpr(List<JCVariableDecl> defs, com.sun.tools.javac.tree.JCTree expr) {
