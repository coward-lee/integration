...
public class DocTreeMaker {
    ...
    public DCAttribute Attribute(Name name, ValueKind vkind, List<com.sun.tools.javac.tree.DCTree> value) {
        DCAttribute tree = new DCAttribute(name, vkind, value);
        tree.pos = pos;
        return tree;
    }

    public DCAuthor Author(List<com.sun.tools.javac.tree.DCTree> name) {
    ...
    public DCDeprecated Deprecated(List<com.sun.tools.javac.tree.DCTree> text) {
        DCDeprecated tree = new DCDeprecated(text);
        tree.pos = pos;
        return tree;
    }

    public DCDocComment DocComment(Comment comment, List<com.sun.tools.javac.tree.DCTree> firstSentence, List<com.sun.tools.javac.tree.DCTree> body, List<com.sun.tools.javac.tree.DCTree> tags) {
    ...
    public DCThrows Exception(DCReference name, List<com.sun.tools.javac.tree.DCTree> description) {
    ...
    public DCLink Link(DCReference ref, List<com.sun.tools.javac.tree.DCTree> label) {
        DCLink tree = new DCLink(Kind.LINK, ref, label);
        tree.pos = pos;
        return tree;
    }

    public DCLink LinkPlain(DCReference ref, List<com.sun.tools.javac.tree.DCTree> label) {
    ...
    public DCParam Param(boolean isTypeParameter, DCIdentifier name, List<com.sun.tools.javac.tree.DCTree> description) {
    ...
    public DCReference Reference(String signature,
                                 com.sun.tools.javac.tree.JCTree qualExpr, Name member, List<JCTree> paramTypes) {
        DCReference tree = new DCReference(signature, qualExpr, member, paramTypes);
        tree.pos = pos;
        return tree;
    }

    public DCReturn Return(List<com.sun.tools.javac.tree.DCTree> description) {
        DCReturn tree = new DCReturn(description);
        tree.pos = pos;
        return tree;
    }

    public DCSee See(List<com.sun.tools.javac.tree.DCTree> reference) {
        DCSee tree = new DCSee(reference);
        tree.pos = pos;
        return tree;
    }

    public DCSerial Serial(List<com.sun.tools.javac.tree.DCTree> description) {
        DCSerial tree = new DCSerial(description);
        tree.pos = pos;
        return tree;
    }

    public DCSerialData SerialData(List<com.sun.tools.javac.tree.DCTree> description) {
        DCSerialData tree = new DCSerialData(description);
        tree.pos = pos;
        return tree;
    }

    public DCSerialField SerialField(DCIdentifier name, DCReference type, List<com.sun.tools.javac.tree.DCTree> description) {
        DCSerialField tree = new DCSerialField(name, type, description);
        tree.pos = pos;
        return tree;
    }

    public DCSince Since(List<com.sun.tools.javac.tree.DCTree> text) {
        DCSince tree = new DCSince(text);
        tree.pos = pos;
        return tree;
    }

    public DCStartElement StartElement(Name name, List<com.sun.tools.javac.tree.DCTree> attrs, boolean selfClosing) {
    ...
    public DCThrows Throws(DCReference name, List<com.sun.tools.javac.tree.DCTree> description) {
        DCThrows tree = new DCThrows(Kind.THROWS, name, description);
        tree.pos = pos;
        return tree;
    }

    public DCUnknownBlockTag UnknownBlockTag(Name name, List<com.sun.tools.javac.tree.DCTree> content) {
        DCUnknownBlockTag tree = new DCUnknownBlockTag(name, content);
        tree.pos = pos;
        return tree;
    }

    public DCUnknownInlineTag UnknownInlineTag(Name name, List<com.sun.tools.javac.tree.DCTree> content) {
