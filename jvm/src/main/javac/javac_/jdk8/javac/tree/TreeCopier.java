 ...
 */
public class TreeCopier<P> implements TreeVisitor<com.sun.tools.javac.tree.JCTree,P> {
    ...
    public <T extends com.sun.tools.javac.tree.JCTree> T copy(T tree) {
        return copy(tree, null);
    }

    @SuppressWarnings("unchecked")
    public <T extends com.sun.tools.javac.tree.JCTree> T copy(T tree, P p) {
        if (tree == null)
            return null;
        return (T) (tree.accept(this, p));
    }

    public <T extends com.sun.tools.javac.tree.JCTree> List<T> copy(List<T> trees) {
        return copy(trees, null);
    }

    public <T extends com.sun.tools.javac.tree.JCTree> List<T> copy(List<T> trees, P p) {
        if (trees == null)
            return null;
    ...
    public com.sun.tools.javac.tree.JCTree visitAnnotatedType(AnnotatedTypeTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitAnnotation(AnnotationTree node, P p) {
        JCAnnotation t = (JCAnnotation) node;
        com.sun.tools.javac.tree.JCTree annotationType = copy(t.annotationType, p);
    ...
    public com.sun.tools.javac.tree.JCTree visitAssert(AssertTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitAssignment(AssignmentTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitCompoundAssignment(CompoundAssignmentTree node, P p) {
        JCAssignOp t = (JCAssignOp) node;
        com.sun.tools.javac.tree.JCTree lhs = copy(t.lhs, p);
        com.sun.tools.javac.tree.JCTree rhs = copy(t.rhs, p);
        return M.at(t.pos).Assignop(t.getTag(), lhs, rhs);
    }

    public com.sun.tools.javac.tree.JCTree visitBinary(BinaryTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitBlock(BlockTree node, P p) {
        JCBlock t = (JCBlock) node;
        List<JCStatement> stats = copy(t.stats, p);
        return M.at(t.pos).Block(t.flags, stats);
    }

    public com.sun.tools.javac.tree.JCTree visitBreak(BreakTree node, P p) {
        JCBreak t = (JCBreak) node;
        return M.at(t.pos).Break(t.label);
    }

    public com.sun.tools.javac.tree.JCTree visitCase(CaseTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitCatch(CatchTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitClass(ClassTree node, P p) {
        ...
        List<com.sun.tools.javac.tree.JCTree> defs = copy(t.defs, p);
        return M.at(t.pos).ClassDef(mods, t.name, typarams, extending, implementing, defs);
    }

    public com.sun.tools.javac.tree.JCTree visitConditionalExpression(ConditionalExpressionTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitContinue(ContinueTree node, P p) {
        JCContinue t = (JCContinue) node;
        return M.at(t.pos).Continue(t.label);
    }

    public com.sun.tools.javac.tree.JCTree visitDoWhileLoop(DoWhileLoopTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitErroneous(ErroneousTree node, P p) {
        JCErroneous t = (JCErroneous) node;
        List<? extends com.sun.tools.javac.tree.JCTree> errs = copy(t.errs, p);
        return M.at(t.pos).Erroneous(errs);
    }

    public com.sun.tools.javac.tree.JCTree visitExpressionStatement(ExpressionStatementTree node, P p) {
        JCExpressionStatement t = (JCExpressionStatement) node;
        JCExpression expr = copy(t.expr, p);
        return M.at(t.pos).Exec(expr);
    }

    public com.sun.tools.javac.tree.JCTree visitEnhancedForLoop(EnhancedForLoopTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitForLoop(ForLoopTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitIdentifier(IdentifierTree node, P p) {
        JCIdent t = (JCIdent) node;
        return M.at(t.pos).Ident(t.name);
    }

    public com.sun.tools.javac.tree.JCTree visitIf(IfTree node, P p) {
        JCIf t = (JCIf) node;
        JCExpression cond = copy(t.cond, p);
    ...
    public com.sun.tools.javac.tree.JCTree visitImport(ImportTree node, P p) {
        JCImport t = (JCImport) node;
        com.sun.tools.javac.tree.JCTree qualid = copy(t.qualid, p);
        return M.at(t.pos).Import(qualid, t.staticImport);
    }

    public com.sun.tools.javac.tree.JCTree visitArrayAccess(ArrayAccessTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitLabeledStatement(LabeledStatementTree node, P p) {
        JCLabeledStatement t = (JCLabeledStatement) node;
        JCStatement body = copy(t.body, p);
        return M.at(t.pos).Labelled(t.label, body);
    }

    public com.sun.tools.javac.tree.JCTree visitLiteral(LiteralTree node, P p) {
        JCLiteral t = (JCLiteral) node;
        return M.at(t.pos).Literal(t.typetag, t.value);
    }

    public com.sun.tools.javac.tree.JCTree visitMethod(MethodTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitMethodInvocation(MethodInvocationTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitModifiers(ModifiersTree node, P p) {
        JCModifiers t = (JCModifiers) node;
        List<JCAnnotation> annotations = copy(t.annotations, p);
        return M.at(t.pos).Modifiers(t.flags, annotations);
    }

    public com.sun.tools.javac.tree.JCTree visitNewArray(NewArrayTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitNewClass(NewClassTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitLambdaExpression(LambdaExpressionTree node, P p) {
        JCLambda t = (JCLambda) node;
        List<JCVariableDecl> params = copy(t.params, p);
        com.sun.tools.javac.tree.JCTree body = copy(t.body, p);
        return M.at(t.pos).Lambda(params, body);
    }

    public com.sun.tools.javac.tree.JCTree visitParenthesized(ParenthesizedTree node, P p) {
        JCParens t = (JCParens) node;
        JCExpression expr = copy(t.expr, p);
        return M.at(t.pos).Parens(expr);
    }

    public com.sun.tools.javac.tree.JCTree visitReturn(ReturnTree node, P p) {
        JCReturn t = (JCReturn) node;
        JCExpression expr = copy(t.expr, p);
        return M.at(t.pos).Return(expr);
    }

    public com.sun.tools.javac.tree.JCTree visitMemberSelect(MemberSelectTree node, P p) {
        JCFieldAccess t = (JCFieldAccess) node;
        JCExpression selected = copy(t.selected, p);
        return M.at(t.pos).Select(selected, t.name);
    }

    public com.sun.tools.javac.tree.JCTree visitMemberReference(MemberReferenceTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitEmptyStatement(EmptyStatementTree node, P p) {
        JCSkip t = (JCSkip) node;
        return M.at(t.pos).Skip();
    }

    public com.sun.tools.javac.tree.JCTree visitSwitch(SwitchTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitSynchronized(SynchronizedTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitThrow(ThrowTree node, P p) {
        JCThrow t = (JCThrow) node;
        JCExpression expr = copy(t.expr, p);
        return M.at(t.pos).Throw(expr);
    }

    public com.sun.tools.javac.tree.JCTree visitCompilationUnit(CompilationUnitTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitTry(TryTree node, P p) {
        JCTry t = (JCTry) node;
        List<com.sun.tools.javac.tree.JCTree> resources = copy(t.resources, p);
        JCBlock body = copy(t.body, p);
    ...
    public com.sun.tools.javac.tree.JCTree visitParameterizedType(ParameterizedTypeTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitUnionType(UnionTypeTree node, P p) {
        JCTypeUnion t = (JCTypeUnion) node;
        List<JCExpression> components = copy(t.alternatives, p);
        return M.at(t.pos).TypeUnion(components);
    }

    public com.sun.tools.javac.tree.JCTree visitIntersectionType(IntersectionTypeTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitArrayType(ArrayTypeTree node, P p) {
        JCArrayTypeTree t = (JCArrayTypeTree) node;
        JCExpression elemtype = copy(t.elemtype, p);
        return M.at(t.pos).TypeArray(elemtype);
    }

    public com.sun.tools.javac.tree.JCTree visitTypeCast(TypeCastTree node, P p) {
        JCTypeCast t = (JCTypeCast) node;
        com.sun.tools.javac.tree.JCTree clazz = copy(t.clazz, p);
        JCExpression expr = copy(t.expr, p);
        return M.at(t.pos).TypeCast(clazz, expr);
    }

    public com.sun.tools.javac.tree.JCTree visitPrimitiveType(PrimitiveTypeTree node, P p) {
        JCPrimitiveTypeTree t = (JCPrimitiveTypeTree) node;
        return M.at(t.pos).TypeIdent(t.typetag);
    }

    public com.sun.tools.javac.tree.JCTree visitTypeParameter(TypeParameterTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitInstanceOf(InstanceOfTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitUnary(UnaryTree node, P p) {
        JCUnary t = (JCUnary) node;
        JCExpression arg = copy(t.arg, p);
        return M.at(t.pos).Unary(t.getTag(), arg);
    }

    public com.sun.tools.javac.tree.JCTree visitVariable(VariableTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitWhileLoop(WhileLoopTree node, P p) {
    ...
    public com.sun.tools.javac.tree.JCTree visitWildcard(WildcardTree node, P p) {
        JCWildcard t = (JCWildcard) node;
        TypeBoundKind kind = M.at(t.kind.pos).TypeBoundKind(t.kind.kind);
        com.sun.tools.javac.tree.JCTree inner = copy(t.inner, p);
        return M.at(t.pos).Wildcard(kind, inner);
    }

    public com.sun.tools.javac.tree.JCTree visitOther(Tree node, P p) {
        com.sun.tools.javac.tree.JCTree tree = (com.sun.tools.javac.tree.JCTree) node;
        switch (tree.getTag()) {
            case LETEXPR: {
