 ...
 */
public class Pretty extends com.sun.tools.javac.tree.JCTree.Visitor {
    ...
    public static String toSimpleString(com.sun.tools.javac.tree.JCTree tree) {
        return toSimpleString(tree, PREFERRED_LENGTH);
    }

    public static String toSimpleString(com.sun.tools.javac.tree.JCTree tree, int maxLength) {
     ...
     */
    public void printExpr(com.sun.tools.javac.tree.JCTree tree, int prec) throws IOException {
     ...
     *  for expression.
     */
    public void printExpr(com.sun.tools.javac.tree.JCTree tree) throws IOException {
        printExpr(tree, TreeInfo.noPrec);
    }

    /** Derived visitor method: print statement tree.
     */
    public void printStat(com.sun.tools.javac.tree.JCTree tree) throws IOException {
     ...
     */
    public <T extends com.sun.tools.javac.tree.JCTree> void printExprs(List<T> trees, String sep) throws IOException {
        if (trees.nonEmpty()) {
     ...
     */
    public <T extends com.sun.tools.javac.tree.JCTree> void printExprs(List<T> trees) throws IOException {
        printExprs(trees, ", ");
    }

    /** Derived visitor method: print list of statements, each on a separate line.
     */
    public void printStats(List<? extends com.sun.tools.javac.tree.JCTree> trees) throws IOException {
     ...
     */
    public void printDocComment(com.sun.tools.javac.tree.JCTree tree) throws IOException {
        if (docComments != null) {
...
//where
    ...
    /** Print a block.
     */
    public void printBlock(List<? extends com.sun.tools.javac.tree.JCTree> stats) throws IOException {
        print("{");
        println();
        indent();
        printStats(stats);
    ...
    /** Print a block.
     */
    public void printEnumBody(List<com.sun.tools.javac.tree.JCTree> stats) throws IOException {
        print("{");
        println();
        indent();
        boolean first = true;
        for (List<com.sun.tools.javac.tree.JCTree> l = stats; l.nonEmpty(); l = l.tail) {
    ...
    boolean isEnumerator(com.sun.tools.javac.tree.JCTree t) {
    ...
    public void printUnit(JCCompilationUnit tree, JCClassDecl cdef) throws IOException {
        ...
        for (List<com.sun.tools.javac.tree.JCTree> l = tree.defs;
    ...
    // where
    boolean isUsed(final Symbol t, com.sun.tools.javac.tree.JCTree cdef) {
        ...
        try {
            ...
            if ((tree.mods.flags & ENUM) != 0) {
                ...
                if ((tree.mods.flags & VARARGS) != 0) {
                    com.sun.tools.javac.tree.JCTree vartype = tree.vartype;
    ...
    public void visitTry(JCTry tree) {
        try {
            ...
            if (tree.resources.nonEmpty()) {
                print("(");
                boolean first = true;
                for (com.sun.tools.javac.tree.JCTree var : tree.resources) {
                    if (!first) {
                        println();
                        indent();
                    }
    ...
    public void visitNewArray(JCNewArray tree) {
        try {
            if (tree.elemtype != null) {
                print("new ");
                com.sun.tools.javac.tree.JCTree elem = tree.elemtype;
    ...
    public String operatorName(com.sun.tools.javac.tree.JCTree.Tag tag) {
        switch(tag) {
            case POS:     return "+";
            case NEG:     return "-";
            case NOT:     return "!";
    ...
    private void printBaseElementType(com.sun.tools.javac.tree.JCTree tree) throws IOException {
        printExpr(TreeInfo.innermostType(tree));
    }

    // prints the brackets of a nested array in reverse order
    // tree is either JCArrayTypeTree or JCAnnotatedTypeTree
    private void printBrackets(com.sun.tools.javac.tree.JCTree tree) throws IOException {
        com.sun.tools.javac.tree.JCTree elem = tree;
        while (true) {
