...
public class TreeInfo {
    ...
    public static List<JCExpression> args(com.sun.tools.javac.tree.JCTree t) {
        switch (t.getTag()) {
            case APPLY:
     ...
     */
    public Name operatorName(com.sun.tools.javac.tree.JCTree.Tag tag) {
        return opname[tag.operatorIndex()];
    }

    /** Is tree a constructor declaration?
     */
    public static boolean isConstructor(com.sun.tools.javac.tree.JCTree tree) {
    ...
    public static boolean isReceiverParam(com.sun.tools.javac.tree.JCTree tree) {
     ...
     */
    public static boolean hasConstructors(List<com.sun.tools.javac.tree.JCTree> trees) {
        for (List<com.sun.tools.javac.tree.JCTree> l = trees; l.nonEmpty(); l = l.tail)
     ...
     */
    public static boolean isSyntheticInit(com.sun.tools.javac.tree.JCTree stat) {
        if (stat.hasTag(EXEC)) {
     ...
     *  otherwise. */
    public static Name calledMethodName(com.sun.tools.javac.tree.JCTree tree) {
        if (tree.hasTag(EXEC)) {
     ...
     */
    public static boolean isSelfCall(com.sun.tools.javac.tree.JCTree tree) {
     ...
     */
    public static boolean isSuperCall(com.sun.tools.javac.tree.JCTree tree) {
        Name name = calledMethodName(tree);
        if (name != null) {
            Names names = name.table.names;
     ...
     *  of the form this(...)?
     */
    public static boolean isInitialConstructor(com.sun.tools.javac.tree.JCTree tree) {
    ...
    public static JCMethodInvocation firstConstructorCall(com.sun.tools.javac.tree.JCTree tree) {
    ...
    public static boolean isDiamond(com.sun.tools.javac.tree.JCTree tree) {
        switch(tree.getTag()) {
    ...
    public static boolean isEnumInit(com.sun.tools.javac.tree.JCTree tree) {
        switch (tree.getTag()) {
            case VARDEF:
    ...
    public static void setPolyKind(com.sun.tools.javac.tree.JCTree tree, PolyKind pkind) {
        switch (tree.getTag()) {
            case APPLY:
    ...
    public static void setVarargsElement(com.sun.tools.javac.tree.JCTree tree, Type varargsElement) {
        switch (tree.getTag()) {
            case APPLY:
     ...
     */
    public static boolean isStaticSelector(com.sun.tools.javac.tree.JCTree base, Names names) {
        if (base == null)
            return false;
        switch (base.getTag()) {
            case IDENT:
    ...
    //where
        private static boolean isStaticSym(com.sun.tools.javac.tree.JCTree tree) {
    ...
    public static boolean isNull(com.sun.tools.javac.tree.JCTree tree) {
    ...
    public static boolean isInAnnotation(Env<?> env, com.sun.tools.javac.tree.JCTree tree) {
    ...
    public static String getCommentText(Env<?> env, com.sun.tools.javac.tree.JCTree tree) {
        DocCommentTable docComments = (tree.hasTag(com.sun.tools.javac.tree.JCTree.Tag.TOPLEVEL))
                ? ((JCCompilationUnit) tree).docComments
                : env.toplevel.docComments;
        return (docComments == null) ? null : docComments.getCommentText(tree);
    }

    public static DCTree.DCDocComment getCommentTree(Env<?> env, com.sun.tools.javac.tree.JCTree tree) {
        DocCommentTable docComments = (tree.hasTag(com.sun.tools.javac.tree.JCTree.Tag.TOPLEVEL))
                ? ((JCCompilationUnit) tree).docComments
                : env.toplevel.docComments;
     ...
     */
    public static int firstStatPos(com.sun.tools.javac.tree.JCTree tree) {
     ...
     *  defined endpos.
     */
    public static int endPos(com.sun.tools.javac.tree.JCTree tree) {
     ...
     */
    public static int getStartPos(com.sun.tools.javac.tree.JCTree tree) {
        if (tree == null)
     ...
     */
    public static int getEndPos(com.sun.tools.javac.tree.JCTree tree, EndPosTable endPosTable) {
        if (tree == null)
            return Position.NOPOS;
     ...
     *  defined endpos.
     */
    public static DiagnosticPosition diagEndPos(final com.sun.tools.javac.tree.JCTree tree) {
        final int endPos = TreeInfo.endPos(tree);
        return new DiagnosticPosition() {
            public com.sun.tools.javac.tree.JCTree getTree() { return tree; }
     ...
     */
    public static int finalizerPos(com.sun.tools.javac.tree.JCTree tree) {
        if (tree.hasTag(TRY)) {
            JCTry t = (JCTry) tree;
    ...
    public static int positionFor(final Symbol sym, final com.sun.tools.javac.tree.JCTree tree) {
        com.sun.tools.javac.tree.JCTree decl = declarationFor(sym, tree);
        return ((decl != null) ? decl : tree).pos;
    }

    /** Find the position for reporting an error about a symbol, where
     *  that symbol is defined somewhere in the given tree. */
    public static DiagnosticPosition diagnosticPositionFor(final Symbol sym, final com.sun.tools.javac.tree.JCTree tree) {
        com.sun.tools.javac.tree.JCTree decl = declarationFor(sym, tree);
        return ((decl != null) ? decl : tree).pos();
    }
     ...
     *  that symbol is defined somewhere in the given tree. */
    public static com.sun.tools.javac.tree.JCTree declarationFor(final Symbol sym, final com.sun.tools.javac.tree.JCTree tree) {
        class DeclScanner extends TreeScanner {
            com.sun.tools.javac.tree.JCTree result = null;
    ...
    public static Env<AttrContext> scopeFor(com.sun.tools.javac.tree.JCTree node, JCCompilationUnit unit) {
        return scopeFor(pathFor(node, unit));
    }

    public static Env<AttrContext> scopeFor(List<com.sun.tools.javac.tree.JCTree> path) {
        // TODO: not implemented yet
        throw new UnsupportedOperationException("not implemented yet");
    }

    public static List<com.sun.tools.javac.tree.JCTree> pathFor(final com.sun.tools.javac.tree.JCTree node, final JCCompilationUnit unit) {
        class Result extends Error {
            static final long serialVersionUID = -5942088234594905625L;
            List<com.sun.tools.javac.tree.JCTree> path;
            Result(List<com.sun.tools.javac.tree.JCTree> path) {
                this.path = path;
            }
        }
        class PathFinder extends TreeScanner {
            List<com.sun.tools.javac.tree.JCTree> path = List.nil();
            public void scan(com.sun.tools.javac.tree.JCTree tree) {
                if (tree != null) {
     ...
     */
    public static com.sun.tools.javac.tree.JCTree referencedStatement(JCLabeledStatement tree) {
        com.sun.tools.javac.tree.JCTree t = tree;
    ...
    /** Skip parens and return the enclosed expression
     */
    public static com.sun.tools.javac.tree.JCTree skipParens(com.sun.tools.javac.tree.JCTree tree) {
     ...
     */
    public static List<Type> types(List<? extends com.sun.tools.javac.tree.JCTree> trees) {
        ListBuffer<Type> ts = new ListBuffer<Type>();
        for (List<? extends com.sun.tools.javac.tree.JCTree> l = trees; l.nonEmpty(); l = l.tail)
     ...
     */
    public static Name name(com.sun.tools.javac.tree.JCTree tree) {
        switch (tree.getTag()) {
        case IDENT:
     ...
     */
    public static Name fullName(com.sun.tools.javac.tree.JCTree tree) {
    ...
    public static Symbol symbolFor(com.sun.tools.javac.tree.JCTree node) {
        Symbol sym = symbolForImpl(node);

        return sym != null ? sym.baseSymbol() : null;
    }

    private static Symbol symbolForImpl(com.sun.tools.javac.tree.JCTree node) {
    ...
    public static boolean isDeclaration(com.sun.tools.javac.tree.JCTree node) {
        node = skipParens(node);
        switch (node.getTag()) {
        case CLASSDEF:
        case METHODDEF:
     ...
     *  otherwise return null.
     */
    public static Symbol symbol(com.sun.tools.javac.tree.JCTree tree) {
        tree = skipParens(tree);
        switch (tree.getTag()) {
        case IDENT:
    ...
    public static boolean nonstaticSelect(com.sun.tools.javac.tree.JCTree tree) {
        tree = skipParens(tree);
     ...
     */
    public static void setSymbol(com.sun.tools.javac.tree.JCTree tree, Symbol sym) {
        tree = skipParens(tree);
        switch (tree.getTag()) {
        case IDENT:
     ...
     *  otherwise return 0.
     */
    public static long flags(com.sun.tools.javac.tree.JCTree tree) {
        switch (tree.getTag()) {
        case VARDEF:
     ...
     */
    public static int opPrec(com.sun.tools.javac.tree.JCTree.Tag op) {
        switch(op) {
        case POS:
        case NEG:
        case NOT:
    ...
    static Tree.Kind tagToKind(com.sun.tools.javac.tree.JCTree.Tag tag) {
        switch (tag) {
        // Postfix expressions
        case POSTINC:           // _ ++
     ...
     */
    public static com.sun.tools.javac.tree.JCTree innermostType(com.sun.tools.javac.tree.JCTree type) {
        com.sun.tools.javac.tree.JCTree lastAnnotatedType = null;
        com.sun.tools.javac.tree.JCTree cur = type;
        loop: while (true) {
            switch (cur.getTag()) {
            case TYPEARRAY:
