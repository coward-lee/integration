...
package javac_.jdk8.javac.tree;
...
public abstract class JCTree implements Tree, Cloneable, DiagnosticPosition {
    ...
    /**
     * Everything in one source file is kept in a {@linkplain com.sun.tools.javac.tree.JCTree.JCCompilationUnit} structure.
     */
    public static class JCCompilationUnit extends JCTree implements CompilationUnitTree {
        public List<com.sun.tools.javac.tree.JCTree.JCAnnotation> packageAnnotations;
        ...
        protected JCCompilationUnit(List<com.sun.tools.javac.tree.JCTree.JCAnnotation> packageAnnotations,
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitTopLevel(this); }

        public Kind getKind() { return Kind.COMPILATION_UNIT; }
        public List<com.sun.tools.javac.tree.JCTree.JCAnnotation> getPackageAnnotations() {
            return packageAnnotations;
        }
        public List<com.sun.tools.javac.tree.JCTree.JCImport> getImports() {
            ListBuffer<com.sun.tools.javac.tree.JCTree.JCImport> imports = new ListBuffer<com.sun.tools.javac.tree.JCTree.JCImport>();
            for (JCTree tree : defs) {
                if (tree.hasTag(IMPORT))
                    imports.append((com.sun.tools.javac.tree.JCTree.JCImport)tree);
                else if (!tree.hasTag(SKIP))
                    break;
            }
            return imports.toList();
        }
        public com.sun.tools.javac.tree.JCTree.JCExpression getPackageName() { return pid; }
    ...
    public static class JCImport extends JCTree implements ImportTree {
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitImport(this); }
    ...
    public static abstract class JCStatement extends JCTree implements StatementTree {
        @Override
        public com.sun.tools.javac.tree.JCTree.JCStatement setType(Type type) {
            super.setType(type);
            return this;
        }
        @Override
        public com.sun.tools.javac.tree.JCTree.JCStatement setPos(int pos) {
            super.setPos(pos);
            return this;
        }
    }
    ...
    public static abstract class JCExpression extends JCTree implements ExpressionTree {
        @Override
        public com.sun.tools.javac.tree.JCTree.JCExpression setType(Type type) {
            super.setType(type);
            return this;
        }
        @Override
        public com.sun.tools.javac.tree.JCTree.JCExpression setPos(int pos) {
            super.setPos(pos);
            return this;
        }
    ...
    public static abstract class JCFunctionalExpression extends JCPolyExpression {
        ...
        public JCFunctionalExpression() {
            ...
            polyKind = com.sun.tools.javac.tree.JCTree.JCPolyExpression.PolyKind.POLY;
        }
    ...
    public static class JCClassDecl extends JCStatement implements ClassTree {
        ...
        public List<com.sun.tools.javac.tree.JCTree.JCTypeParameter> typarams;
        /** the classes this class extends */
        public com.sun.tools.javac.tree.JCTree.JCExpression extending;
        /** the interfaces implemented by this class */
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> implementing;
        /** all variables and methods defined in this class */
        public List<JCTree> defs;
        /** the symbol */
        public ClassSymbol sym;
        protected JCClassDecl(com.sun.tools.javac.tree.JCTree.JCModifiers mods,
                              Name name,
                              List<com.sun.tools.javac.tree.JCTree.JCTypeParameter> typarams,
                              com.sun.tools.javac.tree.JCTree.JCExpression extending,
                              List<com.sun.tools.javac.tree.JCTree.JCExpression> implementing,
                              List<JCTree> defs,
                              ClassSymbol sym)
        {
            this.mods = mods;
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitClassDef(this); }
        ...
        public com.sun.tools.javac.tree.JCTree.JCModifiers getModifiers() { return mods; }
        public Name getSimpleName() { return name; }
        public List<com.sun.tools.javac.tree.JCTree.JCTypeParameter> getTypeParameters() {
            return typarams;
        }
        public com.sun.tools.javac.tree.JCTree.JCExpression getExtendsClause() { return extending; }
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> getImplementsClause() {
            return implementing;
        }
    ...
    public static class JCMethodDecl extends JCTree implements MethodTree {
        ...
        /** value parameters */
        public List<com.sun.tools.javac.tree.JCTree.JCVariableDecl> params;
        /** exceptions thrown by this method */
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> thrown;
        ...
        protected JCMethodDecl(com.sun.tools.javac.tree.JCTree.JCModifiers mods,
                               Name name,
                               com.sun.tools.javac.tree.JCTree.JCExpression restype,
                               List<com.sun.tools.javac.tree.JCTree.JCTypeParameter> typarams,
                               com.sun.tools.javac.tree.JCTree.JCVariableDecl recvparam,
                               List<com.sun.tools.javac.tree.JCTree.JCVariableDecl> params,
                               List<com.sun.tools.javac.tree.JCTree.JCExpression> thrown,
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitMethodDef(this); }
        ...
        public List<com.sun.tools.javac.tree.JCTree.JCVariableDecl> getParameters() {
            return params;
        }
        public com.sun.tools.javac.tree.JCTree.JCVariableDecl getReceiverParameter() { return recvparam; }
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> getThrows() {
            return thrown;
        }
        public com.sun.tools.javac.tree.JCTree.JCBlock getBody() { return body; }
    ...
    public static class JCVariableDecl extends JCStatement implements VariableTree {
        ...
        protected JCVariableDecl(com.sun.tools.javac.tree.JCTree.JCModifiers mods,
                                 Name name,
        ...
        protected JCVariableDecl(com.sun.tools.javac.tree.JCTree.JCModifiers mods,
            ...
            if (nameexpr.hasTag(com.sun.tools.javac.tree.JCTree.Tag.IDENT)) {
                this.name = ((com.sun.tools.javac.tree.JCTree.JCIdent)nameexpr).name;
            } else {
                // Only other option is qualified name x.y.this;
                this.name = ((com.sun.tools.javac.tree.JCTree.JCFieldAccess)nameexpr).name;
            }
        }

        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitVarDef(this); }

        public Kind getKind() { return Kind.VARIABLE; }
        public com.sun.tools.javac.tree.JCTree.JCModifiers getModifiers() { return mods; }
        public Name getName() { return name; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getNameExpression() { return nameexpr; }
    ...
    public static class JCSkip extends JCStatement implements EmptyStatementTree {
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitSkip(this); }
    ...
    public static class JCBlock extends JCStatement implements BlockTree {
        ...
        public long flags;
        /** statements */
        public List<com.sun.tools.javac.tree.JCTree.JCStatement> stats;
        /** Position of closing brace, optional. */
        public int endpos = Position.NOPOS;
        protected JCBlock(long flags, List<com.sun.tools.javac.tree.JCTree.JCStatement> stats) {
            this.stats = stats;
            this.flags = flags;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitBlock(this); }

        public Kind getKind() { return Kind.BLOCK; }
        public List<com.sun.tools.javac.tree.JCTree.JCStatement> getStatements() {
            return stats;
        }
    ...
    public static class JCDoWhileLoop extends JCStatement implements DoWhileLoopTree {
        ...
        protected JCDoWhileLoop(com.sun.tools.javac.tree.JCTree.JCStatement body, com.sun.tools.javac.tree.JCTree.JCExpression cond) {
            this.body = body;
            this.cond = cond;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitDoLoop(this); }

        public Kind getKind() { return Kind.DO_WHILE_LOOP; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getCondition() { return cond; }
        public com.sun.tools.javac.tree.JCTree.JCStatement getStatement() { return body; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCWhileLoop extends JCStatement implements WhileLoopTree {
        public com.sun.tools.javac.tree.JCTree.JCExpression cond;
        public com.sun.tools.javac.tree.JCTree.JCStatement body;
        protected JCWhileLoop(com.sun.tools.javac.tree.JCTree.JCExpression cond, com.sun.tools.javac.tree.JCTree.JCStatement body) {
            this.cond = cond;
            this.body = body;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitWhileLoop(this); }
    ...
    public static class JCForLoop extends JCStatement implements ForLoopTree {
        public List<com.sun.tools.javac.tree.JCTree.JCStatement> init;
        public com.sun.tools.javac.tree.JCTree.JCExpression cond;
        public List<com.sun.tools.javac.tree.JCTree.JCExpressionStatement> step;
        public com.sun.tools.javac.tree.JCTree.JCStatement body;
        protected JCForLoop(List<com.sun.tools.javac.tree.JCTree.JCStatement> init,
                          com.sun.tools.javac.tree.JCTree.JCExpression cond,
                          List<com.sun.tools.javac.tree.JCTree.JCExpressionStatement> update,
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitForLoop(this); }

        public Kind getKind() { return Kind.FOR_LOOP; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getCondition() { return cond; }
        public com.sun.tools.javac.tree.JCTree.JCStatement getStatement() { return body; }
        public List<com.sun.tools.javac.tree.JCTree.JCStatement> getInitializer() {
            return init;
        }
        public List<com.sun.tools.javac.tree.JCTree.JCExpressionStatement> getUpdate() {
            return step;
        }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCEnhancedForLoop extends JCStatement implements EnhancedForLoopTree {
        ...
        public com.sun.tools.javac.tree.JCTree.JCStatement body;
        protected JCEnhancedForLoop(com.sun.tools.javac.tree.JCTree.JCVariableDecl var, com.sun.tools.javac.tree.JCTree.JCExpression expr, com.sun.tools.javac.tree.JCTree.JCStatement body) {
            this.var = var;
            this.expr = expr;
            this.body = body;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitForeachLoop(this); }

        public Kind getKind() { return Kind.ENHANCED_FOR_LOOP; }
        public com.sun.tools.javac.tree.JCTree.JCVariableDecl getVariable() { return var; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getExpression() { return expr; }
        public com.sun.tools.javac.tree.JCTree.JCStatement getStatement() { return body; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCLabeledStatement extends JCStatement implements LabeledStatementTree {
        public Name label;
        public com.sun.tools.javac.tree.JCTree.JCStatement body;
        protected JCLabeledStatement(Name label, com.sun.tools.javac.tree.JCTree.JCStatement body) {
            this.label = label;
            this.body = body;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitLabelled(this); }
    ...
    public static class JCSwitch extends JCStatement implements SwitchTree {
        ...
        public List<com.sun.tools.javac.tree.JCTree.JCCase> cases;
        protected JCSwitch(com.sun.tools.javac.tree.JCTree.JCExpression selector, List<com.sun.tools.javac.tree.JCTree.JCCase> cases) {
            this.selector = selector;
            this.cases = cases;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitSwitch(this); }

        public Kind getKind() { return Kind.SWITCH; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getExpression() { return selector; }
        public List<com.sun.tools.javac.tree.JCTree.JCCase> getCases() { return cases; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCCase extends JCStatement implements CaseTree {
        ...
        public List<com.sun.tools.javac.tree.JCTree.JCStatement> stats;
        protected JCCase(com.sun.tools.javac.tree.JCTree.JCExpression pat, List<com.sun.tools.javac.tree.JCTree.JCStatement> stats) {
            this.pat = pat;
            this.stats = stats;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitCase(this); }

        public Kind getKind() { return Kind.CASE; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getExpression() { return pat; }
        public List<com.sun.tools.javac.tree.JCTree.JCStatement> getStatements() { return stats; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCSynchronized extends JCStatement implements SynchronizedTree {
        ...
        public com.sun.tools.javac.tree.JCTree.JCBlock body;
        protected JCSynchronized(com.sun.tools.javac.tree.JCTree.JCExpression lock, com.sun.tools.javac.tree.JCTree.JCBlock body) {
            this.lock = lock;
            this.body = body;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitSynchronized(this); }

        public Kind getKind() { return Kind.SYNCHRONIZED; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getExpression() { return lock; }
        public com.sun.tools.javac.tree.JCTree.JCBlock getBlock() { return body; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCTry extends JCStatement implements TryTree {
        public com.sun.tools.javac.tree.JCTree.JCBlock body;
        public List<com.sun.tools.javac.tree.JCTree.JCCatch> catchers;
        ...
        protected JCTry(List<JCTree> resources,
                        com.sun.tools.javac.tree.JCTree.JCBlock body,
                        List<com.sun.tools.javac.tree.JCTree.JCCatch> catchers,
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitTry(this); }

        public Kind getKind() { return Kind.TRY; }
        public com.sun.tools.javac.tree.JCTree.JCBlock getBlock() { return body; }
        public List<com.sun.tools.javac.tree.JCTree.JCCatch> getCatches() {
            return catchers;
        }
        public com.sun.tools.javac.tree.JCTree.JCBlock getFinallyBlock() { return finalizer; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCCatch extends JCTree implements CatchTree {
        ...
        public com.sun.tools.javac.tree.JCTree.JCBlock body;
        protected JCCatch(com.sun.tools.javac.tree.JCTree.JCVariableDecl param, com.sun.tools.javac.tree.JCTree.JCBlock body) {
            this.param = param;
            this.body = body;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitCatch(this); }

        public Kind getKind() { return Kind.CATCH; }
        public com.sun.tools.javac.tree.JCTree.JCVariableDecl getParameter() { return param; }
        public com.sun.tools.javac.tree.JCTree.JCBlock getBlock() { return body; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCConditional extends JCPolyExpression implements ConditionalExpressionTree {
        ...
        protected JCConditional(com.sun.tools.javac.tree.JCTree.JCExpression cond,
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitConditional(this); }

        public Kind getKind() { return Kind.CONDITIONAL_EXPRESSION; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getCondition() { return cond; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getTrueExpression() { return truepart; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getFalseExpression() { return falsepart; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCIf extends JCStatement implements IfTree {
        ...
        protected JCIf(com.sun.tools.javac.tree.JCTree.JCExpression cond,
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitIf(this); }

        public Kind getKind() { return Kind.IF; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getCondition() { return cond; }
        public com.sun.tools.javac.tree.JCTree.JCStatement getThenStatement() { return thenpart; }
        public com.sun.tools.javac.tree.JCTree.JCStatement getElseStatement() { return elsepart; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCExpressionStatement extends JCStatement implements ExpressionStatementTree {
        ...
        public com.sun.tools.javac.tree.JCTree.JCExpression expr;
        protected JCExpressionStatement(com.sun.tools.javac.tree.JCTree.JCExpression expr)
        {
            this.expr = expr;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitExec(this); }
    ...
    public static class JCBreak extends JCStatement implements BreakTree {
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitBreak(this); }
    ...
    public static class JCContinue extends JCStatement implements ContinueTree {
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitContinue(this); }
    ...
    public static class JCReturn extends JCStatement implements ReturnTree {
        public com.sun.tools.javac.tree.JCTree.JCExpression expr;
        protected JCReturn(com.sun.tools.javac.tree.JCTree.JCExpression expr) {
            this.expr = expr;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitReturn(this); }
    ...
    public static class JCThrow extends JCStatement implements ThrowTree {
        public com.sun.tools.javac.tree.JCTree.JCExpression expr;
        protected JCThrow(com.sun.tools.javac.tree.JCTree.JCExpression expr) {
            this.expr = expr;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitThrow(this); }
    ...
    public static class JCAssert extends JCStatement implements AssertTree {
        ...
        protected JCAssert(com.sun.tools.javac.tree.JCTree.JCExpression cond, com.sun.tools.javac.tree.JCTree.JCExpression detail) {
            this.cond = cond;
            this.detail = detail;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitAssert(this); }

        public Kind getKind() { return Kind.ASSERT; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getCondition() { return cond; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getDetail() { return detail; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCMethodInvocation extends JCPolyExpression implements MethodInvocationTree {
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> typeargs;
        public com.sun.tools.javac.tree.JCTree.JCExpression meth;
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> args;
        public Type varargsElement;
        protected JCMethodInvocation(List<com.sun.tools.javac.tree.JCTree.JCExpression> typeargs,
                        com.sun.tools.javac.tree.JCTree.JCExpression meth,
                        List<com.sun.tools.javac.tree.JCTree.JCExpression> args)
        {
            this.typeargs = (typeargs == null) ? List.<com.sun.tools.javac.tree.JCTree.JCExpression>nil()
                                               : typeargs;
            this.meth = meth;
            this.args = args;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitApply(this); }

        public Kind getKind() { return Kind.METHOD_INVOCATION; }
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> getTypeArguments() {
            return typeargs;
        }
        public com.sun.tools.javac.tree.JCTree.JCExpression getMethodSelect() { return meth; }
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> getArguments() {
            return args;
        }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
        ...
        @Override
        public com.sun.tools.javac.tree.JCTree.JCMethodInvocation setType(Type type) {
            super.setType(type);
            return this;
        }
        @Override
    ...
    public static class JCNewClass extends JCPolyExpression implements NewClassTree {
        ...
        protected JCNewClass(com.sun.tools.javac.tree.JCTree.JCExpression encl,
                             List<com.sun.tools.javac.tree.JCTree.JCExpression> typeargs,
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitNewClass(this); }

        public Kind getKind() { return Kind.NEW_CLASS; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getEnclosingExpression() { // expr.new C< ... > ( ... )
            return encl;
        }
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> getTypeArguments() {
            return typeargs;
        }
        public com.sun.tools.javac.tree.JCTree.JCExpression getIdentifier() { return clazz; }
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> getArguments() {
            return args;
        }
        public com.sun.tools.javac.tree.JCTree.JCClassDecl getClassBody() { return def; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCNewArray extends JCExpression implements NewArrayTree {
        ...
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> dims;
        // type annotations on inner-most component
        public List<com.sun.tools.javac.tree.JCTree.JCAnnotation> annotations;
        // type annotations on dimensions
        public List<List<com.sun.tools.javac.tree.JCTree.JCAnnotation>> dimAnnotations;
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> elems;
        protected JCNewArray(com.sun.tools.javac.tree.JCTree.JCExpression elemtype,
                             List<com.sun.tools.javac.tree.JCTree.JCExpression> dims,
                             List<com.sun.tools.javac.tree.JCTree.JCExpression> elems)
        {
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitNewArray(this); }

        public Kind getKind() { return Kind.NEW_ARRAY; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getType() { return elemtype; }
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> getDimensions() {
            return dims;
        }
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> getInitializers() {
            return elems;
        }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
        ...
        @Override
        public List<com.sun.tools.javac.tree.JCTree.JCAnnotation> getAnnotations() {
            return annotations;
        }

        @Override
        public List<List<com.sun.tools.javac.tree.JCTree.JCAnnotation>> getDimAnnotations() {
    ...
    public static class JCLambda extends JCFunctionalExpression implements LambdaExpressionTree {
        ...
        public JCLambda(List<com.sun.tools.javac.tree.JCTree.JCVariableDecl> params,
                        JCTree body) {
            this.params = params;
            this.body = body;
            if (params.isEmpty() ||
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) {
            v.visitLambda(this);
        }
        @Override
        public <R, D> R accept(TreeVisitor<R, D> v, D d) {
        ...
        @Override
        public com.sun.tools.javac.tree.JCTree.JCLambda setType(Type type) {
            super.setType(type);
            return this;
        }
        @Override
    ...
    public static class JCParens extends JCExpression implements ParenthesizedTree {
        public com.sun.tools.javac.tree.JCTree.JCExpression expr;
        protected JCParens(com.sun.tools.javac.tree.JCTree.JCExpression expr) {
            this.expr = expr;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitParens(this); }
    ...
    public static class JCAssign extends JCExpression implements AssignmentTree {
        ...
        protected JCAssign(com.sun.tools.javac.tree.JCTree.JCExpression lhs, com.sun.tools.javac.tree.JCTree.JCExpression rhs) {
            this.lhs = lhs;
            this.rhs = rhs;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitAssign(this); }

        public Kind getKind() { return Kind.ASSIGNMENT; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getVariable() { return lhs; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getExpression() { return rhs; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCAssignOp extends JCExpression implements CompoundAssignmentTree {
        ...
        protected JCAssignOp(com.sun.tools.javac.tree.JCTree.Tag opcode, JCTree lhs, JCTree rhs, Symbol operator) {
            this.opcode = opcode;
            this.lhs = (com.sun.tools.javac.tree.JCTree.JCExpression)lhs;
            this.rhs = (com.sun.tools.javac.tree.JCTree.JCExpression)rhs;
            this.operator = operator;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitAssignop(this); }
    ...
    public static class JCUnary extends JCExpression implements UnaryTree {
        ...
        public Symbol operator;
        protected JCUnary(com.sun.tools.javac.tree.JCTree.Tag opcode, com.sun.tools.javac.tree.JCTree.JCExpression arg) {
            this.opcode = opcode;
            this.arg = arg;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitUnary(this); }

        public Kind getKind() { return TreeInfo.tagToKind(getTag()); }
        public com.sun.tools.javac.tree.JCTree.JCExpression getExpression() { return arg; }
        public Symbol getOperator() {
            return operator;
        }
        @Override
        ...
        public void setTag(com.sun.tools.javac.tree.JCTree.Tag tag) {
            opcode = tag;
        }
    }
    ...
    public static class JCBinary extends JCExpression implements BinaryTree {
        ...
        public com.sun.tools.javac.tree.JCTree.JCExpression rhs;
        public Symbol operator;
        protected JCBinary(com.sun.tools.javac.tree.JCTree.Tag opcode,
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitBinary(this); }

        public Kind getKind() { return TreeInfo.tagToKind(getTag()); }
        public com.sun.tools.javac.tree.JCTree.JCExpression getLeftOperand() { return lhs; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getRightOperand() { return rhs; }
        public Symbol getOperator() {
            return operator;
        }
        @Override
    ...
    public static class JCTypeCast extends JCExpression implements TypeCastTree {
        public JCTree clazz;
        public com.sun.tools.javac.tree.JCTree.JCExpression expr;
        protected JCTypeCast(JCTree clazz, com.sun.tools.javac.tree.JCTree.JCExpression expr) {
            this.clazz = clazz;
            this.expr = expr;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitTypeCast(this); }
    ...
    public static class JCInstanceOf extends JCExpression implements InstanceOfTree {
        public com.sun.tools.javac.tree.JCTree.JCExpression expr;
        public JCTree clazz;
        protected JCInstanceOf(com.sun.tools.javac.tree.JCTree.JCExpression expr, JCTree clazz) {
            this.expr = expr;
            this.clazz = clazz;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitTypeTest(this); }
    ...
    public static class JCArrayAccess extends JCExpression implements ArrayAccessTree {
        ...
        protected JCArrayAccess(com.sun.tools.javac.tree.JCTree.JCExpression indexed, com.sun.tools.javac.tree.JCTree.JCExpression index) {
            this.indexed = indexed;
            this.index = index;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitIndexed(this); }

        public Kind getKind() { return Kind.ARRAY_ACCESS; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getExpression() { return indexed; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getIndex() { return index; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCFieldAccess extends JCExpression implements MemberSelectTree {
        ...
        public Symbol sym;
        protected JCFieldAccess(com.sun.tools.javac.tree.JCTree.JCExpression selected, Name name, Symbol sym) {
            this.selected = selected;
            this.name = name;
            this.sym = sym;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitSelect(this); }

        public Kind getKind() { return Kind.MEMBER_SELECT; }
        public com.sun.tools.javac.tree.JCTree.JCExpression getExpression() { return selected; }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCMemberReference extends JCFunctionalExpression implements MemberReferenceTree {
        ...
        protected JCMemberReference(ReferenceMode mode, Name name, com.sun.tools.javac.tree.JCTree.JCExpression expr, List<com.sun.tools.javac.tree.JCTree.JCExpression> typeargs) {
            this.mode = mode;
            this.name = name;
            this.expr = expr;
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitReference(this); }

        public Kind getKind() { return Kind.MEMBER_REFERENCE; }
        @Override
        public ReferenceMode getMode() { return mode; }
        @Override
        public com.sun.tools.javac.tree.JCTree.JCExpression getQualifierExpression() { return expr; }
        @Override
        public Name getName() { return name; }
        @Override
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> getTypeArguments() { return typeargs; }
    ...
    public static class JCIdent extends JCExpression implements IdentifierTree {
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitIdent(this); }
    ...
    public static class JCLiteral extends JCExpression implements LiteralTree {
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitLiteral(this); }
        ...
        @Override
        public com.sun.tools.javac.tree.JCTree.JCLiteral setType(Type type) {
            super.setType(type);
            return this;
        }
        @Override
    ...
    public static class JCPrimitiveTypeTree extends JCExpression implements PrimitiveTypeTree {
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitTypeIdent(this); }
    ...
    public static class JCArrayTypeTree extends JCExpression implements ArrayTypeTree {
        public com.sun.tools.javac.tree.JCTree.JCExpression elemtype;
        protected JCArrayTypeTree(com.sun.tools.javac.tree.JCTree.JCExpression elemtype) {
            this.elemtype = elemtype;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitTypeArray(this); }
    ...
    public static class JCTypeApply extends JCExpression implements ParameterizedTypeTree {
        public com.sun.tools.javac.tree.JCTree.JCExpression clazz;
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> arguments;
        protected JCTypeApply(com.sun.tools.javac.tree.JCTree.JCExpression clazz, List<com.sun.tools.javac.tree.JCTree.JCExpression> arguments) {
            this.clazz = clazz;
            this.arguments = arguments;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitTypeApply(this); }
    ...
    public static class JCTypeUnion extends JCExpression implements UnionTypeTree {
        ...
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> alternatives;

        protected JCTypeUnion(List<com.sun.tools.javac.tree.JCTree.JCExpression> components) {
            this.alternatives = components;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitTypeUnion(this); }

        public Kind getKind() { return Kind.UNION_TYPE; }

        public List<com.sun.tools.javac.tree.JCTree.JCExpression> getTypeAlternatives() {
            return alternatives;
        }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCTypeIntersection extends JCExpression implements IntersectionTypeTree {
        ...
        public List<com.sun.tools.javac.tree.JCTree.JCExpression> bounds;

        protected JCTypeIntersection(List<com.sun.tools.javac.tree.JCTree.JCExpression> bounds) {
            this.bounds = bounds;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitTypeIntersection(this); }

        public Kind getKind() { return Kind.INTERSECTION_TYPE; }

        public List<com.sun.tools.javac.tree.JCTree.JCExpression> getBounds() {
            return bounds;
        }
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
    ...
    public static class JCTypeParameter extends JCTree implements TypeParameterTree {
        ...
        public List<com.sun.tools.javac.tree.JCTree.JCAnnotation> annotations;
        protected JCTypeParameter(Name name, List<com.sun.tools.javac.tree.JCTree.JCExpression> bounds, List<com.sun.tools.javac.tree.JCTree.JCAnnotation> annotations) {
            this.name = name;
            this.bounds = bounds;
            this.annotations = annotations;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitTypeParameter(this); }
    ...
    public static class JCWildcard extends JCExpression implements WildcardTree {
        ...
        public JCTree inner;
        protected JCWildcard(com.sun.tools.javac.tree.JCTree.TypeBoundKind kind, JCTree inner) {
            kind.getClass(); // null-check
            this.kind = kind;
            this.inner = inner;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitWildcard(this); }
        ...
        @Override
        public com.sun.tools.javac.tree.JCTree.Tag getTag() {
            return com.sun.tools.javac.tree.JCTree.Tag.WILDCARD;
        }
    }
    ...
    public static class TypeBoundKind extends JCTree {
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitTypeBoundKind(this); }
    ...
    public static class JCAnnotation extends JCExpression implements AnnotationTree {
        ...
        protected JCAnnotation(com.sun.tools.javac.tree.JCTree.Tag tag, JCTree annotationType, List<com.sun.tools.javac.tree.JCTree.JCExpression> args) {
            this.tag = tag;
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitAnnotation(this); }
    ...
    public static class JCModifiers extends JCTree implements ModifiersTree {
        public long flags;
        public List<com.sun.tools.javac.tree.JCTree.JCAnnotation> annotations;
        protected JCModifiers(long flags, List<com.sun.tools.javac.tree.JCTree.JCAnnotation> annotations) {
            this.flags = flags;
            this.annotations = annotations;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitModifiers(this); }
    ...
    public static class JCAnnotatedType extends JCExpression implements AnnotatedTypeTree {
        ...
        protected JCAnnotatedType(List<com.sun.tools.javac.tree.JCTree.JCAnnotation> annotations, com.sun.tools.javac.tree.JCTree.JCExpression underlyingType) {
            Assert.check(annotations != null && annotations.nonEmpty());
            this.annotations = annotations;
            this.underlyingType = underlyingType;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitAnnotatedType(this); }
    ...
    public static class JCErroneous extends JCExpression
        ...
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitErroneous(this); }
    ...
    public static class LetExpr extends JCExpression {
        public List<com.sun.tools.javac.tree.JCTree.JCVariableDecl> defs;
        public JCTree expr;
        protected LetExpr(List<com.sun.tools.javac.tree.JCTree.JCVariableDecl> defs, JCTree expr) {
            this.defs = defs;
            this.expr = expr;
        }
        @Override
        public void accept(com.sun.tools.javac.tree.JCTree.Visitor v) { v.visitLetExpr(this); }
