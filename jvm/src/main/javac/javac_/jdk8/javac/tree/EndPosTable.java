...
public interface EndPosTable {
     ...
     */
    public int getEndPos(com.sun.tools.javac.tree.JCTree tree);
     ...
     */
    public abstract void storeEnd(com.sun.tools.javac.tree.JCTree tree, int endpos);
     ...
     */
    public int replaceTree(com.sun.tools.javac.tree.JCTree oldtree, JCTree newtree);
}
