 ...
 */
public class TreeTranslator extends com.sun.tools.javac.tree.JCTree.Visitor {
    ...
    public <T extends com.sun.tools.javac.tree.JCTree> T translate(T tree) {
        if (tree == null) {
            return null;
        } else {
            tree.accept(this);
            com.sun.tools.javac.tree.JCTree tmpResult = this.result;
            this.result = null;
     ...
     */
    public <T extends com.sun.tools.javac.tree.JCTree> List<T> translate(List<T> trees) {
