...
public interface DocCommentTable {
     ...
     */
    public boolean hasComment(com.sun.tools.javac.tree.JCTree tree);

    /**
     * Get the Comment token containing the doc comment, if any, for a tree node.
     */
    public Comment getComment(com.sun.tools.javac.tree.JCTree tree);

    /**
     * Get the plain text of the doc comment, if any, for a tree node.
     */
    public String getCommentText(com.sun.tools.javac.tree.JCTree tree);
     ...
     */
    public DCDocComment getCommentTree(com.sun.tools.javac.tree.JCTree tree);
