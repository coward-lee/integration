...
public abstract class DCTree implements DocTree {
    ...
    public static abstract class DCEndPosTree<T extends DCEndPosTree<T>> extends DCTree {
        ...
        public int getEndPos(com.sun.tools.javac.tree.DCTree.DCDocComment dc) {
    ...
    public static class DCLink extends DCInlineTag implements LinkTree {
        ...
        DCLink(Kind kind, com.sun.tools.javac.tree.DCTree.DCReference ref, List<DCTree> label) {
    ...
    public static class DCLiteral extends DCInlineTag implements LiteralTree {
        ...
        DCLiteral(Kind kind, com.sun.tools.javac.tree.DCTree.DCText body) {
    ...
    public static class DCParam extends DCBlockTag implements ParamTree {
        ...
        DCParam(boolean isTypeParameter, com.sun.tools.javac.tree.DCTree.DCIdentifier name, List<DCTree> description) {
    ...
    public static class DCSerialField extends DCBlockTag implements SerialFieldTree {
        ...
        DCSerialField(com.sun.tools.javac.tree.DCTree.DCIdentifier name, com.sun.tools.javac.tree.DCTree.DCReference type, List<DCTree> description) {
            this.description = description;
            this.name = name;
            this.type = type;
        }
    ...
    public static class DCThrows extends DCBlockTag implements ThrowsTree {
        ...
        DCThrows(Kind kind, com.sun.tools.javac.tree.DCTree.DCReference name, List<DCTree> description) {
    ...
    public static class DCValue extends DCInlineTag implements ValueTree {
        ...
        DCValue(com.sun.tools.javac.tree.DCTree.DCReference ref) {
            this.ref = ref;
        }
